...
[RoutePrefix("api/ERP/GLCategories")]
public class ERPGLCategoriesController : ERPBaseController
{
	public IERPGLCategoryModel erpGLCategoryModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLCategoryDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLCategoryDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLCategoryAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLCategoryModel = new ERPGLCategoryModel())
		{
			return await RunApiMethod(base.Request, erpGLCategoryModel, () => erpGLCategoryModel.ValidateRequest_GetAllGLCategories(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLCategoryModel.Process_GetAllGLCategories(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLCategory based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLCategoryDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLCategoryDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLCategoryAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLCategoryModel = new ERPGLCategoryModel())
		{
			return await RunApiMethod(base.Request, erpGLCategoryModel, () => erpGLCategoryModel.ValidateRequest_GetGLCategory(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLCategoryModel.Process_GetGLCategory(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLCategory">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLCategoryDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLCategoryDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLCategoryDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLCategoryAsync([FromBody] ERPGLCategoryDto gLCategory)
	{
		using (erpGLCategoryModel = new ERPGLCategoryModel())
		{
			return await RunApiMethod(base.Request, erpGLCategoryModel, () => erpGLCategoryModel.ValidateRequest_PutGLCategory(gLCategory).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLCategoryModel.Process_PutGLCategory(gLCategory), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLCategoryAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLCategoryModel = new ERPGLCategoryModel())
		{
			return await RunApiMethod(base.Request, erpGLCategoryModel, () => erpGLCategoryModel.ValidateRequest_DeleteGLCategory(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLCategoryModel.Process_DeleteGLCategory(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
