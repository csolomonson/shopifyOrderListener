...
[RoutePrefix("api/ERP/WarehouseBins")]
public class ERPWarehouseBinsController : ERPBaseController
{
	public IERPWarehouseBinModel erpWarehouseBinModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWarehouseBinDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWarehouseBinDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWarehouseBinAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWarehouseBinModel = new ERPWarehouseBinModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseBinModel, () => erpWarehouseBinModel.ValidateRequest_GetAllWarehouseBins(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseBinModel.Process_GetAllWarehouseBins(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a WarehouseBin based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWarehouseBinDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseBinDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWarehouseBinAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseBinModel = new ERPWarehouseBinModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseBinModel, () => erpWarehouseBinModel.ValidateRequest_GetWarehouseBin(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseBinModel.Process_GetWarehouseBin(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="warehouseBin">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWarehouseBinDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWarehouseBinDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseBinDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWarehouseBinAsync([FromBody] ERPWarehouseBinDto warehouseBin)
	{
		using (erpWarehouseBinModel = new ERPWarehouseBinModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseBinModel, () => erpWarehouseBinModel.ValidateRequest_PutWarehouseBin(warehouseBin).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseBinModel.Process_PutWarehouseBin(warehouseBin), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWarehouseBinAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseBinModel = new ERPWarehouseBinModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseBinModel, () => erpWarehouseBinModel.ValidateRequest_DeleteWarehouseBin(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseBinModel.Process_DeleteWarehouseBin(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
