...
[RoutePrefix("api/ERP/SalesOrderMemos")]
public class ERPSalesOrderMemosController : ERPBaseController
{
	public IERPSalesOrderMemoModel erpSalesOrderMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPSalesOrderMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllSalesOrderMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpSalesOrderMemoModel = new ERPSalesOrderMemoModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderMemoModel, () => erpSalesOrderMemoModel.ValidateRequest_GetAllSalesOrderMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderMemoModel.Process_GetAllSalesOrderMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a SalesOrderMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SALESORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetSalesOrderMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderMemoModel = new ERPSalesOrderMemoModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderMemoModel, () => erpSalesOrderMemoModel.ValidateRequest_GetSalesOrderMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderMemoModel.Process_GetSalesOrderMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="salesOrderMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPSalesOrderMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutSalesOrderMemoAsync([FromBody] ERPSalesOrderMemoDto salesOrderMemo)
	{
		using (erpSalesOrderMemoModel = new ERPSalesOrderMemoModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderMemoModel, () => erpSalesOrderMemoModel.ValidateRequest_PutSalesOrderMemo(salesOrderMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderMemoModel.Process_PutSalesOrderMemo(salesOrderMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteSalesOrderMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderMemoModel = new ERPSalesOrderMemoModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderMemoModel, () => erpSalesOrderMemoModel.ValidateRequest_DeleteSalesOrderMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderMemoModel.Process_DeleteSalesOrderMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
