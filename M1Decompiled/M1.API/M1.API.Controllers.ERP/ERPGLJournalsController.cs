...
[RoutePrefix("api/ERP/GLJournals")]
public class ERPGLJournalsController : ERPBaseController
{
	public IERPGLJournalModel erpGLJournalModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLJournalDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLJournalDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLJournalAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLJournalModel = new ERPGLJournalModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalModel, () => erpGLJournalModel.ValidateRequest_GetAllGLJournals(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalModel.Process_GetAllGLJournals(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLJournal based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLJournalDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLJournalDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLJournalAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLJournalModel = new ERPGLJournalModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalModel, () => erpGLJournalModel.ValidateRequest_GetGLJournal(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalModel.Process_GetGLJournal(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLJournal">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLJournalDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLJournalDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLJournalDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLJournalAsync([FromBody] ERPGLJournalDto gLJournal)
	{
		using (erpGLJournalModel = new ERPGLJournalModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalModel, () => erpGLJournalModel.ValidateRequest_PutGLJournal(gLJournal).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalModel.Process_PutGLJournal(gLJournal), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLJournalAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLJournalModel = new ERPGLJournalModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalModel, () => erpGLJournalModel.ValidateRequest_DeleteGLJournal(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalModel.Process_DeleteGLJournal(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
