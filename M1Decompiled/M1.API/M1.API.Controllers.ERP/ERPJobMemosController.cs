...
[RoutePrefix("api/ERP/JobMemos")]
public class ERPJobMemosController : ERPBaseController
{
	public IERPJobMemoModel erpJobMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobMemoModel = new ERPJobMemoModel())
		{
			return await RunApiMethod(base.Request, erpJobMemoModel, () => erpJobMemoModel.ValidateRequest_GetAllJobMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMemoModel.Process_GetAllJobMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobMemoModel = new ERPJobMemoModel())
		{
			return await RunApiMethod(base.Request, erpJobMemoModel, () => erpJobMemoModel.ValidateRequest_GetJobMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMemoModel.Process_GetJobMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobMemoAsync([FromBody] ERPJobMemoDto jobMemo)
	{
		using (erpJobMemoModel = new ERPJobMemoModel())
		{
			return await RunApiMethod(base.Request, erpJobMemoModel, () => erpJobMemoModel.ValidateRequest_PutJobMemo(jobMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMemoModel.Process_PutJobMemo(jobMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobMemoModel = new ERPJobMemoModel())
		{
			return await RunApiMethod(base.Request, erpJobMemoModel, () => erpJobMemoModel.ValidateRequest_DeleteJobMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMemoModel.Process_DeleteJobMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
