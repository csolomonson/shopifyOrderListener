...
[RoutePrefix("api/ERP/ShippingMethods")]
public class ERPShippingMethodsController : ERPBaseController
{
	public IERPShippingMethodModel erpShippingMethodModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPShippingMethodDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPShippingMethodDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllShippingMethodAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpShippingMethodModel = new ERPShippingMethodModel())
		{
			return await RunApiMethod(base.Request, erpShippingMethodModel, () => erpShippingMethodModel.ValidateRequest_GetAllShippingMethods(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShippingMethodModel.Process_GetAllShippingMethods(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ShippingMethod based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPShippingMethodDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShippingMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SHIPPING" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetShippingMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShippingMethodModel = new ERPShippingMethodModel())
		{
			return await RunApiMethod(base.Request, erpShippingMethodModel, () => erpShippingMethodModel.ValidateRequest_GetShippingMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShippingMethodModel.Process_GetShippingMethod(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="shippingMethod">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPShippingMethodDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPShippingMethodDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShippingMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutShippingMethodAsync([FromBody] ERPShippingMethodDto shippingMethod)
	{
		using (erpShippingMethodModel = new ERPShippingMethodModel())
		{
			return await RunApiMethod(base.Request, erpShippingMethodModel, () => erpShippingMethodModel.ValidateRequest_PutShippingMethod(shippingMethod).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShippingMethodModel.Process_PutShippingMethod(shippingMethod), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteShippingMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShippingMethodModel = new ERPShippingMethodModel())
		{
			return await RunApiMethod(base.Request, erpShippingMethodModel, () => erpShippingMethodModel.ValidateRequest_DeleteShippingMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShippingMethodModel.Process_DeleteShippingMethod(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
