...
[RoutePrefix("api/ERP/RFQMemos")]
public class ERPRFQMemosController : ERPBaseController
{
	public IERPRFQMemoModel erpRFQMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRFQMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRFQMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRFQMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRFQMemoModel = new ERPRFQMemoModel())
		{
			return await RunApiMethod(base.Request, erpRFQMemoModel, () => erpRFQMemoModel.ValidateRequest_GetAllRFQMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQMemoModel.Process_GetAllRFQMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RFQMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRFQMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRFQMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQMemoModel = new ERPRFQMemoModel())
		{
			return await RunApiMethod(base.Request, erpRFQMemoModel, () => erpRFQMemoModel.ValidateRequest_GetRFQMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQMemoModel.Process_GetRFQMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rFQMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRFQMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRFQMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRFQMemoAsync([FromBody] ERPRFQMemoDto rFQMemo)
	{
		using (erpRFQMemoModel = new ERPRFQMemoModel())
		{
			return await RunApiMethod(base.Request, erpRFQMemoModel, () => erpRFQMemoModel.ValidateRequest_PutRFQMemo(rFQMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQMemoModel.Process_PutRFQMemo(rFQMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRFQMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQMemoModel = new ERPRFQMemoModel())
		{
			return await RunApiMethod(base.Request, erpRFQMemoModel, () => erpRFQMemoModel.ValidateRequest_DeleteRFQMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQMemoModel.Process_DeleteRFQMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
