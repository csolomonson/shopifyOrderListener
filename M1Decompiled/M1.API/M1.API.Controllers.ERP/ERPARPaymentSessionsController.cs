...
[RoutePrefix("api/ERP/ARPaymentSessions")]
public class ERPARPaymentSessionsController : ERPBaseController
{
	public IERPARPaymentSessionModel erpARPaymentSessionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARPaymentSessionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARPaymentSessionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARPaymentSessionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARPaymentSessionModel = new ERPARPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentSessionModel, () => erpARPaymentSessionModel.ValidateRequest_GetAllARPaymentSessions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentSessionModel.Process_GetAllARPaymentSessions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARPaymentSession based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARPaymentSessionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARPaymentSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentSessionModel = new ERPARPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentSessionModel, () => erpARPaymentSessionModel.ValidateRequest_GetARPaymentSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentSessionModel.Process_GetARPaymentSession(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRPaymentSession">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARPaymentSessionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARPaymentSessionAsync([FromBody] ERPARPaymentSessionDto aRPaymentSession)
	{
		using (erpARPaymentSessionModel = new ERPARPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentSessionModel, () => erpARPaymentSessionModel.ValidateRequest_PutARPaymentSession(aRPaymentSession).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentSessionModel.Process_PutARPaymentSession(aRPaymentSession), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARPaymentSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentSessionModel = new ERPARPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentSessionModel, () => erpARPaymentSessionModel.ValidateRequest_DeleteARPaymentSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentSessionModel.Process_DeleteARPaymentSession(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
