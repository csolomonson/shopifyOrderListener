...
[RoutePrefix("api/ERP/APInvoices")]
public class ERPAPInvoicesController : ERPBaseController
{
	public IERPAPInvoiceModel erpAPInvoiceModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPInvoiceDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPInvoiceAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPInvoiceModel = new ERPAPInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceModel, () => erpAPInvoiceModel.ValidateRequest_GetAllAPInvoices(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceModel.Process_GetAllAPInvoices(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APInvoice based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPInvoiceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceModel = new ERPAPInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceModel, () => erpAPInvoiceModel.ValidateRequest_GetAPInvoice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceModel.Process_GetAPInvoice(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPInvoice">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPInvoiceAsync([FromBody] ERPAPInvoiceDto aPInvoice)
	{
		using (erpAPInvoiceModel = new ERPAPInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceModel, () => erpAPInvoiceModel.ValidateRequest_PutAPInvoice(aPInvoice).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceModel.Process_PutAPInvoice(aPInvoice), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPInvoiceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceModel = new ERPAPInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceModel, () => erpAPInvoiceModel.ValidateRequest_DeleteAPInvoice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceModel.Process_DeleteAPInvoice(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
