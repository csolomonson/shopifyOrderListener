...
[RoutePrefix("api/ERP/EmployeeMemos")]
public class ERPEmployeeMemosController : ERPBaseController
{
	public IERPEmployeeMemoModel erpEmployeeMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPEmployeeMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPEmployeeMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllEmployeeMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpEmployeeMemoModel = new ERPEmployeeMemoModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeMemoModel, () => erpEmployeeMemoModel.ValidateRequest_GetAllEmployeeMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeMemoModel.Process_GetAllEmployeeMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a EmployeeMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPEmployeeMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPEmployeeMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/EMPLOYEE" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetEmployeeMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpEmployeeMemoModel = new ERPEmployeeMemoModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeMemoModel, () => erpEmployeeMemoModel.ValidateRequest_GetEmployeeMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeMemoModel.Process_GetEmployeeMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="employeeMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPEmployeeMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPEmployeeMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPEmployeeMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutEmployeeMemoAsync([FromBody] ERPEmployeeMemoDto employeeMemo)
	{
		using (erpEmployeeMemoModel = new ERPEmployeeMemoModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeMemoModel, () => erpEmployeeMemoModel.ValidateRequest_PutEmployeeMemo(employeeMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeMemoModel.Process_PutEmployeeMemo(employeeMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteEmployeeMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpEmployeeMemoModel = new ERPEmployeeMemoModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeMemoModel, () => erpEmployeeMemoModel.ValidateRequest_DeleteEmployeeMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeMemoModel.Process_DeleteEmployeeMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
