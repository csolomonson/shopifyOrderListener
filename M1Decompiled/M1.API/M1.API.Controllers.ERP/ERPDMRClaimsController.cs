...
[RoutePrefix("api/ERP/DMRClaims")]
public class ERPDMRClaimsController : ERPBaseController
{
	public IERPDMRClaimModel erpDMRClaimModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPDMRClaimDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllDMRClaimAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpDMRClaimModel = new ERPDMRClaimModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimModel, () => erpDMRClaimModel.ValidateRequest_GetAllDMRClaims(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimModel.Process_GetAllDMRClaims(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a DMRClaim based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRClaimDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetDMRClaimAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRClaimModel = new ERPDMRClaimModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimModel, () => erpDMRClaimModel.ValidateRequest_GetDMRClaim(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimModel.Process_GetDMRClaim(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="dMRClaim">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPDMRClaimDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRClaimDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutDMRClaimAsync([FromBody] ERPDMRClaimDto dMRClaim)
	{
		using (erpDMRClaimModel = new ERPDMRClaimModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimModel, () => erpDMRClaimModel.ValidateRequest_PutDMRClaim(dMRClaim).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimModel.Process_PutDMRClaim(dMRClaim), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteDMRClaimAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRClaimModel = new ERPDMRClaimModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimModel, () => erpDMRClaimModel.ValidateRequest_DeleteDMRClaim(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimModel.Process_DeleteDMRClaim(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
