...
[RoutePrefix("api/ERP/Receipts")]
public class ERPReceiptsController : ERPBaseController
{
	public IERPReceiptModel erpReceiptModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPReceiptDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPReceiptDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllReceiptAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpReceiptModel = new ERPReceiptModel())
		{
			return await RunApiMethod(base.Request, erpReceiptModel, () => erpReceiptModel.ValidateRequest_GetAllReceipts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptModel.Process_GetAllReceipts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Receipt based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPReceiptDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASERECEIPTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpReceiptModel = new ERPReceiptModel())
		{
			return await RunApiMethod(base.Request, erpReceiptModel, () => erpReceiptModel.ValidateRequest_GetReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptModel.Process_GetReceipt(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="receipt">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPReceiptDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutReceiptAsync([FromBody] ERPReceiptDto receipt)
	{
		using (erpReceiptModel = new ERPReceiptModel())
		{
			return await RunApiMethod(base.Request, erpReceiptModel, () => erpReceiptModel.ValidateRequest_PutReceipt(receipt).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptModel.Process_PutReceipt(receipt), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpReceiptModel = new ERPReceiptModel())
		{
			return await RunApiMethod(base.Request, erpReceiptModel, () => erpReceiptModel.ValidateRequest_DeleteReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptModel.Process_DeleteReceipt(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
