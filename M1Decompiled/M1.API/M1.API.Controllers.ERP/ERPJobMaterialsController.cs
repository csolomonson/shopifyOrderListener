...
[RoutePrefix("api/ERP/JobMaterials")]
public class ERPJobMaterialsController : ERPBaseController
{
	public IERPJobMaterialModel erpJobMaterialModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobMaterialDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobMaterialDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobMaterialAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobMaterialModel = new ERPJobMaterialModel())
		{
			return await RunApiMethod(base.Request, erpJobMaterialModel, () => erpJobMaterialModel.ValidateRequest_GetAllJobMaterials(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMaterialModel.Process_GetAllJobMaterials(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobMaterial based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobMaterialDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobMaterialModel = new ERPJobMaterialModel())
		{
			return await RunApiMethod(base.Request, erpJobMaterialModel, () => erpJobMaterialModel.ValidateRequest_GetJobMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMaterialModel.Process_GetJobMaterial(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobMaterial">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobMaterialDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobMaterialAsync([FromBody] ERPJobMaterialDto jobMaterial)
	{
		using (erpJobMaterialModel = new ERPJobMaterialModel())
		{
			return await RunApiMethod(base.Request, erpJobMaterialModel, () => erpJobMaterialModel.ValidateRequest_PutJobMaterial(jobMaterial).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMaterialModel.Process_PutJobMaterial(jobMaterial), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobMaterialModel = new ERPJobMaterialModel())
		{
			return await RunApiMethod(base.Request, erpJobMaterialModel, () => erpJobMaterialModel.ValidateRequest_DeleteJobMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobMaterialModel.Process_DeleteJobMaterial(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
