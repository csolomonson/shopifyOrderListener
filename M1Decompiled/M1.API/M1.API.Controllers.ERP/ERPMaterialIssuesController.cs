...
[RoutePrefix("api/ERP/MaterialIssues")]
public class ERPMaterialIssuesController : ERPBaseController
{
	public IERPMaterialIssueModel erpMaterialIssueModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMaterialIssueDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMaterialIssueAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMaterialIssueModel = new ERPMaterialIssueModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueModel, () => erpMaterialIssueModel.ValidateRequest_GetAllMaterialIssues(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueModel.Process_GetAllMaterialIssues(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MaterialIssue based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMaterialIssueAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMaterialIssueModel = new ERPMaterialIssueModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueModel, () => erpMaterialIssueModel.ValidateRequest_GetMaterialIssue(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueModel.Process_GetMaterialIssue(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="materialIssue">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMaterialIssueAsync([FromBody] ERPMaterialIssueDto materialIssue)
	{
		using (erpMaterialIssueModel = new ERPMaterialIssueModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueModel, () => erpMaterialIssueModel.ValidateRequest_PutMaterialIssue(materialIssue).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueModel.Process_PutMaterialIssue(materialIssue), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMaterialIssueAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMaterialIssueModel = new ERPMaterialIssueModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueModel, () => erpMaterialIssueModel.ValidateRequest_DeleteMaterialIssue(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueModel.Process_DeleteMaterialIssue(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
