...
[RoutePrefix("api/ERP/Milestones")]
public class ERPMilestonesController : ERPBaseController
{
	public IERPMilestoneModel erpMilestoneModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMilestoneDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMilestoneDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMilestoneAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMilestoneModel = new ERPMilestoneModel())
		{
			return await RunApiMethod(base.Request, erpMilestoneModel, () => erpMilestoneModel.ValidateRequest_GetAllMilestones(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMilestoneModel.Process_GetAllMilestones(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Milestone based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMilestoneDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMilestoneDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMilestoneAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMilestoneModel = new ERPMilestoneModel())
		{
			return await RunApiMethod(base.Request, erpMilestoneModel, () => erpMilestoneModel.ValidateRequest_GetMilestone(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMilestoneModel.Process_GetMilestone(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="milestone">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMilestoneDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMilestoneDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMilestoneDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMilestoneAsync([FromBody] ERPMilestoneDto milestone)
	{
		using (erpMilestoneModel = new ERPMilestoneModel())
		{
			return await RunApiMethod(base.Request, erpMilestoneModel, () => erpMilestoneModel.ValidateRequest_PutMilestone(milestone).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMilestoneModel.Process_PutMilestone(milestone), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMilestoneAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMilestoneModel = new ERPMilestoneModel())
		{
			return await RunApiMethod(base.Request, erpMilestoneModel, () => erpMilestoneModel.ValidateRequest_DeleteMilestone(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMilestoneModel.Process_DeleteMilestone(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
