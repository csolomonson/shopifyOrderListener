...
[RoutePrefix("api/ERP/RMAReceipts")]
public class ERPRMAReceiptsController : ERPBaseController
{
	public IERPRMAReceiptModel erpRMAReceiptModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRMAReceiptDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRMAReceiptAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRMAReceiptModel = new ERPRMAReceiptModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptModel, () => erpRMAReceiptModel.ValidateRequest_GetAllRMAReceipts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptModel.Process_GetAllRMAReceipts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RMAReceipt based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRMAReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAReceiptModel = new ERPRMAReceiptModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptModel, () => erpRMAReceiptModel.ValidateRequest_GetRMAReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptModel.Process_GetRMAReceipt(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rMAReceipt">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRMAReceiptAsync([FromBody] ERPRMAReceiptDto rMAReceipt)
	{
		using (erpRMAReceiptModel = new ERPRMAReceiptModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptModel, () => erpRMAReceiptModel.ValidateRequest_PutRMAReceipt(rMAReceipt).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptModel.Process_PutRMAReceipt(rMAReceipt), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRMAReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAReceiptModel = new ERPRMAReceiptModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptModel, () => erpRMAReceiptModel.ValidateRequest_DeleteRMAReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptModel.Process_DeleteRMAReceipt(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
