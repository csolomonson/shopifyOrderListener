...
[RoutePrefix("api/ERP/WarehouseReceipts")]
public class ERPWarehouseReceiptsController : ERPBaseController
{
	public IERPWarehouseReceiptModel erpWarehouseReceiptModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWarehouseReceiptDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWarehouseReceiptDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWarehouseReceiptAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWarehouseReceiptModel = new ERPWarehouseReceiptModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseReceiptModel, () => erpWarehouseReceiptModel.ValidateRequest_GetAllWarehouseReceipts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseReceiptModel.Process_GetAllWarehouseReceipts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a WarehouseReceipt based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWarehouseReceiptDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWarehouseReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseReceiptModel = new ERPWarehouseReceiptModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseReceiptModel, () => erpWarehouseReceiptModel.ValidateRequest_GetWarehouseReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseReceiptModel.Process_GetWarehouseReceipt(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="warehouseReceipt">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWarehouseReceiptDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWarehouseReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseReceiptDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWarehouseReceiptAsync([FromBody] ERPWarehouseReceiptDto warehouseReceipt)
	{
		using (erpWarehouseReceiptModel = new ERPWarehouseReceiptModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseReceiptModel, () => erpWarehouseReceiptModel.ValidateRequest_PutWarehouseReceipt(warehouseReceipt).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseReceiptModel.Process_PutWarehouseReceipt(warehouseReceipt), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWarehouseReceiptAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseReceiptModel = new ERPWarehouseReceiptModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseReceiptModel, () => erpWarehouseReceiptModel.ValidateRequest_DeleteWarehouseReceipt(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseReceiptModel.Process_DeleteWarehouseReceipt(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
