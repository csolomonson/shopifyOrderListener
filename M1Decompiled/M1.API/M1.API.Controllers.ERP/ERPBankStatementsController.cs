...
[RoutePrefix("api/ERP/BankStatements")]
public class ERPBankStatementsController : ERPBaseController
{
	public IERPBankStatementModel erpBankStatementModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPBankStatementDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPBankStatementDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllBankStatementAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpBankStatementModel = new ERPBankStatementModel())
		{
			return await RunApiMethod(base.Request, erpBankStatementModel, () => erpBankStatementModel.ValidateRequest_GetAllBankStatements(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankStatementModel.Process_GetAllBankStatements(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a BankStatement based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPBankStatementDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPBankStatementDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetBankStatementAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpBankStatementModel = new ERPBankStatementModel())
		{
			return await RunApiMethod(base.Request, erpBankStatementModel, () => erpBankStatementModel.ValidateRequest_GetBankStatement(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankStatementModel.Process_GetBankStatement(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="bankStatement">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPBankStatementDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPBankStatementDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPBankStatementDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutBankStatementAsync([FromBody] ERPBankStatementDto bankStatement)
	{
		using (erpBankStatementModel = new ERPBankStatementModel())
		{
			return await RunApiMethod(base.Request, erpBankStatementModel, () => erpBankStatementModel.ValidateRequest_PutBankStatement(bankStatement).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankStatementModel.Process_PutBankStatement(bankStatement), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteBankStatementAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpBankStatementModel = new ERPBankStatementModel())
		{
			return await RunApiMethod(base.Request, erpBankStatementModel, () => erpBankStatementModel.ValidateRequest_DeleteBankStatement(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankStatementModel.Process_DeleteBankStatement(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
