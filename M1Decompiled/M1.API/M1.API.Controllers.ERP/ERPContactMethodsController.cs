...
[RoutePrefix("api/ERP/ContactMethods")]
public class ERPContactMethodsController : ERPBaseController
{
	public IERPContactMethodModel erpContactMethodModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPContactMethodDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPContactMethodDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllContactMethodAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpContactMethodModel = new ERPContactMethodModel())
		{
			return await RunApiMethod(base.Request, erpContactMethodModel, () => erpContactMethodModel.ValidateRequest_GetAllContactMethods(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactMethodModel.Process_GetAllContactMethods(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ContactMethod based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPContactMethodDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetContactMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactMethodModel = new ERPContactMethodModel())
		{
			return await RunApiMethod(base.Request, erpContactMethodModel, () => erpContactMethodModel.ValidateRequest_GetContactMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactMethodModel.Process_GetContactMethod(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="contactMethod">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPContactMethodDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPContactMethodDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutContactMethodAsync([FromBody] ERPContactMethodDto contactMethod)
	{
		using (erpContactMethodModel = new ERPContactMethodModel())
		{
			return await RunApiMethod(base.Request, erpContactMethodModel, () => erpContactMethodModel.ValidateRequest_PutContactMethod(contactMethod).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactMethodModel.Process_PutContactMethod(contactMethod), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteContactMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactMethodModel = new ERPContactMethodModel())
		{
			return await RunApiMethod(base.Request, erpContactMethodModel, () => erpContactMethodModel.ValidateRequest_DeleteContactMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactMethodModel.Process_DeleteContactMethod(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
