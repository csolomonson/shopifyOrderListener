...
[RoutePrefix("api/ERP/OrganizationMemos")]
public class ERPOrganizationMemosController : ERPBaseController
{
	public IERPOrganizationMemoModel erpOrganizationMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPOrganizationMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPOrganizationMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllOrganizationMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpOrganizationMemoModel = new ERPOrganizationMemoModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationMemoModel, () => erpOrganizationMemoModel.ValidateRequest_GetAllOrganizationMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationMemoModel.Process_GetAllOrganizationMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a OrganizationMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPOrganizationMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPOrganizationMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetOrganizationMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpOrganizationMemoModel = new ERPOrganizationMemoModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationMemoModel, () => erpOrganizationMemoModel.ValidateRequest_GetOrganizationMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationMemoModel.Process_GetOrganizationMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="organizationMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPOrganizationMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPOrganizationMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPOrganizationMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutOrganizationMemoAsync([FromBody] ERPOrganizationMemoDto organizationMemo)
	{
		using (erpOrganizationMemoModel = new ERPOrganizationMemoModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationMemoModel, () => erpOrganizationMemoModel.ValidateRequest_PutOrganizationMemo(organizationMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationMemoModel.Process_PutOrganizationMemo(organizationMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteOrganizationMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpOrganizationMemoModel = new ERPOrganizationMemoModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationMemoModel, () => erpOrganizationMemoModel.ValidateRequest_DeleteOrganizationMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationMemoModel.Process_DeleteOrganizationMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
