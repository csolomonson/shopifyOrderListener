...
[RoutePrefix("api/ERP/WarehouseTransfers")]
public class ERPWarehouseTransfersController : ERPBaseController
{
	public IERPWarehouseTransferModel erpWarehouseTransferModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWarehouseTransferDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWarehouseTransferDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWarehouseTransferAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWarehouseTransferModel = new ERPWarehouseTransferModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseTransferModel, () => erpWarehouseTransferModel.ValidateRequest_GetAllWarehouseTransfers(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseTransferModel.Process_GetAllWarehouseTransfers(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a WarehouseTransfer based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWarehouseTransferDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseTransferDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWarehouseTransferAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseTransferModel = new ERPWarehouseTransferModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseTransferModel, () => erpWarehouseTransferModel.ValidateRequest_GetWarehouseTransfer(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseTransferModel.Process_GetWarehouseTransfer(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="warehouseTransfer">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWarehouseTransferDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWarehouseTransferDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseTransferDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWarehouseTransferAsync([FromBody] ERPWarehouseTransferDto warehouseTransfer)
	{
		using (erpWarehouseTransferModel = new ERPWarehouseTransferModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseTransferModel, () => erpWarehouseTransferModel.ValidateRequest_PutWarehouseTransfer(warehouseTransfer).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseTransferModel.Process_PutWarehouseTransfer(warehouseTransfer), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWarehouseTransferAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseTransferModel = new ERPWarehouseTransferModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseTransferModel, () => erpWarehouseTransferModel.ValidateRequest_DeleteWarehouseTransfer(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseTransferModel.Process_DeleteWarehouseTransfer(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
