...
[RoutePrefix("api/ERP/PartMaterials")]
public class ERPPartMaterialsController : ERPBaseController
{
	public IERPPartMaterialModel erpPartMaterialModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartMaterialDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartMaterialDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartMaterialAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartMaterialModel = new ERPPartMaterialModel())
		{
			return await RunApiMethod(base.Request, erpPartMaterialModel, () => erpPartMaterialModel.ValidateRequest_GetAllPartMaterials(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartMaterialModel.Process_GetAllPartMaterials(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartMaterial based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartMaterialDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartMaterialModel = new ERPPartMaterialModel())
		{
			return await RunApiMethod(base.Request, erpPartMaterialModel, () => erpPartMaterialModel.ValidateRequest_GetPartMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartMaterialModel.Process_GetPartMaterial(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partMaterial">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartMaterialDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartMaterialAsync([FromBody] ERPPartMaterialDto partMaterial)
	{
		using (erpPartMaterialModel = new ERPPartMaterialModel())
		{
			return await RunApiMethod(base.Request, erpPartMaterialModel, () => erpPartMaterialModel.ValidateRequest_PutPartMaterial(partMaterial).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartMaterialModel.Process_PutPartMaterial(partMaterial), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartMaterialModel = new ERPPartMaterialModel())
		{
			return await RunApiMethod(base.Request, erpPartMaterialModel, () => erpPartMaterialModel.ValidateRequest_DeletePartMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartMaterialModel.Process_DeletePartMaterial(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
