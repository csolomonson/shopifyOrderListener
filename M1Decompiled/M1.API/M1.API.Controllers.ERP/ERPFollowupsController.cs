...
[RoutePrefix("api/ERP/Followups")]
public class ERPFollowupsController : ERPBaseController
{
	public IERPFollowupModel erpFollowupModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPFollowupDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPFollowupDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllFollowupAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpFollowupModel = new ERPFollowupModel())
		{
			return await RunApiMethod(base.Request, erpFollowupModel, () => erpFollowupModel.ValidateRequest_GetAllFollowups(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFollowupModel.Process_GetAllFollowups(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Followup based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPFollowupDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPFollowupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetFollowupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpFollowupModel = new ERPFollowupModel())
		{
			return await RunApiMethod(base.Request, erpFollowupModel, () => erpFollowupModel.ValidateRequest_GetFollowup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFollowupModel.Process_GetFollowup(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="followup">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPFollowupDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPFollowupDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPFollowupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutFollowupAsync([FromBody] ERPFollowupDto followup)
	{
		using (erpFollowupModel = new ERPFollowupModel())
		{
			return await RunApiMethod(base.Request, erpFollowupModel, () => erpFollowupModel.ValidateRequest_PutFollowup(followup).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFollowupModel.Process_PutFollowup(followup), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteFollowupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpFollowupModel = new ERPFollowupModel())
		{
			return await RunApiMethod(base.Request, erpFollowupModel, () => erpFollowupModel.ValidateRequest_DeleteFollowup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFollowupModel.Process_DeleteFollowup(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
