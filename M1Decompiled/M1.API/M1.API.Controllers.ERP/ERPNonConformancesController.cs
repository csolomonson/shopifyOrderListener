...
[RoutePrefix("api/ERP/NonConformances")]
public class ERPNonConformancesController : ERPBaseController
{
	public IERPNonConformanceModel erpNonConformanceModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPNonConformanceDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPNonConformanceDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllNonConformanceAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpNonConformanceModel = new ERPNonConformanceModel())
		{
			return await RunApiMethod(base.Request, erpNonConformanceModel, () => erpNonConformanceModel.ValidateRequest_GetAllNonConformances(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNonConformanceModel.Process_GetAllNonConformances(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a NonConformance based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPNonConformanceDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPNonConformanceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetNonConformanceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpNonConformanceModel = new ERPNonConformanceModel())
		{
			return await RunApiMethod(base.Request, erpNonConformanceModel, () => erpNonConformanceModel.ValidateRequest_GetNonConformance(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNonConformanceModel.Process_GetNonConformance(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="nonConformance">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPNonConformanceDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPNonConformanceDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPNonConformanceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutNonConformanceAsync([FromBody] ERPNonConformanceDto nonConformance)
	{
		using (erpNonConformanceModel = new ERPNonConformanceModel())
		{
			return await RunApiMethod(base.Request, erpNonConformanceModel, () => erpNonConformanceModel.ValidateRequest_PutNonConformance(nonConformance).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNonConformanceModel.Process_PutNonConformance(nonConformance), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteNonConformanceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpNonConformanceModel = new ERPNonConformanceModel())
		{
			return await RunApiMethod(base.Request, erpNonConformanceModel, () => erpNonConformanceModel.ValidateRequest_DeleteNonConformance(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNonConformanceModel.Process_DeleteNonConformance(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
