...
[RoutePrefix("api/ERP/GLFiscalYears")]
public class ERPGLFiscalYearsController : ERPBaseController
{
	public IERPGLFiscalYearModel erpGLFiscalYearModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLFiscalYearDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLFiscalYearDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLFiscalYearAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLFiscalYearModel = new ERPGLFiscalYearModel())
		{
			return await RunApiMethod(base.Request, erpGLFiscalYearModel, () => erpGLFiscalYearModel.ValidateRequest_GetAllGLFiscalYears(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLFiscalYearModel.Process_GetAllGLFiscalYears(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLFiscalYear based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLFiscalYearDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLFiscalYearDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLFiscalYearAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLFiscalYearModel = new ERPGLFiscalYearModel())
		{
			return await RunApiMethod(base.Request, erpGLFiscalYearModel, () => erpGLFiscalYearModel.ValidateRequest_GetGLFiscalYear(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLFiscalYearModel.Process_GetGLFiscalYear(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLFiscalYear">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLFiscalYearDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLFiscalYearDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLFiscalYearDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLFiscalYearAsync([FromBody] ERPGLFiscalYearDto gLFiscalYear)
	{
		using (erpGLFiscalYearModel = new ERPGLFiscalYearModel())
		{
			return await RunApiMethod(base.Request, erpGLFiscalYearModel, () => erpGLFiscalYearModel.ValidateRequest_PutGLFiscalYear(gLFiscalYear).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLFiscalYearModel.Process_PutGLFiscalYear(gLFiscalYear), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLFiscalYearAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLFiscalYearModel = new ERPGLFiscalYearModel())
		{
			return await RunApiMethod(base.Request, erpGLFiscalYearModel, () => erpGLFiscalYearModel.ValidateRequest_DeleteGLFiscalYear(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLFiscalYearModel.Process_DeleteGLFiscalYear(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
