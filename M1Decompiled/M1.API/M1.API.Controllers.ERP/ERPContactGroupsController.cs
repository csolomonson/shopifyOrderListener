...
[RoutePrefix("api/ERP/ContactGroups")]
public class ERPContactGroupsController : ERPBaseController
{
	public IERPContactGroupModel erpContactGroupModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPContactGroupDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPContactGroupDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllContactGroupAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpContactGroupModel = new ERPContactGroupModel())
		{
			return await RunApiMethod(base.Request, erpContactGroupModel, () => erpContactGroupModel.ValidateRequest_GetAllContactGroups(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactGroupModel.Process_GetAllContactGroups(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ContactGroup based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPContactGroupDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetContactGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactGroupModel = new ERPContactGroupModel())
		{
			return await RunApiMethod(base.Request, erpContactGroupModel, () => erpContactGroupModel.ValidateRequest_GetContactGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactGroupModel.Process_GetContactGroup(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="contactGroup">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPContactGroupDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPContactGroupDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutContactGroupAsync([FromBody] ERPContactGroupDto contactGroup)
	{
		using (erpContactGroupModel = new ERPContactGroupModel())
		{
			return await RunApiMethod(base.Request, erpContactGroupModel, () => erpContactGroupModel.ValidateRequest_PutContactGroup(contactGroup).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactGroupModel.Process_PutContactGroup(contactGroup), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteContactGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactGroupModel = new ERPContactGroupModel())
		{
			return await RunApiMethod(base.Request, erpContactGroupModel, () => erpContactGroupModel.ValidateRequest_DeleteContactGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactGroupModel.Process_DeleteContactGroup(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
