...
[RoutePrefix("api/ERP/MRPDemands")]
public class ERPMRPDemandsController : ERPBaseController
{
	public IERPMRPDemandModel erpMRPDemandModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMRPDemandDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMRPDemandDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMRPDemandAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMRPDemandModel = new ERPMRPDemandModel())
		{
			return await RunApiMethod(base.Request, erpMRPDemandModel, () => erpMRPDemandModel.ValidateRequest_GetAllMRPDemands(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPDemandModel.Process_GetAllMRPDemands(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MRPDemand based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMRPDemandDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPDemandDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMRPDemandAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPDemandModel = new ERPMRPDemandModel())
		{
			return await RunApiMethod(base.Request, erpMRPDemandModel, () => erpMRPDemandModel.ValidateRequest_GetMRPDemand(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPDemandModel.Process_GetMRPDemand(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="mRPDemand">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMRPDemandDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMRPDemandDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPDemandDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMRPDemandAsync([FromBody] ERPMRPDemandDto mRPDemand)
	{
		using (erpMRPDemandModel = new ERPMRPDemandModel())
		{
			return await RunApiMethod(base.Request, erpMRPDemandModel, () => erpMRPDemandModel.ValidateRequest_PutMRPDemand(mRPDemand).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPDemandModel.Process_PutMRPDemand(mRPDemand), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMRPDemandAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPDemandModel = new ERPMRPDemandModel())
		{
			return await RunApiMethod(base.Request, erpMRPDemandModel, () => erpMRPDemandModel.ValidateRequest_DeleteMRPDemand(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPDemandModel.Process_DeleteMRPDemand(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
