...
[RoutePrefix("api/ERP/RMAReceiptLines")]
public class ERPRMAReceiptLinesController : ERPBaseController
{
	public IERPRMAReceiptLineModel erpRMAReceiptLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRMAReceiptLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRMAReceiptLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRMAReceiptLineModel = new ERPRMAReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptLineModel, () => erpRMAReceiptLineModel.ValidateRequest_GetAllRMAReceiptLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptLineModel.Process_GetAllRMAReceiptLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RMAReceiptLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRMAReceiptLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAReceiptLineModel = new ERPRMAReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptLineModel, () => erpRMAReceiptLineModel.ValidateRequest_GetRMAReceiptLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptLineModel.Process_GetRMAReceiptLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rMAReceiptLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRMAReceiptLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRMAReceiptLineAsync([FromBody] ERPRMAReceiptLineDto rMAReceiptLine)
	{
		using (erpRMAReceiptLineModel = new ERPRMAReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptLineModel, () => erpRMAReceiptLineModel.ValidateRequest_PutRMAReceiptLine(rMAReceiptLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptLineModel.Process_PutRMAReceiptLine(rMAReceiptLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRMAReceiptLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAReceiptLineModel = new ERPRMAReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAReceiptLineModel, () => erpRMAReceiptLineModel.ValidateRequest_DeleteRMAReceiptLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAReceiptLineModel.Process_DeleteRMAReceiptLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
