...
[RoutePrefix("api/ERP/LeadLines")]
public class ERPLeadLinesController : ERPBaseController
{
	public IERPLeadLineModel erpLeadLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLeadLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLeadLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLeadLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLeadLineModel = new ERPLeadLineModel())
		{
			return await RunApiMethod(base.Request, erpLeadLineModel, () => erpLeadLineModel.ValidateRequest_GetAllLeadLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadLineModel.Process_GetAllLeadLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LeadLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLeadLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLeadLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadLineModel = new ERPLeadLineModel())
		{
			return await RunApiMethod(base.Request, erpLeadLineModel, () => erpLeadLineModel.ValidateRequest_GetLeadLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadLineModel.Process_GetLeadLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="leadLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLeadLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLeadLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLeadLineAsync([FromBody] ERPLeadLineDto leadLine)
	{
		using (erpLeadLineModel = new ERPLeadLineModel())
		{
			return await RunApiMethod(base.Request, erpLeadLineModel, () => erpLeadLineModel.ValidateRequest_PutLeadLine(leadLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadLineModel.Process_PutLeadLine(leadLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLeadLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadLineModel = new ERPLeadLineModel())
		{
			return await RunApiMethod(base.Request, erpLeadLineModel, () => erpLeadLineModel.ValidateRequest_DeleteLeadLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadLineModel.Process_DeleteLeadLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
