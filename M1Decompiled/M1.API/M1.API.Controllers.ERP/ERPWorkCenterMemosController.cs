...
[RoutePrefix("api/ERP/WorkCenterMemos")]
public class ERPWorkCenterMemosController : ERPBaseController
{
	public IERPWorkCenterMemoModel erpWorkCenterMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWorkCenterMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWorkCenterMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWorkCenterMemoModel = new ERPWorkCenterMemoModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterMemoModel, () => erpWorkCenterMemoModel.ValidateRequest_GetAllWorkCenterMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterMemoModel.Process_GetAllWorkCenterMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a WorkCenterMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWorkCenterMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWorkCenterMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWorkCenterMemoModel = new ERPWorkCenterMemoModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterMemoModel, () => erpWorkCenterMemoModel.ValidateRequest_GetWorkCenterMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterMemoModel.Process_GetWorkCenterMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="workCenterMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWorkCenterMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWorkCenterMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWorkCenterMemoAsync([FromBody] ERPWorkCenterMemoDto workCenterMemo)
	{
		using (erpWorkCenterMemoModel = new ERPWorkCenterMemoModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterMemoModel, () => erpWorkCenterMemoModel.ValidateRequest_PutWorkCenterMemo(workCenterMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterMemoModel.Process_PutWorkCenterMemo(workCenterMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWorkCenterMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWorkCenterMemoModel = new ERPWorkCenterMemoModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterMemoModel, () => erpWorkCenterMemoModel.ValidateRequest_DeleteWorkCenterMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterMemoModel.Process_DeleteWorkCenterMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
