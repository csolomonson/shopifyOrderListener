...
[RoutePrefix("api/ERP/PartOrgReferences")]
public class ERPPartOrgReferencesController : ERPBaseController
{
	public IERPPartOrgReferenceModel erpPartOrgReferenceModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartOrgReferenceDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartOrgReferenceDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartOrgReferenceAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartOrgReferenceModel = new ERPPartOrgReferenceModel())
		{
			return await RunApiMethod(base.Request, erpPartOrgReferenceModel, () => erpPartOrgReferenceModel.ValidateRequest_GetAllPartOrgReferences(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOrgReferenceModel.Process_GetAllPartOrgReferences(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartOrgReference based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartOrgReferenceDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartOrgReferenceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartOrgReferenceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartOrgReferenceModel = new ERPPartOrgReferenceModel())
		{
			return await RunApiMethod(base.Request, erpPartOrgReferenceModel, () => erpPartOrgReferenceModel.ValidateRequest_GetPartOrgReference(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOrgReferenceModel.Process_GetPartOrgReference(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partOrgReference">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartOrgReferenceDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartOrgReferenceDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartOrgReferenceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartOrgReferenceAsync([FromBody] ERPPartOrgReferenceDto partOrgReference)
	{
		using (erpPartOrgReferenceModel = new ERPPartOrgReferenceModel())
		{
			return await RunApiMethod(base.Request, erpPartOrgReferenceModel, () => erpPartOrgReferenceModel.ValidateRequest_PutPartOrgReference(partOrgReference).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOrgReferenceModel.Process_PutPartOrgReference(partOrgReference), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartOrgReferenceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartOrgReferenceModel = new ERPPartOrgReferenceModel())
		{
			return await RunApiMethod(base.Request, erpPartOrgReferenceModel, () => erpPartOrgReferenceModel.ValidateRequest_DeletePartOrgReference(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOrgReferenceModel.Process_DeletePartOrgReference(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
