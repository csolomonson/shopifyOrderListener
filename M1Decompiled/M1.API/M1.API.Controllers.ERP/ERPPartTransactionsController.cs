...
[RoutePrefix("api/ERP/PartTransactions")]
public class ERPPartTransactionsController : ERPBaseController
{
	public IERPPartTransactionModel erpPartTransactionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartTransactionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartTransactionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartTransactionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartTransactionModel = new ERPPartTransactionModel())
		{
			return await RunApiMethod(base.Request, erpPartTransactionModel, () => erpPartTransactionModel.ValidateRequest_GetAllPartTransactions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartTransactionModel.Process_GetAllPartTransactions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartTransaction based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartTransactionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartTransactionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartTransactionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartTransactionModel = new ERPPartTransactionModel())
		{
			return await RunApiMethod(base.Request, erpPartTransactionModel, () => erpPartTransactionModel.ValidateRequest_GetPartTransaction(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartTransactionModel.Process_GetPartTransaction(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partTransaction">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartTransactionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartTransactionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartTransactionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartTransactionAsync([FromBody] ERPPartTransactionDto partTransaction)
	{
		using (erpPartTransactionModel = new ERPPartTransactionModel())
		{
			return await RunApiMethod(base.Request, erpPartTransactionModel, () => erpPartTransactionModel.ValidateRequest_PutPartTransaction(partTransaction).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartTransactionModel.Process_PutPartTransaction(partTransaction), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartTransactionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartTransactionModel = new ERPPartTransactionModel())
		{
			return await RunApiMethod(base.Request, erpPartTransactionModel, () => erpPartTransactionModel.ValidateRequest_DeletePartTransaction(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartTransactionModel.Process_DeletePartTransaction(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
