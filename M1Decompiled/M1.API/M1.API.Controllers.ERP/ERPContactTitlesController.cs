...
[RoutePrefix("api/ERP/ContactTitles")]
public class ERPContactTitlesController : ERPBaseController
{
	public IERPContactTitleModel erpContactTitleModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPContactTitleDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPContactTitleDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllContactTitleAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpContactTitleModel = new ERPContactTitleModel())
		{
			return await RunApiMethod(base.Request, erpContactTitleModel, () => erpContactTitleModel.ValidateRequest_GetAllContactTitles(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactTitleModel.Process_GetAllContactTitles(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ContactTitle based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPContactTitleDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactTitleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetContactTitleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactTitleModel = new ERPContactTitleModel())
		{
			return await RunApiMethod(base.Request, erpContactTitleModel, () => erpContactTitleModel.ValidateRequest_GetContactTitle(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactTitleModel.Process_GetContactTitle(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="contactTitle">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPContactTitleDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPContactTitleDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPContactTitleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutContactTitleAsync([FromBody] ERPContactTitleDto contactTitle)
	{
		using (erpContactTitleModel = new ERPContactTitleModel())
		{
			return await RunApiMethod(base.Request, erpContactTitleModel, () => erpContactTitleModel.ValidateRequest_PutContactTitle(contactTitle).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactTitleModel.Process_PutContactTitle(contactTitle), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteContactTitleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpContactTitleModel = new ERPContactTitleModel())
		{
			return await RunApiMethod(base.Request, erpContactTitleModel, () => erpContactTitleModel.ValidateRequest_DeleteContactTitle(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpContactTitleModel.Process_DeleteContactTitle(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
