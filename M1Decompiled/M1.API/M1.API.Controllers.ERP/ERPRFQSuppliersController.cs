...
[RoutePrefix("api/ERP/RFQSuppliers")]
public class ERPRFQSuppliersController : ERPBaseController
{
	public IERPRFQSupplierModel erpRFQSupplierModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRFQSupplierDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRFQSupplierDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRFQSupplierAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRFQSupplierModel = new ERPRFQSupplierModel())
		{
			return await RunApiMethod(base.Request, erpRFQSupplierModel, () => erpRFQSupplierModel.ValidateRequest_GetAllRFQSuppliers(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQSupplierModel.Process_GetAllRFQSuppliers(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RFQSupplier based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRFQSupplierDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQSupplierDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRFQSupplierAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQSupplierModel = new ERPRFQSupplierModel())
		{
			return await RunApiMethod(base.Request, erpRFQSupplierModel, () => erpRFQSupplierModel.ValidateRequest_GetRFQSupplier(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQSupplierModel.Process_GetRFQSupplier(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rFQSupplier">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRFQSupplierDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRFQSupplierDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQSupplierDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRFQSupplierAsync([FromBody] ERPRFQSupplierDto rFQSupplier)
	{
		using (erpRFQSupplierModel = new ERPRFQSupplierModel())
		{
			return await RunApiMethod(base.Request, erpRFQSupplierModel, () => erpRFQSupplierModel.ValidateRequest_PutRFQSupplier(rFQSupplier).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQSupplierModel.Process_PutRFQSupplier(rFQSupplier), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRFQSupplierAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQSupplierModel = new ERPRFQSupplierModel())
		{
			return await RunApiMethod(base.Request, erpRFQSupplierModel, () => erpRFQSupplierModel.ValidateRequest_DeleteRFQSupplier(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQSupplierModel.Process_DeleteRFQSupplier(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
