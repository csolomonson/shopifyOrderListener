...
[RoutePrefix("api/ERP/JobAssemblies")]
public class ERPJobAssembliesController : ERPBaseController
{
	public IERPJobAssemblyModel erpJobAssemblyModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobAssemblyDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobAssemblyDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobAssemblyAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobAssemblyModel = new ERPJobAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpJobAssemblyModel, () => erpJobAssemblyModel.ValidateRequest_GetAllJobAssemblies(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobAssemblyModel.Process_GetAllJobAssemblies(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobAssembly based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobAssemblyDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobAssemblyModel = new ERPJobAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpJobAssemblyModel, () => erpJobAssemblyModel.ValidateRequest_GetJobAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobAssemblyModel.Process_GetJobAssembly(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobAssembly">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobAssemblyDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobAssemblyAsync([FromBody] ERPJobAssemblyDto jobAssembly)
	{
		using (erpJobAssemblyModel = new ERPJobAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpJobAssemblyModel, () => erpJobAssemblyModel.ValidateRequest_PutJobAssembly(jobAssembly).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobAssemblyModel.Process_PutJobAssembly(jobAssembly), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobAssemblyModel = new ERPJobAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpJobAssemblyModel, () => erpJobAssemblyModel.ValidateRequest_DeleteJobAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobAssemblyModel.Process_DeleteJobAssembly(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
