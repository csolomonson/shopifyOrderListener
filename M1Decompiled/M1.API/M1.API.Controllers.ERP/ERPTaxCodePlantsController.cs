...
[RoutePrefix("api/ERP/TaxCodePlants")]
public class ERPTaxCodePlantsController : ERPBaseController
{
	public IERPTaxCodePlantModel erpTaxCodePlantModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPTaxCodePlantDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPTaxCodePlantDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllTaxCodePlantAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpTaxCodePlantModel = new ERPTaxCodePlantModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodePlantModel, () => erpTaxCodePlantModel.ValidateRequest_GetAllTaxCodePlants(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodePlantModel.Process_GetAllTaxCodePlants(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a TaxCodePlant based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPTaxCodePlantDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodePlantDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/GENERAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetTaxCodePlantAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodePlantModel = new ERPTaxCodePlantModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodePlantModel, () => erpTaxCodePlantModel.ValidateRequest_GetTaxCodePlant(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodePlantModel.Process_GetTaxCodePlant(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="taxCodePlant">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPTaxCodePlantDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPTaxCodePlantDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodePlantDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutTaxCodePlantAsync([FromBody] ERPTaxCodePlantDto taxCodePlant)
	{
		using (erpTaxCodePlantModel = new ERPTaxCodePlantModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodePlantModel, () => erpTaxCodePlantModel.ValidateRequest_PutTaxCodePlant(taxCodePlant).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodePlantModel.Process_PutTaxCodePlant(taxCodePlant), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteTaxCodePlantAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodePlantModel = new ERPTaxCodePlantModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodePlantModel, () => erpTaxCodePlantModel.ValidateRequest_DeleteTaxCodePlant(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodePlantModel.Process_DeleteTaxCodePlant(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
