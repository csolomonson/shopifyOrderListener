...
[RoutePrefix("api/ERP/IndustryTypes")]
public class ERPIndustryTypesController : ERPBaseController
{
	public IERPIndustryTypeModel erpIndustryTypeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPIndustryTypeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPIndustryTypeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllIndustryTypeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpIndustryTypeModel = new ERPIndustryTypeModel())
		{
			return await RunApiMethod(base.Request, erpIndustryTypeModel, () => erpIndustryTypeModel.ValidateRequest_GetAllIndustryTypes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpIndustryTypeModel.Process_GetAllIndustryTypes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a IndustryType based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPIndustryTypeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPIndustryTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetIndustryTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpIndustryTypeModel = new ERPIndustryTypeModel())
		{
			return await RunApiMethod(base.Request, erpIndustryTypeModel, () => erpIndustryTypeModel.ValidateRequest_GetIndustryType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpIndustryTypeModel.Process_GetIndustryType(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="industryType">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPIndustryTypeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPIndustryTypeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPIndustryTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutIndustryTypeAsync([FromBody] ERPIndustryTypeDto industryType)
	{
		using (erpIndustryTypeModel = new ERPIndustryTypeModel())
		{
			return await RunApiMethod(base.Request, erpIndustryTypeModel, () => erpIndustryTypeModel.ValidateRequest_PutIndustryType(industryType).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpIndustryTypeModel.Process_PutIndustryType(industryType), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteIndustryTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpIndustryTypeModel = new ERPIndustryTypeModel())
		{
			return await RunApiMethod(base.Request, erpIndustryTypeModel, () => erpIndustryTypeModel.ValidateRequest_DeleteIndustryType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpIndustryTypeModel.Process_DeleteIndustryType(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
