...
[RoutePrefix("api/ERP/TaxCodeLines")]
public class ERPTaxCodeLinesController : ERPBaseController
{
	public IERPTaxCodeLineModel erpTaxCodeLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPTaxCodeLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllTaxCodeLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpTaxCodeLineModel = new ERPTaxCodeLineModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeLineModel, () => erpTaxCodeLineModel.ValidateRequest_GetAllTaxCodeLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeLineModel.Process_GetAllTaxCodeLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a TaxCodeLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodeLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/GENERAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetTaxCodeLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodeLineModel = new ERPTaxCodeLineModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeLineModel, () => erpTaxCodeLineModel.ValidateRequest_GetTaxCodeLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeLineModel.Process_GetTaxCodeLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="taxCodeLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPTaxCodeLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodeLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutTaxCodeLineAsync([FromBody] ERPTaxCodeLineDto taxCodeLine)
	{
		using (erpTaxCodeLineModel = new ERPTaxCodeLineModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeLineModel, () => erpTaxCodeLineModel.ValidateRequest_PutTaxCodeLine(taxCodeLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeLineModel.Process_PutTaxCodeLine(taxCodeLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteTaxCodeLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodeLineModel = new ERPTaxCodeLineModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeLineModel, () => erpTaxCodeLineModel.ValidateRequest_DeleteTaxCodeLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeLineModel.Process_DeleteTaxCodeLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
