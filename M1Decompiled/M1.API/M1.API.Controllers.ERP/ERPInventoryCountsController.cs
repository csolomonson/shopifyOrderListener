...
[RoutePrefix("api/ERP/InventoryCounts")]
public class ERPInventoryCountsController : ERPBaseController
{
	public IERPInventoryCountModel erpInventoryCountModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPInventoryCountDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPInventoryCountDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllInventoryCountAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpInventoryCountModel = new ERPInventoryCountModel())
		{
			return await RunApiMethod(base.Request, erpInventoryCountModel, () => erpInventoryCountModel.ValidateRequest_GetAllInventoryCounts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInventoryCountModel.Process_GetAllInventoryCounts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a InventoryCount based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPInventoryCountDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInventoryCountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetInventoryCountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInventoryCountModel = new ERPInventoryCountModel())
		{
			return await RunApiMethod(base.Request, erpInventoryCountModel, () => erpInventoryCountModel.ValidateRequest_GetInventoryCount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInventoryCountModel.Process_GetInventoryCount(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="inventoryCount">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPInventoryCountDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPInventoryCountDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInventoryCountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutInventoryCountAsync([FromBody] ERPInventoryCountDto inventoryCount)
	{
		using (erpInventoryCountModel = new ERPInventoryCountModel())
		{
			return await RunApiMethod(base.Request, erpInventoryCountModel, () => erpInventoryCountModel.ValidateRequest_PutInventoryCount(inventoryCount).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInventoryCountModel.Process_PutInventoryCount(inventoryCount), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteInventoryCountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInventoryCountModel = new ERPInventoryCountModel())
		{
			return await RunApiMethod(base.Request, erpInventoryCountModel, () => erpInventoryCountModel.ValidateRequest_DeleteInventoryCount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInventoryCountModel.Process_DeleteInventoryCount(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
