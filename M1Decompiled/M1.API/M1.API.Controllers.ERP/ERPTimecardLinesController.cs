...
[RoutePrefix("api/ERP/TimecardLines")]
public class ERPTimecardLinesController : ERPBaseController
{
	public IERPTimecardLineModel erpTimecardLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPTimecardLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPTimecardLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllTimecardLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpTimecardLineModel = new ERPTimecardLineModel())
		{
			return await RunApiMethod(base.Request, erpTimecardLineModel, () => erpTimecardLineModel.ValidateRequest_GetAllTimecardLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardLineModel.Process_GetAllTimecardLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a TimecardLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPTimecardLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTimecardLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DATACOLLECTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetTimecardLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTimecardLineModel = new ERPTimecardLineModel())
		{
			return await RunApiMethod(base.Request, erpTimecardLineModel, () => erpTimecardLineModel.ValidateRequest_GetTimecardLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardLineModel.Process_GetTimecardLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="timecardLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPTimecardLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPTimecardLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTimecardLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutTimecardLineAsync([FromBody] ERPTimecardLineDto timecardLine)
	{
		using (erpTimecardLineModel = new ERPTimecardLineModel())
		{
			return await RunApiMethod(base.Request, erpTimecardLineModel, () => erpTimecardLineModel.ValidateRequest_PutTimecardLine(timecardLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardLineModel.Process_PutTimecardLine(timecardLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteTimecardLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTimecardLineModel = new ERPTimecardLineModel())
		{
			return await RunApiMethod(base.Request, erpTimecardLineModel, () => erpTimecardLineModel.ValidateRequest_DeleteTimecardLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardLineModel.Process_DeleteTimecardLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
