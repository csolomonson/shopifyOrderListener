...
[RoutePrefix("api/ERP/APPaymentLines")]
public class ERPAPPaymentLinesController : ERPBaseController
{
	public IERPAPPaymentLineModel erpAPPaymentLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPPaymentLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPPaymentLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPPaymentLineModel = new ERPAPPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentLineModel, () => erpAPPaymentLineModel.ValidateRequest_GetAllAPPaymentLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentLineModel.Process_GetAllAPPaymentLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APPaymentLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPPaymentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentLineModel = new ERPAPPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentLineModel, () => erpAPPaymentLineModel.ValidateRequest_GetAPPaymentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentLineModel.Process_GetAPPaymentLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPPaymentLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPPaymentLineAsync([FromBody] ERPAPPaymentLineDto aPPaymentLine)
	{
		using (erpAPPaymentLineModel = new ERPAPPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentLineModel, () => erpAPPaymentLineModel.ValidateRequest_PutAPPaymentLine(aPPaymentLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentLineModel.Process_PutAPPaymentLine(aPPaymentLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPPaymentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentLineModel = new ERPAPPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentLineModel, () => erpAPPaymentLineModel.ValidateRequest_DeleteAPPaymentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentLineModel.Process_DeleteAPPaymentLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
