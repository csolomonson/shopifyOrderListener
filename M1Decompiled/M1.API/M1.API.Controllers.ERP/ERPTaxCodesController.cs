...
[RoutePrefix("api/ERP/TaxCodes")]
public class ERPTaxCodesController : ERPBaseController
{
	public IERPTaxCodeModel erpTaxCodeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPTaxCodeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllTaxCodeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpTaxCodeModel = new ERPTaxCodeModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeModel, () => erpTaxCodeModel.ValidateRequest_GetAllTaxCodes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeModel.Process_GetAllTaxCodes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a TaxCode based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/GENERAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetTaxCodeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodeModel = new ERPTaxCodeModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeModel, () => erpTaxCodeModel.ValidateRequest_GetTaxCode(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeModel.Process_GetTaxCode(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="taxCode">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPTaxCodeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPTaxCodeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTaxCodeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutTaxCodeAsync([FromBody] ERPTaxCodeDto taxCode)
	{
		using (erpTaxCodeModel = new ERPTaxCodeModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeModel, () => erpTaxCodeModel.ValidateRequest_PutTaxCode(taxCode).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeModel.Process_PutTaxCode(taxCode), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteTaxCodeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTaxCodeModel = new ERPTaxCodeModel())
		{
			return await RunApiMethod(base.Request, erpTaxCodeModel, () => erpTaxCodeModel.ValidateRequest_DeleteTaxCode(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTaxCodeModel.Process_DeleteTaxCode(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
