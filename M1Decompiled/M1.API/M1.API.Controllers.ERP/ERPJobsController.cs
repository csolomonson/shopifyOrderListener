...
[RoutePrefix("api/ERP/Jobs")]
public class ERPJobsController : ERPBaseController
{
	public IERPJobModel erpJobModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobModel = new ERPJobModel())
		{
			return await RunApiMethod(base.Request, erpJobModel, () => erpJobModel.ValidateRequest_GetAllJobs(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobModel.Process_GetAllJobs(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Job based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobModel = new ERPJobModel())
		{
			return await RunApiMethod(base.Request, erpJobModel, () => erpJobModel.ValidateRequest_GetJob(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobModel.Process_GetJob(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="job">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobAsync([FromBody] ERPJobDto job)
	{
		using (erpJobModel = new ERPJobModel())
		{
			return await RunApiMethod(base.Request, erpJobModel, () => erpJobModel.ValidateRequest_PutJob(job).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobModel.Process_PutJob(job), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobModel = new ERPJobModel())
		{
			return await RunApiMethod(base.Request, erpJobModel, () => erpJobModel.ValidateRequest_DeleteJob(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobModel.Process_DeleteJob(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
