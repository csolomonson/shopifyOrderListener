...
[RoutePrefix("api/ERP/AttachmentMemos")]
public class ERPAttachmentMemosController : ERPBaseController
{
	public IERPAttachmentMemoModel erpAttachmentMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAttachmentMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAttachmentMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAttachmentMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAttachmentMemoModel = new ERPAttachmentMemoModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentMemoModel, () => erpAttachmentMemoModel.ValidateRequest_GetAllAttachmentMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentMemoModel.Process_GetAllAttachmentMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AttachmentMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAttachmentMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DOCUMENTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAttachmentMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentMemoModel = new ERPAttachmentMemoModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentMemoModel, () => erpAttachmentMemoModel.ValidateRequest_GetAttachmentMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentMemoModel.Process_GetAttachmentMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="attachmentMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAttachmentMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAttachmentMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAttachmentMemoAsync([FromBody] ERPAttachmentMemoDto attachmentMemo)
	{
		using (erpAttachmentMemoModel = new ERPAttachmentMemoModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentMemoModel, () => erpAttachmentMemoModel.ValidateRequest_PutAttachmentMemo(attachmentMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentMemoModel.Process_PutAttachmentMemo(attachmentMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAttachmentMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentMemoModel = new ERPAttachmentMemoModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentMemoModel, () => erpAttachmentMemoModel.ValidateRequest_DeleteAttachmentMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentMemoModel.Process_DeleteAttachmentMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
