...
[RoutePrefix("api/ERP/CurrencyRates")]
public class ERPCurrencyRatesController : ERPBaseController
{
	public IERPCurrencyRateModel erpCurrencyRateModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPCurrencyRateDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPCurrencyRateDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllCurrencyRateAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpCurrencyRateModel = new ERPCurrencyRateModel())
		{
			return await RunApiMethod(base.Request, erpCurrencyRateModel, () => erpCurrencyRateModel.ValidateRequest_GetAllCurrencyRates(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCurrencyRateModel.Process_GetAllCurrencyRates(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a CurrencyRate based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPCurrencyRateDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCurrencyRateDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/GENERAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetCurrencyRateAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCurrencyRateModel = new ERPCurrencyRateModel())
		{
			return await RunApiMethod(base.Request, erpCurrencyRateModel, () => erpCurrencyRateModel.ValidateRequest_GetCurrencyRate(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCurrencyRateModel.Process_GetCurrencyRate(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="currencyRate">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPCurrencyRateDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPCurrencyRateDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCurrencyRateDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutCurrencyRateAsync([FromBody] ERPCurrencyRateDto currencyRate)
	{
		using (erpCurrencyRateModel = new ERPCurrencyRateModel())
		{
			return await RunApiMethod(base.Request, erpCurrencyRateModel, () => erpCurrencyRateModel.ValidateRequest_PutCurrencyRate(currencyRate).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCurrencyRateModel.Process_PutCurrencyRate(currencyRate), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteCurrencyRateAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCurrencyRateModel = new ERPCurrencyRateModel())
		{
			return await RunApiMethod(base.Request, erpCurrencyRateModel, () => erpCurrencyRateModel.ValidateRequest_DeleteCurrencyRate(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCurrencyRateModel.Process_DeleteCurrencyRate(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
