...
[RoutePrefix("api/ERP/APInvoiceLines")]
public class ERPAPInvoiceLinesController : ERPBaseController
{
	public IERPAPInvoiceLineModel erpAPInvoiceLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPInvoiceLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPInvoiceLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPInvoiceLineModel = new ERPAPInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceLineModel, () => erpAPInvoiceLineModel.ValidateRequest_GetAllAPInvoiceLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceLineModel.Process_GetAllAPInvoiceLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APInvoiceLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPInvoiceLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceLineModel = new ERPAPInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceLineModel, () => erpAPInvoiceLineModel.ValidateRequest_GetAPInvoiceLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceLineModel.Process_GetAPInvoiceLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPInvoiceLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPInvoiceLineAsync([FromBody] ERPAPInvoiceLineDto aPInvoiceLine)
	{
		using (erpAPInvoiceLineModel = new ERPAPInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceLineModel, () => erpAPInvoiceLineModel.ValidateRequest_PutAPInvoiceLine(aPInvoiceLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceLineModel.Process_PutAPInvoiceLine(aPInvoiceLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPInvoiceLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceLineModel = new ERPAPInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceLineModel, () => erpAPInvoiceLineModel.ValidateRequest_DeleteAPInvoiceLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceLineModel.Process_DeleteAPInvoiceLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
