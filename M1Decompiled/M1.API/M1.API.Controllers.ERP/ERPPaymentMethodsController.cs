...
[RoutePrefix("api/ERP/PaymentMethods")]
public class ERPPaymentMethodsController : ERPBaseController
{
	public IERPPaymentMethodModel erpPaymentMethodModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPaymentMethodDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPaymentMethodDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPaymentMethodAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPaymentMethodModel = new ERPPaymentMethodModel())
		{
			return await RunApiMethod(base.Request, erpPaymentMethodModel, () => erpPaymentMethodModel.ValidateRequest_GetAllPaymentMethods(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPaymentMethodModel.Process_GetAllPaymentMethods(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PaymentMethod based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPaymentMethodDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPaymentMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPaymentMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPaymentMethodModel = new ERPPaymentMethodModel())
		{
			return await RunApiMethod(base.Request, erpPaymentMethodModel, () => erpPaymentMethodModel.ValidateRequest_GetPaymentMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPaymentMethodModel.Process_GetPaymentMethod(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="paymentMethod">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPaymentMethodDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPaymentMethodDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPaymentMethodDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPaymentMethodAsync([FromBody] ERPPaymentMethodDto paymentMethod)
	{
		using (erpPaymentMethodModel = new ERPPaymentMethodModel())
		{
			return await RunApiMethod(base.Request, erpPaymentMethodModel, () => erpPaymentMethodModel.ValidateRequest_PutPaymentMethod(paymentMethod).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPaymentMethodModel.Process_PutPaymentMethod(paymentMethod), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePaymentMethodAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPaymentMethodModel = new ERPPaymentMethodModel())
		{
			return await RunApiMethod(base.Request, erpPaymentMethodModel, () => erpPaymentMethodModel.ValidateRequest_DeletePaymentMethod(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPaymentMethodModel.Process_DeletePaymentMethod(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
