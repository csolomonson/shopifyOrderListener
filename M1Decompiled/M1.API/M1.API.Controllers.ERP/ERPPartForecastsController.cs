...
[RoutePrefix("api/ERP/PartForecasts")]
public class ERPPartForecastsController : ERPBaseController
{
	public IERPPartForecastModel erpPartForecastModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartForecastDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartForecastDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartForecastAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartForecastModel = new ERPPartForecastModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastModel, () => erpPartForecastModel.ValidateRequest_GetAllPartForecasts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastModel.Process_GetAllPartForecasts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartForecast based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartForecastDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartForecastDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartForecastAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartForecastModel = new ERPPartForecastModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastModel, () => erpPartForecastModel.ValidateRequest_GetPartForecast(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastModel.Process_GetPartForecast(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partForecast">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartForecastDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartForecastDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartForecastDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartForecastAsync([FromBody] ERPPartForecastDto partForecast)
	{
		using (erpPartForecastModel = new ERPPartForecastModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastModel, () => erpPartForecastModel.ValidateRequest_PutPartForecast(partForecast).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastModel.Process_PutPartForecast(partForecast), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartForecastAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartForecastModel = new ERPPartForecastModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastModel, () => erpPartForecastModel.ValidateRequest_DeletePartForecast(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastModel.Process_DeletePartForecast(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
