...
[RoutePrefix("api/ERP/RFQs")]
public class ERPRFQsController : ERPBaseController
{
	public IERPRFQModel erpRFQModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRFQDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRFQDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRFQAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRFQModel = new ERPRFQModel())
		{
			return await RunApiMethod(base.Request, erpRFQModel, () => erpRFQModel.ValidateRequest_GetAllRFQs(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQModel.Process_GetAllRFQs(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RFQ based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRFQDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRFQAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQModel = new ERPRFQModel())
		{
			return await RunApiMethod(base.Request, erpRFQModel, () => erpRFQModel.ValidateRequest_GetRFQ(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQModel.Process_GetRFQ(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rFQ">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRFQDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRFQDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRFQAsync([FromBody] ERPRFQDto rFQ)
	{
		using (erpRFQModel = new ERPRFQModel())
		{
			return await RunApiMethod(base.Request, erpRFQModel, () => erpRFQModel.ValidateRequest_PutRFQ(rFQ).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQModel.Process_PutRFQ(rFQ), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRFQAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQModel = new ERPRFQModel())
		{
			return await RunApiMethod(base.Request, erpRFQModel, () => erpRFQModel.ValidateRequest_DeleteRFQ(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQModel.Process_DeleteRFQ(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
