...
[RoutePrefix("api/ERP/PartClasses")]
public class ERPPartClassesController : ERPBaseController
{
	public IERPPartClassModel erpPartClassModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartClassDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartClassDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartClassAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartClassModel = new ERPPartClassModel())
		{
			return await RunApiMethod(base.Request, erpPartClassModel, () => erpPartClassModel.ValidateRequest_GetAllPartClasses(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartClassModel.Process_GetAllPartClasses(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartClass based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartClassDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartClassDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartClassAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartClassModel = new ERPPartClassModel())
		{
			return await RunApiMethod(base.Request, erpPartClassModel, () => erpPartClassModel.ValidateRequest_GetPartClass(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartClassModel.Process_GetPartClass(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partClass">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartClassDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartClassDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartClassDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartClassAsync([FromBody] ERPPartClassDto partClass)
	{
		using (erpPartClassModel = new ERPPartClassModel())
		{
			return await RunApiMethod(base.Request, erpPartClassModel, () => erpPartClassModel.ValidateRequest_PutPartClass(partClass).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartClassModel.Process_PutPartClass(partClass), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartClassAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartClassModel = new ERPPartClassModel())
		{
			return await RunApiMethod(base.Request, erpPartClassModel, () => erpPartClassModel.ValidateRequest_DeletePartClass(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartClassModel.Process_DeletePartClass(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
