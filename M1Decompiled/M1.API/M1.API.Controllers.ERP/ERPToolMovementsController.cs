...
[RoutePrefix("api/ERP/ToolMovements")]
public class ERPToolMovementsController : ERPBaseController
{
	public IERPToolMovementModel erpToolMovementModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPToolMovementDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPToolMovementDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllToolMovementAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpToolMovementModel = new ERPToolMovementModel())
		{
			return await RunApiMethod(base.Request, erpToolMovementModel, () => erpToolMovementModel.ValidateRequest_GetAllToolMovements(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMovementModel.Process_GetAllToolMovements(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ToolMovement based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPToolMovementDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolMovementDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetToolMovementAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolMovementModel = new ERPToolMovementModel())
		{
			return await RunApiMethod(base.Request, erpToolMovementModel, () => erpToolMovementModel.ValidateRequest_GetToolMovement(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMovementModel.Process_GetToolMovement(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="toolMovement">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPToolMovementDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPToolMovementDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolMovementDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutToolMovementAsync([FromBody] ERPToolMovementDto toolMovement)
	{
		using (erpToolMovementModel = new ERPToolMovementModel())
		{
			return await RunApiMethod(base.Request, erpToolMovementModel, () => erpToolMovementModel.ValidateRequest_PutToolMovement(toolMovement).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMovementModel.Process_PutToolMovement(toolMovement), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteToolMovementAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolMovementModel = new ERPToolMovementModel())
		{
			return await RunApiMethod(base.Request, erpToolMovementModel, () => erpToolMovementModel.ValidateRequest_DeleteToolMovement(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMovementModel.Process_DeleteToolMovement(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
