...
[RoutePrefix("api/ERP/AssetLowValuePool")]
public class ERPAssetLowValuePoolController : ERPBaseController
{
	public IERPAssetLowValuePoolModel erpAssetLowValuePoolModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAssetLowValuePoolDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAssetLowValuePoolDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAssetLowValuePoolAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAssetLowValuePoolModel = new ERPAssetLowValuePoolModel())
		{
			return await RunApiMethod(base.Request, erpAssetLowValuePoolModel, () => erpAssetLowValuePoolModel.ValidateRequest_GetAllAssetLowValuePool(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetLowValuePoolModel.Process_GetAllAssetLowValuePool(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AssetLowValuePool based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAssetLowValuePoolDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetLowValuePoolDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAssetLowValuePoolAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetLowValuePoolModel = new ERPAssetLowValuePoolModel())
		{
			return await RunApiMethod(base.Request, erpAssetLowValuePoolModel, () => erpAssetLowValuePoolModel.ValidateRequest_GetAssetLowValuePool(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetLowValuePoolModel.Process_GetAssetLowValuePool(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="assetLowValuePool">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAssetLowValuePoolDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAssetLowValuePoolDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetLowValuePoolDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAssetLowValuePoolAsync([FromBody] ERPAssetLowValuePoolDto assetLowValuePool)
	{
		using (erpAssetLowValuePoolModel = new ERPAssetLowValuePoolModel())
		{
			return await RunApiMethod(base.Request, erpAssetLowValuePoolModel, () => erpAssetLowValuePoolModel.ValidateRequest_PutAssetLowValuePool(assetLowValuePool).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetLowValuePoolModel.Process_PutAssetLowValuePool(assetLowValuePool), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAssetLowValuePoolAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetLowValuePoolModel = new ERPAssetLowValuePoolModel())
		{
			return await RunApiMethod(base.Request, erpAssetLowValuePoolModel, () => erpAssetLowValuePoolModel.ValidateRequest_DeleteAssetLowValuePool(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetLowValuePoolModel.Process_DeleteAssetLowValuePool(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
