...
[RoutePrefix("api/ERP/ReceiptLines")]
public class ERPReceiptLinesController : ERPBaseController
{
	public IERPReceiptLineModel erpReceiptLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPReceiptLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPReceiptLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllReceiptLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpReceiptLineModel = new ERPReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpReceiptLineModel, () => erpReceiptLineModel.ValidateRequest_GetAllReceiptLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptLineModel.Process_GetAllReceiptLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ReceiptLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPReceiptLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASERECEIPTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetReceiptLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpReceiptLineModel = new ERPReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpReceiptLineModel, () => erpReceiptLineModel.ValidateRequest_GetReceiptLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptLineModel.Process_GetReceiptLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="receiptLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPReceiptLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPReceiptLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutReceiptLineAsync([FromBody] ERPReceiptLineDto receiptLine)
	{
		using (erpReceiptLineModel = new ERPReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpReceiptLineModel, () => erpReceiptLineModel.ValidateRequest_PutReceiptLine(receiptLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptLineModel.Process_PutReceiptLine(receiptLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteReceiptLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpReceiptLineModel = new ERPReceiptLineModel())
		{
			return await RunApiMethod(base.Request, erpReceiptLineModel, () => erpReceiptLineModel.ValidateRequest_DeleteReceiptLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpReceiptLineModel.Process_DeleteReceiptLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
