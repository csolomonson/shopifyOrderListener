...
[RoutePrefix("api/ERP/CallMemos")]
public class ERPCallMemosController : ERPBaseController
{
	public IERPCallMemoModel erpCallMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPCallMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPCallMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllCallMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpCallMemoModel = new ERPCallMemoModel())
		{
			return await RunApiMethod(base.Request, erpCallMemoModel, () => erpCallMemoModel.ValidateRequest_GetAllCallMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCallMemoModel.Process_GetAllCallMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a CallMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPCallMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCallMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetCallMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCallMemoModel = new ERPCallMemoModel())
		{
			return await RunApiMethod(base.Request, erpCallMemoModel, () => erpCallMemoModel.ValidateRequest_GetCallMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCallMemoModel.Process_GetCallMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="callMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPCallMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPCallMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCallMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutCallMemoAsync([FromBody] ERPCallMemoDto callMemo)
	{
		using (erpCallMemoModel = new ERPCallMemoModel())
		{
			return await RunApiMethod(base.Request, erpCallMemoModel, () => erpCallMemoModel.ValidateRequest_PutCallMemo(callMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCallMemoModel.Process_PutCallMemo(callMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteCallMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCallMemoModel = new ERPCallMemoModel())
		{
			return await RunApiMethod(base.Request, erpCallMemoModel, () => erpCallMemoModel.ValidateRequest_DeleteCallMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCallMemoModel.Process_DeleteCallMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
