...
[RoutePrefix("api/ERP/ToolMemos")]
public class ERPToolMemosController : ERPBaseController
{
	public IERPToolMemoModel erpToolMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPToolMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPToolMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllToolMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpToolMemoModel = new ERPToolMemoModel())
		{
			return await RunApiMethod(base.Request, erpToolMemoModel, () => erpToolMemoModel.ValidateRequest_GetAllToolMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMemoModel.Process_GetAllToolMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ToolMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPToolMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetToolMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolMemoModel = new ERPToolMemoModel())
		{
			return await RunApiMethod(base.Request, erpToolMemoModel, () => erpToolMemoModel.ValidateRequest_GetToolMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMemoModel.Process_GetToolMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="toolMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPToolMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPToolMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutToolMemoAsync([FromBody] ERPToolMemoDto toolMemo)
	{
		using (erpToolMemoModel = new ERPToolMemoModel())
		{
			return await RunApiMethod(base.Request, erpToolMemoModel, () => erpToolMemoModel.ValidateRequest_PutToolMemo(toolMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMemoModel.Process_PutToolMemo(toolMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteToolMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolMemoModel = new ERPToolMemoModel())
		{
			return await RunApiMethod(base.Request, erpToolMemoModel, () => erpToolMemoModel.ValidateRequest_DeleteToolMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolMemoModel.Process_DeleteToolMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
