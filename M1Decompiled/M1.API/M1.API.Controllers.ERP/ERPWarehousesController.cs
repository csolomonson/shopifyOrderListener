...
[RoutePrefix("api/ERP/Warehouses")]
public class ERPWarehousesController : ERPBaseController
{
	public IERPWarehouseModel erpWarehouseModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWarehouseDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWarehouseDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWarehouseAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWarehouseModel = new ERPWarehouseModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseModel, () => erpWarehouseModel.ValidateRequest_GetAllWarehouses(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseModel.Process_GetAllWarehouses(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Warehouse based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWarehouseDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWarehouseAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseModel = new ERPWarehouseModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseModel, () => erpWarehouseModel.ValidateRequest_GetWarehouse(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseModel.Process_GetWarehouse(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="warehouse">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWarehouseDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWarehouseDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWarehouseDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWarehouseAsync([FromBody] ERPWarehouseDto warehouse)
	{
		using (erpWarehouseModel = new ERPWarehouseModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseModel, () => erpWarehouseModel.ValidateRequest_PutWarehouse(warehouse).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseModel.Process_PutWarehouse(warehouse), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWarehouseAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWarehouseModel = new ERPWarehouseModel())
		{
			return await RunApiMethod(base.Request, erpWarehouseModel, () => erpWarehouseModel.ValidateRequest_DeleteWarehouse(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWarehouseModel.Process_DeleteWarehouse(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
