...
[RoutePrefix("api/ERP/QuoteAssemblies")]
public class ERPQuoteAssembliesController : ERPBaseController
{
	public IERPQuoteAssemblyModel erpQuoteAssemblyModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPQuoteAssemblyDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPQuoteAssemblyDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllQuoteAssemblyAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpQuoteAssemblyModel = new ERPQuoteAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpQuoteAssemblyModel, () => erpQuoteAssemblyModel.ValidateRequest_GetAllQuoteAssemblies(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteAssemblyModel.Process_GetAllQuoteAssemblies(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a QuoteAssembly based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPQuoteAssemblyDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUOTATIONS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetQuoteAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteAssemblyModel = new ERPQuoteAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpQuoteAssemblyModel, () => erpQuoteAssemblyModel.ValidateRequest_GetQuoteAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteAssemblyModel.Process_GetQuoteAssembly(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="quoteAssembly">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPQuoteAssemblyDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPQuoteAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutQuoteAssemblyAsync([FromBody] ERPQuoteAssemblyDto quoteAssembly)
	{
		using (erpQuoteAssemblyModel = new ERPQuoteAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpQuoteAssemblyModel, () => erpQuoteAssemblyModel.ValidateRequest_PutQuoteAssembly(quoteAssembly).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteAssemblyModel.Process_PutQuoteAssembly(quoteAssembly), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteQuoteAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteAssemblyModel = new ERPQuoteAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpQuoteAssemblyModel, () => erpQuoteAssemblyModel.ValidateRequest_DeleteQuoteAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteAssemblyModel.Process_DeleteQuoteAssembly(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
