...
[RoutePrefix("api/ERP/NextIDs")]
public class ERPNextIDsController : ERPBaseController
{
	public IERPNextIDModel erpNextIDModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPNextIDDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPNextIDDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllNextIDAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpNextIDModel = new ERPNextIDModel())
		{
			return await RunApiMethod(base.Request, erpNextIDModel, () => erpNextIDModel.ValidateRequest_GetAllNextIDs(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNextIDModel.Process_GetAllNextIDs(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a NextID based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPNextIDDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPNextIDDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/GENERAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetNextIDAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpNextIDModel = new ERPNextIDModel())
		{
			return await RunApiMethod(base.Request, erpNextIDModel, () => erpNextIDModel.ValidateRequest_GetNextID(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNextIDModel.Process_GetNextID(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="nextID">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPNextIDDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPNextIDDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPNextIDDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutNextIDAsync([FromBody] ERPNextIDDto nextID)
	{
		using (erpNextIDModel = new ERPNextIDModel())
		{
			return await RunApiMethod(base.Request, erpNextIDModel, () => erpNextIDModel.ValidateRequest_PutNextID(nextID).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNextIDModel.Process_PutNextID(nextID), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteNextIDAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpNextIDModel = new ERPNextIDModel())
		{
			return await RunApiMethod(base.Request, erpNextIDModel, () => erpNextIDModel.ValidateRequest_DeleteNextID(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpNextIDModel.Process_DeleteNextID(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
