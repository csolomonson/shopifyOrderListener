...
[RoutePrefix("api/ERP/LeadMemos")]
public class ERPLeadMemosController : ERPBaseController
{
	public IERPLeadMemoModel erpLeadMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLeadMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLeadMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLeadMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLeadMemoModel = new ERPLeadMemoModel())
		{
			return await RunApiMethod(base.Request, erpLeadMemoModel, () => erpLeadMemoModel.ValidateRequest_GetAllLeadMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadMemoModel.Process_GetAllLeadMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LeadMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLeadMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLeadMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadMemoModel = new ERPLeadMemoModel())
		{
			return await RunApiMethod(base.Request, erpLeadMemoModel, () => erpLeadMemoModel.ValidateRequest_GetLeadMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadMemoModel.Process_GetLeadMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="leadMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLeadMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLeadMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLeadMemoAsync([FromBody] ERPLeadMemoDto leadMemo)
	{
		using (erpLeadMemoModel = new ERPLeadMemoModel())
		{
			return await RunApiMethod(base.Request, erpLeadMemoModel, () => erpLeadMemoModel.ValidateRequest_PutLeadMemo(leadMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadMemoModel.Process_PutLeadMemo(leadMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLeadMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadMemoModel = new ERPLeadMemoModel())
		{
			return await RunApiMethod(base.Request, erpLeadMemoModel, () => erpLeadMemoModel.ValidateRequest_DeleteLeadMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadMemoModel.Process_DeleteLeadMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
