...
[RoutePrefix("api/ERP/ChangeRequests")]
public class ERPChangeRequestsController : ERPBaseController
{
	public IERPChangeRequestModel erpChangeRequestModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPChangeRequestDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPChangeRequestDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllChangeRequestAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpChangeRequestModel = new ERPChangeRequestModel())
		{
			return await RunApiMethod(base.Request, erpChangeRequestModel, () => erpChangeRequestModel.ValidateRequest_GetAllChangeRequests(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpChangeRequestModel.Process_GetAllChangeRequests(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ChangeRequest based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPChangeRequestDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPChangeRequestDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetChangeRequestAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpChangeRequestModel = new ERPChangeRequestModel())
		{
			return await RunApiMethod(base.Request, erpChangeRequestModel, () => erpChangeRequestModel.ValidateRequest_GetChangeRequest(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpChangeRequestModel.Process_GetChangeRequest(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="changeRequest">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPChangeRequestDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPChangeRequestDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPChangeRequestDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutChangeRequestAsync([FromBody] ERPChangeRequestDto changeRequest)
	{
		using (erpChangeRequestModel = new ERPChangeRequestModel())
		{
			return await RunApiMethod(base.Request, erpChangeRequestModel, () => erpChangeRequestModel.ValidateRequest_PutChangeRequest(changeRequest).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpChangeRequestModel.Process_PutChangeRequest(changeRequest), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteChangeRequestAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpChangeRequestModel = new ERPChangeRequestModel())
		{
			return await RunApiMethod(base.Request, erpChangeRequestModel, () => erpChangeRequestModel.ValidateRequest_DeleteChangeRequest(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpChangeRequestModel.Process_DeleteChangeRequest(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
