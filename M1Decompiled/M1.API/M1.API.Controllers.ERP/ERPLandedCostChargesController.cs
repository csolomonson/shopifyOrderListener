...
[RoutePrefix("api/ERP/LandedCostCharges")]
public class ERPLandedCostChargesController : ERPBaseController
{
	public IERPLandedCostChargeModel erpLandedCostChargeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLandedCostChargeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLandedCostChargeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLandedCostChargeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLandedCostChargeModel = new ERPLandedCostChargeModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostChargeModel, () => erpLandedCostChargeModel.ValidateRequest_GetAllLandedCostCharges(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostChargeModel.Process_GetAllLandedCostCharges(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LandedCostCharge based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLandedCostChargeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLandedCostChargeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLandedCostChargeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLandedCostChargeModel = new ERPLandedCostChargeModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostChargeModel, () => erpLandedCostChargeModel.ValidateRequest_GetLandedCostCharge(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostChargeModel.Process_GetLandedCostCharge(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="landedCostCharge">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLandedCostChargeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLandedCostChargeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLandedCostChargeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLandedCostChargeAsync([FromBody] ERPLandedCostChargeDto landedCostCharge)
	{
		using (erpLandedCostChargeModel = new ERPLandedCostChargeModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostChargeModel, () => erpLandedCostChargeModel.ValidateRequest_PutLandedCostCharge(landedCostCharge).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostChargeModel.Process_PutLandedCostCharge(landedCostCharge), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLandedCostChargeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLandedCostChargeModel = new ERPLandedCostChargeModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostChargeModel, () => erpLandedCostChargeModel.ValidateRequest_DeleteLandedCostCharge(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostChargeModel.Process_DeleteLandedCostCharge(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
