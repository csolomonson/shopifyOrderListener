...
[RoutePrefix("api/ERP/APPaymentSessions")]
public class ERPAPPaymentSessionsController : ERPBaseController
{
	public IERPAPPaymentSessionModel erpAPPaymentSessionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentSessionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPPaymentSessionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPPaymentSessionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPPaymentSessionModel = new ERPAPPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentSessionModel, () => erpAPPaymentSessionModel.ValidateRequest_GetAllAPPaymentSessions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentSessionModel.Process_GetAllAPPaymentSessions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APPaymentSession based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentSessionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPPaymentSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentSessionModel = new ERPAPPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentSessionModel, () => erpAPPaymentSessionModel.ValidateRequest_GetAPPaymentSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentSessionModel.Process_GetAPPaymentSession(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPPaymentSession">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentSessionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPPaymentSessionAsync([FromBody] ERPAPPaymentSessionDto aPPaymentSession)
	{
		using (erpAPPaymentSessionModel = new ERPAPPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentSessionModel, () => erpAPPaymentSessionModel.ValidateRequest_PutAPPaymentSession(aPPaymentSession).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentSessionModel.Process_PutAPPaymentSession(aPPaymentSession), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPPaymentSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentSessionModel = new ERPAPPaymentSessionModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentSessionModel, () => erpAPPaymentSessionModel.ValidateRequest_DeleteAPPaymentSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentSessionModel.Process_DeleteAPPaymentSession(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
