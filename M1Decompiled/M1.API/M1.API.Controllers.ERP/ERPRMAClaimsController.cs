...
[RoutePrefix("api/ERP/RMAClaims")]
public class ERPRMAClaimsController : ERPBaseController
{
	public IERPRMAClaimModel erpRMAClaimModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRMAClaimDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRMAClaimAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRMAClaimModel = new ERPRMAClaimModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimModel, () => erpRMAClaimModel.ValidateRequest_GetAllRMAClaims(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimModel.Process_GetAllRMAClaims(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RMAClaim based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAClaimDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRMAClaimAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAClaimModel = new ERPRMAClaimModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimModel, () => erpRMAClaimModel.ValidateRequest_GetRMAClaim(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimModel.Process_GetRMAClaim(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rMAClaim">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRMAClaimDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAClaimDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRMAClaimAsync([FromBody] ERPRMAClaimDto rMAClaim)
	{
		using (erpRMAClaimModel = new ERPRMAClaimModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimModel, () => erpRMAClaimModel.ValidateRequest_PutRMAClaim(rMAClaim).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimModel.Process_PutRMAClaim(rMAClaim), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRMAClaimAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAClaimModel = new ERPRMAClaimModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimModel, () => erpRMAClaimModel.ValidateRequest_DeleteRMAClaim(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimModel.Process_DeleteRMAClaim(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
