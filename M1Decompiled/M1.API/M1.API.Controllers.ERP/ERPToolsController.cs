...
[RoutePrefix("api/ERP/Tools")]
public class ERPToolsController : ERPBaseController
{
	public IERPToolModel erpToolModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPToolDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPToolDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllToolAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpToolModel = new ERPToolModel())
		{
			return await RunApiMethod(base.Request, erpToolModel, () => erpToolModel.ValidateRequest_GetAllTools(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolModel.Process_GetAllTools(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Tool based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPToolDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetToolAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolModel = new ERPToolModel())
		{
			return await RunApiMethod(base.Request, erpToolModel, () => erpToolModel.ValidateRequest_GetTool(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolModel.Process_GetTool(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="tool">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPToolDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPToolDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPToolDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutToolAsync([FromBody] ERPToolDto tool)
	{
		using (erpToolModel = new ERPToolModel())
		{
			return await RunApiMethod(base.Request, erpToolModel, () => erpToolModel.ValidateRequest_PutTool(tool).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolModel.Process_PutTool(tool), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteToolAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpToolModel = new ERPToolModel())
		{
			return await RunApiMethod(base.Request, erpToolModel, () => erpToolModel.ValidateRequest_DeleteTool(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpToolModel.Process_DeleteTool(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
