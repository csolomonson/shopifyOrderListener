...
[RoutePrefix("api/ERP/BankAccounts")]
public class ERPBankAccountsController : ERPBaseController
{
	public IERPBankAccountModel erpBankAccountModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPBankAccountDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPBankAccountDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllBankAccountAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpBankAccountModel = new ERPBankAccountModel())
		{
			return await RunApiMethod(base.Request, erpBankAccountModel, () => erpBankAccountModel.ValidateRequest_GetAllBankAccounts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankAccountModel.Process_GetAllBankAccounts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a BankAccount based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPBankAccountDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPBankAccountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetBankAccountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpBankAccountModel = new ERPBankAccountModel())
		{
			return await RunApiMethod(base.Request, erpBankAccountModel, () => erpBankAccountModel.ValidateRequest_GetBankAccount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankAccountModel.Process_GetBankAccount(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="bankAccount">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPBankAccountDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPBankAccountDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPBankAccountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutBankAccountAsync([FromBody] ERPBankAccountDto bankAccount)
	{
		using (erpBankAccountModel = new ERPBankAccountModel())
		{
			return await RunApiMethod(base.Request, erpBankAccountModel, () => erpBankAccountModel.ValidateRequest_PutBankAccount(bankAccount).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankAccountModel.Process_PutBankAccount(bankAccount), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteBankAccountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpBankAccountModel = new ERPBankAccountModel())
		{
			return await RunApiMethod(base.Request, erpBankAccountModel, () => erpBankAccountModel.ValidateRequest_DeleteBankAccount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpBankAccountModel.Process_DeleteBankAccount(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
