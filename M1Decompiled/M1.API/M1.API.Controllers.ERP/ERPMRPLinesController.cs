...
[RoutePrefix("api/ERP/MRPLines")]
public class ERPMRPLinesController : ERPBaseController
{
	public IERPMRPLineModel erpMRPLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMRPLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMRPLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMRPLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMRPLineModel = new ERPMRPLineModel())
		{
			return await RunApiMethod(base.Request, erpMRPLineModel, () => erpMRPLineModel.ValidateRequest_GetAllMRPLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPLineModel.Process_GetAllMRPLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MRPLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMRPLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMRPLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPLineModel = new ERPMRPLineModel())
		{
			return await RunApiMethod(base.Request, erpMRPLineModel, () => erpMRPLineModel.ValidateRequest_GetMRPLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPLineModel.Process_GetMRPLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="mRPLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMRPLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMRPLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMRPLineAsync([FromBody] ERPMRPLineDto mRPLine)
	{
		using (erpMRPLineModel = new ERPMRPLineModel())
		{
			return await RunApiMethod(base.Request, erpMRPLineModel, () => erpMRPLineModel.ValidateRequest_PutMRPLine(mRPLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPLineModel.Process_PutMRPLine(mRPLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMRPLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPLineModel = new ERPMRPLineModel())
		{
			return await RunApiMethod(base.Request, erpMRPLineModel, () => erpMRPLineModel.ValidateRequest_DeleteMRPLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPLineModel.Process_DeleteMRPLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
