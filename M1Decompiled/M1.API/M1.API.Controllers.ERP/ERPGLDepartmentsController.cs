...
[RoutePrefix("api/ERP/GLDepartments")]
public class ERPGLDepartmentsController : ERPBaseController
{
	public IERPGLDepartmentModel erpGLDepartmentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLDepartmentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLDepartmentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLDepartmentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLDepartmentModel = new ERPGLDepartmentModel())
		{
			return await RunApiMethod(base.Request, erpGLDepartmentModel, () => erpGLDepartmentModel.ValidateRequest_GetAllGLDepartments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDepartmentModel.Process_GetAllGLDepartments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLDepartment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLDepartmentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLDepartmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLDepartmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLDepartmentModel = new ERPGLDepartmentModel())
		{
			return await RunApiMethod(base.Request, erpGLDepartmentModel, () => erpGLDepartmentModel.ValidateRequest_GetGLDepartment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDepartmentModel.Process_GetGLDepartment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLDepartment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLDepartmentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLDepartmentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLDepartmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLDepartmentAsync([FromBody] ERPGLDepartmentDto gLDepartment)
	{
		using (erpGLDepartmentModel = new ERPGLDepartmentModel())
		{
			return await RunApiMethod(base.Request, erpGLDepartmentModel, () => erpGLDepartmentModel.ValidateRequest_PutGLDepartment(gLDepartment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDepartmentModel.Process_PutGLDepartment(gLDepartment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLDepartmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLDepartmentModel = new ERPGLDepartmentModel())
		{
			return await RunApiMethod(base.Request, erpGLDepartmentModel, () => erpGLDepartmentModel.ValidateRequest_DeleteGLDepartment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDepartmentModel.Process_DeleteGLDepartment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
