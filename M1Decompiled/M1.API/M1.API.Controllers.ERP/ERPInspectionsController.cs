...
[RoutePrefix("api/ERP/Inspections")]
public class ERPInspectionsController : ERPBaseController
{
	public IERPInspectionModel erpInspectionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPInspectionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPInspectionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllInspectionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpInspectionModel = new ERPInspectionModel())
		{
			return await RunApiMethod(base.Request, erpInspectionModel, () => erpInspectionModel.ValidateRequest_GetAllInspections(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionModel.Process_GetAllInspections(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Inspection based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPInspectionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInspectionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetInspectionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInspectionModel = new ERPInspectionModel())
		{
			return await RunApiMethod(base.Request, erpInspectionModel, () => erpInspectionModel.ValidateRequest_GetInspection(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionModel.Process_GetInspection(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="inspection">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPInspectionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPInspectionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInspectionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutInspectionAsync([FromBody] ERPInspectionDto inspection)
	{
		using (erpInspectionModel = new ERPInspectionModel())
		{
			return await RunApiMethod(base.Request, erpInspectionModel, () => erpInspectionModel.ValidateRequest_PutInspection(inspection).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionModel.Process_PutInspection(inspection), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteInspectionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInspectionModel = new ERPInspectionModel())
		{
			return await RunApiMethod(base.Request, erpInspectionModel, () => erpInspectionModel.ValidateRequest_DeleteInspection(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionModel.Process_DeleteInspection(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
