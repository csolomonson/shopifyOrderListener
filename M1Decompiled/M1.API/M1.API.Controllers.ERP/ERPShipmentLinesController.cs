...
[RoutePrefix("api/ERP/ShipmentLines")]
public class ERPShipmentLinesController : ERPBaseController
{
	public IERPShipmentLineModel erpShipmentLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPShipmentLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPShipmentLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllShipmentLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpShipmentLineModel = new ERPShipmentLineModel())
		{
			return await RunApiMethod(base.Request, erpShipmentLineModel, () => erpShipmentLineModel.ValidateRequest_GetAllShipmentLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentLineModel.Process_GetAllShipmentLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ShipmentLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPShipmentLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShipmentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SHIPPING" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetShipmentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShipmentLineModel = new ERPShipmentLineModel())
		{
			return await RunApiMethod(base.Request, erpShipmentLineModel, () => erpShipmentLineModel.ValidateRequest_GetShipmentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentLineModel.Process_GetShipmentLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="shipmentLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPShipmentLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPShipmentLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShipmentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutShipmentLineAsync([FromBody] ERPShipmentLineDto shipmentLine)
	{
		using (erpShipmentLineModel = new ERPShipmentLineModel())
		{
			return await RunApiMethod(base.Request, erpShipmentLineModel, () => erpShipmentLineModel.ValidateRequest_PutShipmentLine(shipmentLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentLineModel.Process_PutShipmentLine(shipmentLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteShipmentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShipmentLineModel = new ERPShipmentLineModel())
		{
			return await RunApiMethod(base.Request, erpShipmentLineModel, () => erpShipmentLineModel.ValidateRequest_DeleteShipmentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentLineModel.Process_DeleteShipmentLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
