...
[RoutePrefix("api/ERP/PartRules")]
public class ERPPartRulesController : ERPBaseController
{
	public IERPPartRuleModel erpPartRuleModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartRuleDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartRuleDto>>))]
	...
	[SwaggerOperation(null, Tags = new string[] { "ERP/CONFIGURATOR" })]
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartRuleAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartRuleModel = new ERPPartRuleModel())
		{
			return await RunApiMethod(base.Request, erpPartRuleModel, () => erpPartRuleModel.ValidateRequest_GetAllPartRules(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRuleModel.Process_GetAllPartRules(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartRule based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartRuleDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartRuleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CONFIGURATOR" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartRuleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartRuleModel = new ERPPartRuleModel())
		{
			return await RunApiMethod(base.Request, erpPartRuleModel, () => erpPartRuleModel.ValidateRequest_GetPartRule(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRuleModel.Process_GetPartRule(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partRule">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartRuleDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartRuleDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartRuleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartRuleAsync([FromBody] ERPPartRuleDto partRule)
	{
		using (erpPartRuleModel = new ERPPartRuleModel())
		{
			return await RunApiMethod(base.Request, erpPartRuleModel, () => erpPartRuleModel.ValidateRequest_PutPartRule(partRule).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRuleModel.Process_PutPartRule(partRule), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartRuleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartRuleModel = new ERPPartRuleModel())
		{
			return await RunApiMethod(base.Request, erpPartRuleModel, () => erpPartRuleModel.ValidateRequest_DeletePartRule(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRuleModel.Process_DeletePartRule(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
