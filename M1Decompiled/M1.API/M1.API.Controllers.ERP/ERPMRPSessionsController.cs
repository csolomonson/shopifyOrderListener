...
[RoutePrefix("api/ERP/MRPSessions")]
public class ERPMRPSessionsController : ERPBaseController
{
	public IERPMRPSessionModel erpMRPSessionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMRPSessionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMRPSessionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMRPSessionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMRPSessionModel = new ERPMRPSessionModel())
		{
			return await RunApiMethod(base.Request, erpMRPSessionModel, () => erpMRPSessionModel.ValidateRequest_GetAllMRPSessions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSessionModel.Process_GetAllMRPSessions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MRPSession based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMRPSessionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMRPSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPSessionModel = new ERPMRPSessionModel())
		{
			return await RunApiMethod(base.Request, erpMRPSessionModel, () => erpMRPSessionModel.ValidateRequest_GetMRPSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSessionModel.Process_GetMRPSession(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="mRPSession">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMRPSessionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMRPSessionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPSessionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMRPSessionAsync([FromBody] ERPMRPSessionDto mRPSession)
	{
		using (erpMRPSessionModel = new ERPMRPSessionModel())
		{
			return await RunApiMethod(base.Request, erpMRPSessionModel, () => erpMRPSessionModel.ValidateRequest_PutMRPSession(mRPSession).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSessionModel.Process_PutMRPSession(mRPSession), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMRPSessionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPSessionModel = new ERPMRPSessionModel())
		{
			return await RunApiMethod(base.Request, erpMRPSessionModel, () => erpMRPSessionModel.ValidateRequest_DeleteMRPSession(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSessionModel.Process_DeleteMRPSession(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
