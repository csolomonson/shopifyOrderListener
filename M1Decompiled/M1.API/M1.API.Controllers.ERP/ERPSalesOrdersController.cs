...
[RoutePrefix("api/ERP/SalesOrders")]
public class ERPSalesOrdersController : ERPBaseController
{
	public IERPSalesOrderModel erpSalesOrderModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPSalesOrderDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllSalesOrderAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpSalesOrderModel = new ERPSalesOrderModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderModel, () => erpSalesOrderModel.ValidateRequest_GetAllSalesOrders(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderModel.Process_GetAllSalesOrders(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a SalesOrder based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SALESORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetSalesOrderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderModel = new ERPSalesOrderModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderModel, () => erpSalesOrderModel.ValidateRequest_GetSalesOrder(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderModel.Process_GetSalesOrder(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="salesOrder">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPSalesOrderDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutSalesOrderAsync([FromBody] ERPSalesOrderDto salesOrder)
	{
		using (erpSalesOrderModel = new ERPSalesOrderModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderModel, () => erpSalesOrderModel.ValidateRequest_PutSalesOrder(salesOrder).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderModel.Process_PutSalesOrder(salesOrder), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteSalesOrderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderModel = new ERPSalesOrderModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderModel, () => erpSalesOrderModel.ValidateRequest_DeleteSalesOrder(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderModel.Process_DeleteSalesOrder(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
