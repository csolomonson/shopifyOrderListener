...
[RoutePrefix("api/ERP/PartForecastLines")]
public class ERPPartForecastLinesController : ERPBaseController
{
	public IERPPartForecastLineModel erpPartForecastLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartForecastLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartForecastLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartForecastLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartForecastLineModel = new ERPPartForecastLineModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastLineModel, () => erpPartForecastLineModel.ValidateRequest_GetAllPartForecastLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastLineModel.Process_GetAllPartForecastLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartForecastLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartForecastLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartForecastLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartForecastLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartForecastLineModel = new ERPPartForecastLineModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastLineModel, () => erpPartForecastLineModel.ValidateRequest_GetPartForecastLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastLineModel.Process_GetPartForecastLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partForecastLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartForecastLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartForecastLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartForecastLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartForecastLineAsync([FromBody] ERPPartForecastLineDto partForecastLine)
	{
		using (erpPartForecastLineModel = new ERPPartForecastLineModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastLineModel, () => erpPartForecastLineModel.ValidateRequest_PutPartForecastLine(partForecastLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastLineModel.Process_PutPartForecastLine(partForecastLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartForecastLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartForecastLineModel = new ERPPartForecastLineModel())
		{
			return await RunApiMethod(base.Request, erpPartForecastLineModel, () => erpPartForecastLineModel.ValidateRequest_DeletePartForecastLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartForecastLineModel.Process_DeletePartForecastLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
