...
[RoutePrefix("api/ERP/Quotes")]
public class ERPQuotesController : ERPBaseController
{
	public IERPQuoteModel erpQuoteModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPQuoteDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPQuoteDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllQuoteAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpQuoteModel = new ERPQuoteModel())
		{
			return await RunApiMethod(base.Request, erpQuoteModel, () => erpQuoteModel.ValidateRequest_GetAllQuotes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteModel.Process_GetAllQuotes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Quote based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPQuoteDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUOTATIONS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetQuoteAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteModel = new ERPQuoteModel())
		{
			return await RunApiMethod(base.Request, erpQuoteModel, () => erpQuoteModel.ValidateRequest_GetQuote(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteModel.Process_GetQuote(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="quote">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPQuoteDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPQuoteDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutQuoteAsync([FromBody] ERPQuoteDto quote)
	{
		using (erpQuoteModel = new ERPQuoteModel())
		{
			return await RunApiMethod(base.Request, erpQuoteModel, () => erpQuoteModel.ValidateRequest_PutQuote(quote).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteModel.Process_PutQuote(quote), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteQuoteAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteModel = new ERPQuoteModel())
		{
			return await RunApiMethod(base.Request, erpQuoteModel, () => erpQuoteModel.ValidateRequest_DeleteQuote(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteModel.Process_DeleteQuote(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
