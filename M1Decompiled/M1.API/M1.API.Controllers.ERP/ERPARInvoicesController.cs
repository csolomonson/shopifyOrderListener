...
[RoutePrefix("api/ERP/ARInvoices")]
public class ERPARInvoicesController : ERPBaseController
{
	public IERPARInvoiceModel erpARInvoiceModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARInvoiceDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARInvoiceAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARInvoiceModel = new ERPARInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceModel, () => erpARInvoiceModel.ValidateRequest_GetAllARInvoices(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceModel.Process_GetAllARInvoices(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARInvoice based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARInvoiceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceModel = new ERPARInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceModel, () => erpARInvoiceModel.ValidateRequest_GetARInvoice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceModel.Process_GetARInvoice(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRInvoice">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARInvoiceAsync([FromBody] ERPARInvoiceDto aRInvoice)
	{
		using (erpARInvoiceModel = new ERPARInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceModel, () => erpARInvoiceModel.ValidateRequest_PutARInvoice(aRInvoice).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceModel.Process_PutARInvoice(aRInvoice), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARInvoiceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceModel = new ERPARInvoiceModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceModel, () => erpARInvoiceModel.ValidateRequest_DeleteARInvoice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceModel.Process_DeleteARInvoice(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
