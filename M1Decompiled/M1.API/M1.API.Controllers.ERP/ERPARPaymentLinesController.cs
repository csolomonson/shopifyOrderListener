...
[RoutePrefix("api/ERP/ARPaymentLines")]
public class ERPARPaymentLinesController : ERPBaseController
{
	public IERPARPaymentLineModel erpARPaymentLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARPaymentLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARPaymentLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARPaymentLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARPaymentLineModel = new ERPARPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentLineModel, () => erpARPaymentLineModel.ValidateRequest_GetAllARPaymentLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentLineModel.Process_GetAllARPaymentLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARPaymentLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARPaymentLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARPaymentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentLineModel = new ERPARPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentLineModel, () => erpARPaymentLineModel.ValidateRequest_GetARPaymentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentLineModel.Process_GetARPaymentLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRPaymentLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARPaymentLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARPaymentLineAsync([FromBody] ERPARPaymentLineDto aRPaymentLine)
	{
		using (erpARPaymentLineModel = new ERPARPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentLineModel, () => erpARPaymentLineModel.ValidateRequest_PutARPaymentLine(aRPaymentLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentLineModel.Process_PutARPaymentLine(aRPaymentLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARPaymentLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentLineModel = new ERPARPaymentLineModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentLineModel, () => erpARPaymentLineModel.ValidateRequest_DeleteARPaymentLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentLineModel.Process_DeleteARPaymentLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
