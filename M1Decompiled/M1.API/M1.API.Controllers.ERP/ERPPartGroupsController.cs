...
[RoutePrefix("api/ERP/PartGroups")]
public class ERPPartGroupsController : ERPBaseController
{
	public IERPPartGroupModel erpPartGroupModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartGroupDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartGroupDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartGroupAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartGroupModel = new ERPPartGroupModel())
		{
			return await RunApiMethod(base.Request, erpPartGroupModel, () => erpPartGroupModel.ValidateRequest_GetAllPartGroups(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartGroupModel.Process_GetAllPartGroups(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartGroup based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartGroupDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartGroupModel = new ERPPartGroupModel())
		{
			return await RunApiMethod(base.Request, erpPartGroupModel, () => erpPartGroupModel.ValidateRequest_GetPartGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartGroupModel.Process_GetPartGroup(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partGroup">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartGroupDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartGroupDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartGroupAsync([FromBody] ERPPartGroupDto partGroup)
	{
		using (erpPartGroupModel = new ERPPartGroupModel())
		{
			return await RunApiMethod(base.Request, erpPartGroupModel, () => erpPartGroupModel.ValidateRequest_PutPartGroup(partGroup).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartGroupModel.Process_PutPartGroup(partGroup), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartGroupModel = new ERPPartGroupModel())
		{
			return await RunApiMethod(base.Request, erpPartGroupModel, () => erpPartGroupModel.ValidateRequest_DeletePartGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartGroupModel.Process_DeletePartGroup(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
