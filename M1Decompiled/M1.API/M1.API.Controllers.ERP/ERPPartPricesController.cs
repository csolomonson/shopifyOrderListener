...
[RoutePrefix("api/ERP/PartPrices")]
public class ERPPartPricesController : ERPBaseController
{
	public IERPPartPriceModel erpPartPriceModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartPriceDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartPriceDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartPriceAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartPriceModel = new ERPPartPriceModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceModel, () => erpPartPriceModel.ValidateRequest_GetAllPartPrices(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceModel.Process_GetAllPartPrices(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartPrice based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartPriceDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartPriceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartPriceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartPriceModel = new ERPPartPriceModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceModel, () => erpPartPriceModel.ValidateRequest_GetPartPrice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceModel.Process_GetPartPrice(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partPrice">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartPriceDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartPriceDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartPriceDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartPriceAsync([FromBody] ERPPartPriceDto partPrice)
	{
		using (erpPartPriceModel = new ERPPartPriceModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceModel, () => erpPartPriceModel.ValidateRequest_PutPartPrice(partPrice).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceModel.Process_PutPartPrice(partPrice), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartPriceAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartPriceModel = new ERPPartPriceModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceModel, () => erpPartPriceModel.ValidateRequest_DeletePartPrice(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceModel.Process_DeletePartPrice(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
