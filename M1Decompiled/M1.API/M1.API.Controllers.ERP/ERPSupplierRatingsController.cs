...
[RoutePrefix("api/ERP/SupplierRatings")]
public class ERPSupplierRatingsController : ERPBaseController
{
	public IERPSupplierRatingModel erpSupplierRatingModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPSupplierRatingDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPSupplierRatingDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllSupplierRatingAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpSupplierRatingModel = new ERPSupplierRatingModel())
		{
			return await RunApiMethod(base.Request, erpSupplierRatingModel, () => erpSupplierRatingModel.ValidateRequest_GetAllSupplierRatings(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSupplierRatingModel.Process_GetAllSupplierRatings(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a SupplierRating based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPSupplierRatingDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSupplierRatingDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetSupplierRatingAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSupplierRatingModel = new ERPSupplierRatingModel())
		{
			return await RunApiMethod(base.Request, erpSupplierRatingModel, () => erpSupplierRatingModel.ValidateRequest_GetSupplierRating(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSupplierRatingModel.Process_GetSupplierRating(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="supplierRating">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPSupplierRatingDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPSupplierRatingDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSupplierRatingDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutSupplierRatingAsync([FromBody] ERPSupplierRatingDto supplierRating)
	{
		using (erpSupplierRatingModel = new ERPSupplierRatingModel())
		{
			return await RunApiMethod(base.Request, erpSupplierRatingModel, () => erpSupplierRatingModel.ValidateRequest_PutSupplierRating(supplierRating).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSupplierRatingModel.Process_PutSupplierRating(supplierRating), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteSupplierRatingAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSupplierRatingModel = new ERPSupplierRatingModel())
		{
			return await RunApiMethod(base.Request, erpSupplierRatingModel, () => erpSupplierRatingModel.ValidateRequest_DeleteSupplierRating(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSupplierRatingModel.Process_DeleteSupplierRating(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
