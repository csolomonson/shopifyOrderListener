...
[RoutePrefix("api/ERP/GLJournalLines")]
public class ERPGLJournalLinesController : ERPBaseController
{
	public IERPGLJournalLineModel erpGLJournalLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLJournalLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLJournalLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLJournalLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLJournalLineModel = new ERPGLJournalLineModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalLineModel, () => erpGLJournalLineModel.ValidateRequest_GetAllGLJournalLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalLineModel.Process_GetAllGLJournalLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLJournalLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLJournalLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLJournalLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLJournalLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLJournalLineModel = new ERPGLJournalLineModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalLineModel, () => erpGLJournalLineModel.ValidateRequest_GetGLJournalLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalLineModel.Process_GetGLJournalLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLJournalLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLJournalLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLJournalLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLJournalLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLJournalLineAsync([FromBody] ERPGLJournalLineDto gLJournalLine)
	{
		using (erpGLJournalLineModel = new ERPGLJournalLineModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalLineModel, () => erpGLJournalLineModel.ValidateRequest_PutGLJournalLine(gLJournalLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalLineModel.Process_PutGLJournalLine(gLJournalLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLJournalLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLJournalLineModel = new ERPGLJournalLineModel())
		{
			return await RunApiMethod(base.Request, erpGLJournalLineModel, () => erpGLJournalLineModel.ValidateRequest_DeleteGLJournalLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLJournalLineModel.Process_DeleteGLJournalLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
