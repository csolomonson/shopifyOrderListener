...
[RoutePrefix("api/ERP/ProjectedPayments")]
public class ERPProjectedPaymentsController : ERPBaseController
{
	public IERPProjectedPaymentModel erpProjectedPaymentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPProjectedPaymentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPProjectedPaymentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllProjectedPaymentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpProjectedPaymentModel = new ERPProjectedPaymentModel())
		{
			return await RunApiMethod(base.Request, erpProjectedPaymentModel, () => erpProjectedPaymentModel.ValidateRequest_GetAllProjectedPayments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectedPaymentModel.Process_GetAllProjectedPayments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ProjectedPayment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPProjectedPaymentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectedPaymentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetProjectedPaymentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectedPaymentModel = new ERPProjectedPaymentModel())
		{
			return await RunApiMethod(base.Request, erpProjectedPaymentModel, () => erpProjectedPaymentModel.ValidateRequest_GetProjectedPayment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectedPaymentModel.Process_GetProjectedPayment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="projectedPayment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPProjectedPaymentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPProjectedPaymentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectedPaymentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutProjectedPaymentAsync([FromBody] ERPProjectedPaymentDto projectedPayment)
	{
		using (erpProjectedPaymentModel = new ERPProjectedPaymentModel())
		{
			return await RunApiMethod(base.Request, erpProjectedPaymentModel, () => erpProjectedPaymentModel.ValidateRequest_PutProjectedPayment(projectedPayment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectedPaymentModel.Process_PutProjectedPayment(projectedPayment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteProjectedPaymentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectedPaymentModel = new ERPProjectedPaymentModel())
		{
			return await RunApiMethod(base.Request, erpProjectedPaymentModel, () => erpProjectedPaymentModel.ValidateRequest_DeleteProjectedPayment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectedPaymentModel.Process_DeleteProjectedPayment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
