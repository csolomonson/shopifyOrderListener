...
[RoutePrefix("api/ERP/AssetAdjustments")]
public class ERPAssetAdjustmentsController : ERPBaseController
{
	public IERPAssetAdjustmentModel erpAssetAdjustmentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAssetAdjustmentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAssetAdjustmentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAssetAdjustmentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAssetAdjustmentModel = new ERPAssetAdjustmentModel())
		{
			return await RunApiMethod(base.Request, erpAssetAdjustmentModel, () => erpAssetAdjustmentModel.ValidateRequest_GetAllAssetAdjustments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetAdjustmentModel.Process_GetAllAssetAdjustments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AssetAdjustment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAssetAdjustmentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetAdjustmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAssetAdjustmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetAdjustmentModel = new ERPAssetAdjustmentModel())
		{
			return await RunApiMethod(base.Request, erpAssetAdjustmentModel, () => erpAssetAdjustmentModel.ValidateRequest_GetAssetAdjustment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetAdjustmentModel.Process_GetAssetAdjustment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="assetAdjustment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAssetAdjustmentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAssetAdjustmentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetAdjustmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAssetAdjustmentAsync([FromBody] ERPAssetAdjustmentDto assetAdjustment)
	{
		using (erpAssetAdjustmentModel = new ERPAssetAdjustmentModel())
		{
			return await RunApiMethod(base.Request, erpAssetAdjustmentModel, () => erpAssetAdjustmentModel.ValidateRequest_PutAssetAdjustment(assetAdjustment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetAdjustmentModel.Process_PutAssetAdjustment(assetAdjustment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAssetAdjustmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetAdjustmentModel = new ERPAssetAdjustmentModel())
		{
			return await RunApiMethod(base.Request, erpAssetAdjustmentModel, () => erpAssetAdjustmentModel.ValidateRequest_DeleteAssetAdjustment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetAdjustmentModel.Process_DeleteAssetAdjustment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
