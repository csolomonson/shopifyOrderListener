...
[RoutePrefix("api/ERP/DMRShipments")]
public class ERPDMRShipmentsController : ERPBaseController
{
	public IERPDMRShipmentModel erpDMRShipmentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPDMRShipmentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPDMRShipmentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllDMRShipmentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpDMRShipmentModel = new ERPDMRShipmentModel())
		{
			return await RunApiMethod(base.Request, erpDMRShipmentModel, () => erpDMRShipmentModel.ValidateRequest_GetAllDMRShipments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRShipmentModel.Process_GetAllDMRShipments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a DMRShipment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPDMRShipmentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetDMRShipmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRShipmentModel = new ERPDMRShipmentModel())
		{
			return await RunApiMethod(base.Request, erpDMRShipmentModel, () => erpDMRShipmentModel.ValidateRequest_GetDMRShipment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRShipmentModel.Process_GetDMRShipment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="dMRShipment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPDMRShipmentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPDMRShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutDMRShipmentAsync([FromBody] ERPDMRShipmentDto dMRShipment)
	{
		using (erpDMRShipmentModel = new ERPDMRShipmentModel())
		{
			return await RunApiMethod(base.Request, erpDMRShipmentModel, () => erpDMRShipmentModel.ValidateRequest_PutDMRShipment(dMRShipment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRShipmentModel.Process_PutDMRShipment(dMRShipment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteDMRShipmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRShipmentModel = new ERPDMRShipmentModel())
		{
			return await RunApiMethod(base.Request, erpDMRShipmentModel, () => erpDMRShipmentModel.ValidateRequest_DeleteDMRShipment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRShipmentModel.Process_DeleteDMRShipment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
