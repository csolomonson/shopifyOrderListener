...
[RoutePrefix("api/ERP/QuoteQuantities")]
public class ERPQuoteQuantitiesController : ERPBaseController
{
	public IERPQuoteQuantityModel erpQuoteQuantityModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPQuoteQuantityDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPQuoteQuantityDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllQuoteQuantityAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpQuoteQuantityModel = new ERPQuoteQuantityModel())
		{
			return await RunApiMethod(base.Request, erpQuoteQuantityModel, () => erpQuoteQuantityModel.ValidateRequest_GetAllQuoteQuantities(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteQuantityModel.Process_GetAllQuoteQuantities(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a QuoteQuantity based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPQuoteQuantityDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUOTATIONS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetQuoteQuantityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteQuantityModel = new ERPQuoteQuantityModel())
		{
			return await RunApiMethod(base.Request, erpQuoteQuantityModel, () => erpQuoteQuantityModel.ValidateRequest_GetQuoteQuantity(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteQuantityModel.Process_GetQuoteQuantity(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="quoteQuantity">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPQuoteQuantityDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPQuoteQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutQuoteQuantityAsync([FromBody] ERPQuoteQuantityDto quoteQuantity)
	{
		using (erpQuoteQuantityModel = new ERPQuoteQuantityModel())
		{
			return await RunApiMethod(base.Request, erpQuoteQuantityModel, () => erpQuoteQuantityModel.ValidateRequest_PutQuoteQuantity(quoteQuantity).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteQuantityModel.Process_PutQuoteQuantity(quoteQuantity), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteQuoteQuantityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteQuantityModel = new ERPQuoteQuantityModel())
		{
			return await RunApiMethod(base.Request, erpQuoteQuantityModel, () => erpQuoteQuantityModel.ValidateRequest_DeleteQuoteQuantity(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteQuantityModel.Process_DeleteQuoteQuantity(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
