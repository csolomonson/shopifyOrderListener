...
[RoutePrefix("api/ERP/JobCosts")]
public class ERPJobCostsController : ERPBaseController
{
	public IERPJobCostModel erpJobCostModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobCostDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobCostDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobCostAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobCostModel = new ERPJobCostModel())
		{
			return await RunApiMethod(base.Request, erpJobCostModel, () => erpJobCostModel.ValidateRequest_GetAllJobCosts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobCostModel.Process_GetAllJobCosts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobCost based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobCostDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobCostDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobCostAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobCostModel = new ERPJobCostModel())
		{
			return await RunApiMethod(base.Request, erpJobCostModel, () => erpJobCostModel.ValidateRequest_GetJobCost(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobCostModel.Process_GetJobCost(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobCost">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobCostDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobCostDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobCostDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobCostAsync([FromBody] ERPJobCostDto jobCost)
	{
		using (erpJobCostModel = new ERPJobCostModel())
		{
			return await RunApiMethod(base.Request, erpJobCostModel, () => erpJobCostModel.ValidateRequest_PutJobCost(jobCost).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobCostModel.Process_PutJobCost(jobCost), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobCostAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobCostModel = new ERPJobCostModel())
		{
			return await RunApiMethod(base.Request, erpJobCostModel, () => erpJobCostModel.ValidateRequest_DeleteJobCost(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobCostModel.Process_DeleteJobCost(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
