...
[RoutePrefix("api/ERP/ARPaymentHeaders")]
public class ERPARPaymentHeadersController : ERPBaseController
{
	public IERPARPaymentHeaderModel erpARPaymentHeaderModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARPaymentHeaderDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARPaymentHeaderDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARPaymentHeaderAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARPaymentHeaderModel = new ERPARPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentHeaderModel, () => erpARPaymentHeaderModel.ValidateRequest_GetAllARPaymentHeaders(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentHeaderModel.Process_GetAllARPaymentHeaders(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARPaymentHeader based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARPaymentHeaderDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARPaymentHeaderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentHeaderModel = new ERPARPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentHeaderModel, () => erpARPaymentHeaderModel.ValidateRequest_GetARPaymentHeader(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentHeaderModel.Process_GetARPaymentHeader(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRPaymentHeader">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARPaymentHeaderDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARPaymentHeaderAsync([FromBody] ERPARPaymentHeaderDto aRPaymentHeader)
	{
		using (erpARPaymentHeaderModel = new ERPARPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentHeaderModel, () => erpARPaymentHeaderModel.ValidateRequest_PutARPaymentHeader(aRPaymentHeader).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentHeaderModel.Process_PutARPaymentHeader(aRPaymentHeader), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARPaymentHeaderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARPaymentHeaderModel = new ERPARPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpARPaymentHeaderModel, () => erpARPaymentHeaderModel.ValidateRequest_DeleteARPaymentHeader(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARPaymentHeaderModel.Process_DeleteARPaymentHeader(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
