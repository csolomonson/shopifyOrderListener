...
[RoutePrefix("api/ERP/LeadSalesPeople")]
public class ERPLeadSalesPeopleController : ERPBaseController
{
	public IERPLeadSalesPersonModel erpLeadSalesPersonModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLeadSalesPersonDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLeadSalesPersonDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLeadSalesPersonAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLeadSalesPersonModel = new ERPLeadSalesPersonModel())
		{
			return await RunApiMethod(base.Request, erpLeadSalesPersonModel, () => erpLeadSalesPersonModel.ValidateRequest_GetAllLeadSalesPeople(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadSalesPersonModel.Process_GetAllLeadSalesPeople(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LeadSalesPerson based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLeadSalesPersonDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadSalesPersonDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLeadSalesPersonAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadSalesPersonModel = new ERPLeadSalesPersonModel())
		{
			return await RunApiMethod(base.Request, erpLeadSalesPersonModel, () => erpLeadSalesPersonModel.ValidateRequest_GetLeadSalesPerson(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadSalesPersonModel.Process_GetLeadSalesPerson(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="leadSalesPerson">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLeadSalesPersonDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLeadSalesPersonDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadSalesPersonDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLeadSalesPersonAsync([FromBody] ERPLeadSalesPersonDto leadSalesPerson)
	{
		using (erpLeadSalesPersonModel = new ERPLeadSalesPersonModel())
		{
			return await RunApiMethod(base.Request, erpLeadSalesPersonModel, () => erpLeadSalesPersonModel.ValidateRequest_PutLeadSalesPerson(leadSalesPerson).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadSalesPersonModel.Process_PutLeadSalesPerson(leadSalesPerson), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLeadSalesPersonAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadSalesPersonModel = new ERPLeadSalesPersonModel())
		{
			return await RunApiMethod(base.Request, erpLeadSalesPersonModel, () => erpLeadSalesPersonModel.ValidateRequest_DeleteLeadSalesPerson(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadSalesPersonModel.Process_DeleteLeadSalesPerson(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
