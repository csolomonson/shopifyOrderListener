...
[RoutePrefix("api/ERP/KnowledgeBasePages")]
public class ERPKnowledgeBasePagesController : ERPBaseController
{
	public IERPKnowledgeBasePageModel erpKnowledgeBasePageModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPKnowledgeBasePageDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPKnowledgeBasePageDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllKnowledgeBasePageAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpKnowledgeBasePageModel = new ERPKnowledgeBasePageModel())
		{
			return await RunApiMethod(base.Request, erpKnowledgeBasePageModel, () => erpKnowledgeBasePageModel.ValidateRequest_GetAllKnowledgeBasePages(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpKnowledgeBasePageModel.Process_GetAllKnowledgeBasePages(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a KnowledgeBasePage based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPKnowledgeBasePageDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPKnowledgeBasePageDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetKnowledgeBasePageAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpKnowledgeBasePageModel = new ERPKnowledgeBasePageModel())
		{
			return await RunApiMethod(base.Request, erpKnowledgeBasePageModel, () => erpKnowledgeBasePageModel.ValidateRequest_GetKnowledgeBasePage(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpKnowledgeBasePageModel.Process_GetKnowledgeBasePage(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="knowledgeBasePage">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPKnowledgeBasePageDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPKnowledgeBasePageDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPKnowledgeBasePageDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutKnowledgeBasePageAsync([FromBody] ERPKnowledgeBasePageDto knowledgeBasePage)
	{
		using (erpKnowledgeBasePageModel = new ERPKnowledgeBasePageModel())
		{
			return await RunApiMethod(base.Request, erpKnowledgeBasePageModel, () => erpKnowledgeBasePageModel.ValidateRequest_PutKnowledgeBasePage(knowledgeBasePage).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpKnowledgeBasePageModel.Process_PutKnowledgeBasePage(knowledgeBasePage), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteKnowledgeBasePageAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpKnowledgeBasePageModel = new ERPKnowledgeBasePageModel())
		{
			return await RunApiMethod(base.Request, erpKnowledgeBasePageModel, () => erpKnowledgeBasePageModel.ValidateRequest_DeleteKnowledgeBasePage(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpKnowledgeBasePageModel.Process_DeleteKnowledgeBasePage(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
