...
[RoutePrefix("api/ERP/CustomerGroups")]
public class ERPCustomerGroupsController : ERPBaseController
{
	public IERPCustomerGroupModel erpCustomerGroupModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPCustomerGroupDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPCustomerGroupDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllCustomerGroupAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpCustomerGroupModel = new ERPCustomerGroupModel())
		{
			return await RunApiMethod(base.Request, erpCustomerGroupModel, () => erpCustomerGroupModel.ValidateRequest_GetAllCustomerGroups(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCustomerGroupModel.Process_GetAllCustomerGroups(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a CustomerGroup based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPCustomerGroupDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCustomerGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetCustomerGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCustomerGroupModel = new ERPCustomerGroupModel())
		{
			return await RunApiMethod(base.Request, erpCustomerGroupModel, () => erpCustomerGroupModel.ValidateRequest_GetCustomerGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCustomerGroupModel.Process_GetCustomerGroup(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="customerGroup">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPCustomerGroupDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPCustomerGroupDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCustomerGroupDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutCustomerGroupAsync([FromBody] ERPCustomerGroupDto customerGroup)
	{
		using (erpCustomerGroupModel = new ERPCustomerGroupModel())
		{
			return await RunApiMethod(base.Request, erpCustomerGroupModel, () => erpCustomerGroupModel.ValidateRequest_PutCustomerGroup(customerGroup).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCustomerGroupModel.Process_PutCustomerGroup(customerGroup), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteCustomerGroupAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCustomerGroupModel = new ERPCustomerGroupModel())
		{
			return await RunApiMethod(base.Request, erpCustomerGroupModel, () => erpCustomerGroupModel.ValidateRequest_DeleteCustomerGroup(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCustomerGroupModel.Process_DeleteCustomerGroup(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
