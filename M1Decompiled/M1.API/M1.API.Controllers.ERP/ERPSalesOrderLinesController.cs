...
[RoutePrefix("api/ERP/SalesOrderLines")]
public class ERPSalesOrderLinesController : ERPBaseController
{
	public IERPSalesOrderLineModel erpSalesOrderLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPSalesOrderLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllSalesOrderLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpSalesOrderLineModel = new ERPSalesOrderLineModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderLineModel, () => erpSalesOrderLineModel.ValidateRequest_GetAllSalesOrderLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderLineModel.Process_GetAllSalesOrderLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a SalesOrderLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SALESORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetSalesOrderLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderLineModel = new ERPSalesOrderLineModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderLineModel, () => erpSalesOrderLineModel.ValidateRequest_GetSalesOrderLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderLineModel.Process_GetSalesOrderLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="salesOrderLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPSalesOrderLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPSalesOrderLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSalesOrderLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutSalesOrderLineAsync([FromBody] ERPSalesOrderLineDto salesOrderLine)
	{
		using (erpSalesOrderLineModel = new ERPSalesOrderLineModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderLineModel, () => erpSalesOrderLineModel.ValidateRequest_PutSalesOrderLine(salesOrderLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderLineModel.Process_PutSalesOrderLine(salesOrderLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteSalesOrderLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSalesOrderLineModel = new ERPSalesOrderLineModel())
		{
			return await RunApiMethod(base.Request, erpSalesOrderLineModel, () => erpSalesOrderLineModel.ValidateRequest_DeleteSalesOrderLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSalesOrderLineModel.Process_DeleteSalesOrderLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
