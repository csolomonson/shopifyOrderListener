...
[RoutePrefix("api/ERP/PartPriceBreaks")]
public class ERPPartPriceBreaksController : ERPBaseController
{
	public IERPPartPriceBreakModel erpPartPriceBreakModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartPriceBreakDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartPriceBreakDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartPriceBreakAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartPriceBreakModel = new ERPPartPriceBreakModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceBreakModel, () => erpPartPriceBreakModel.ValidateRequest_GetAllPartPriceBreaks(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceBreakModel.Process_GetAllPartPriceBreaks(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartPriceBreak based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartPriceBreakDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartPriceBreakDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartPriceBreakAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartPriceBreakModel = new ERPPartPriceBreakModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceBreakModel, () => erpPartPriceBreakModel.ValidateRequest_GetPartPriceBreak(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceBreakModel.Process_GetPartPriceBreak(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partPriceBreak">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartPriceBreakDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartPriceBreakDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartPriceBreakDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartPriceBreakAsync([FromBody] ERPPartPriceBreakDto partPriceBreak)
	{
		using (erpPartPriceBreakModel = new ERPPartPriceBreakModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceBreakModel, () => erpPartPriceBreakModel.ValidateRequest_PutPartPriceBreak(partPriceBreak).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceBreakModel.Process_PutPartPriceBreak(partPriceBreak), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartPriceBreakAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartPriceBreakModel = new ERPPartPriceBreakModel())
		{
			return await RunApiMethod(base.Request, erpPartPriceBreakModel, () => erpPartPriceBreakModel.ValidateRequest_DeletePartPriceBreak(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartPriceBreakModel.Process_DeletePartPriceBreak(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
