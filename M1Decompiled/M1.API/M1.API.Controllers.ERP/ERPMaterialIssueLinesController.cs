...
[RoutePrefix("api/ERP/MaterialIssueLines")]
public class ERPMaterialIssueLinesController : ERPBaseController
{
	public IERPMaterialIssueLineModel erpMaterialIssueLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMaterialIssueLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMaterialIssueLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMaterialIssueLineModel = new ERPMaterialIssueLineModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueLineModel, () => erpMaterialIssueLineModel.ValidateRequest_GetAllMaterialIssueLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueLineModel.Process_GetAllMaterialIssueLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MaterialIssueLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMaterialIssueLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMaterialIssueLineModel = new ERPMaterialIssueLineModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueLineModel, () => erpMaterialIssueLineModel.ValidateRequest_GetMaterialIssueLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueLineModel.Process_GetMaterialIssueLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="materialIssueLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMaterialIssueLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMaterialIssueLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMaterialIssueLineAsync([FromBody] ERPMaterialIssueLineDto materialIssueLine)
	{
		using (erpMaterialIssueLineModel = new ERPMaterialIssueLineModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueLineModel, () => erpMaterialIssueLineModel.ValidateRequest_PutMaterialIssueLine(materialIssueLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueLineModel.Process_PutMaterialIssueLine(materialIssueLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMaterialIssueLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMaterialIssueLineModel = new ERPMaterialIssueLineModel())
		{
			return await RunApiMethod(base.Request, erpMaterialIssueLineModel, () => erpMaterialIssueLineModel.ValidateRequest_DeleteMaterialIssueLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMaterialIssueLineModel.Process_DeleteMaterialIssueLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
