...
[RoutePrefix("api/ERP/AssetSchedules")]
public class ERPAssetSchedulesController : ERPBaseController
{
	public IERPAssetScheduleModel erpAssetScheduleModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAssetScheduleDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAssetScheduleDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAssetScheduleAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAssetScheduleModel = new ERPAssetScheduleModel())
		{
			return await RunApiMethod(base.Request, erpAssetScheduleModel, () => erpAssetScheduleModel.ValidateRequest_GetAllAssetSchedules(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetScheduleModel.Process_GetAllAssetSchedules(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AssetSchedule based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAssetScheduleDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetScheduleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAssetScheduleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetScheduleModel = new ERPAssetScheduleModel())
		{
			return await RunApiMethod(base.Request, erpAssetScheduleModel, () => erpAssetScheduleModel.ValidateRequest_GetAssetSchedule(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetScheduleModel.Process_GetAssetSchedule(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="assetSchedule">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAssetScheduleDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAssetScheduleDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetScheduleDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAssetScheduleAsync([FromBody] ERPAssetScheduleDto assetSchedule)
	{
		using (erpAssetScheduleModel = new ERPAssetScheduleModel())
		{
			return await RunApiMethod(base.Request, erpAssetScheduleModel, () => erpAssetScheduleModel.ValidateRequest_PutAssetSchedule(assetSchedule).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetScheduleModel.Process_PutAssetSchedule(assetSchedule), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAssetScheduleAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetScheduleModel = new ERPAssetScheduleModel())
		{
			return await RunApiMethod(base.Request, erpAssetScheduleModel, () => erpAssetScheduleModel.ValidateRequest_DeleteAssetSchedule(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetScheduleModel.Process_DeleteAssetSchedule(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
