...
[RoutePrefix("api/ERP/QuoteOperations")]
public class ERPQuoteOperationsController : ERPBaseController
{
	public IERPQuoteOperationModel erpQuoteOperationModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPQuoteOperationDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPQuoteOperationDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllQuoteOperationAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpQuoteOperationModel = new ERPQuoteOperationModel())
		{
			return await RunApiMethod(base.Request, erpQuoteOperationModel, () => erpQuoteOperationModel.ValidateRequest_GetAllQuoteOperations(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteOperationModel.Process_GetAllQuoteOperations(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a QuoteOperation based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPQuoteOperationDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUOTATIONS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetQuoteOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteOperationModel = new ERPQuoteOperationModel())
		{
			return await RunApiMethod(base.Request, erpQuoteOperationModel, () => erpQuoteOperationModel.ValidateRequest_GetQuoteOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteOperationModel.Process_GetQuoteOperation(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="quoteOperation">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPQuoteOperationDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPQuoteOperationDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutQuoteOperationAsync([FromBody] ERPQuoteOperationDto quoteOperation)
	{
		using (erpQuoteOperationModel = new ERPQuoteOperationModel())
		{
			return await RunApiMethod(base.Request, erpQuoteOperationModel, () => erpQuoteOperationModel.ValidateRequest_PutQuoteOperation(quoteOperation).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteOperationModel.Process_PutQuoteOperation(quoteOperation), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteQuoteOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteOperationModel = new ERPQuoteOperationModel())
		{
			return await RunApiMethod(base.Request, erpQuoteOperationModel, () => erpQuoteOperationModel.ValidateRequest_DeleteQuoteOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteOperationModel.Process_DeleteQuoteOperation(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
