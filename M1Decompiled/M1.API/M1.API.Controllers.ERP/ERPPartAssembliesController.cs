...
[RoutePrefix("api/ERP/PartAssemblies")]
public class ERPPartAssembliesController : ERPBaseController
{
	public IERPPartAssemblyModel erpPartAssemblyModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartAssemblyDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartAssemblyDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartAssemblyAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartAssemblyModel = new ERPPartAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpPartAssemblyModel, () => erpPartAssemblyModel.ValidateRequest_GetAllPartAssemblies(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAssemblyModel.Process_GetAllPartAssemblies(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartAssembly based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartAssemblyDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartAssemblyModel = new ERPPartAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpPartAssemblyModel, () => erpPartAssemblyModel.ValidateRequest_GetPartAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAssemblyModel.Process_GetPartAssembly(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partAssembly">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartAssemblyDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartAssemblyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartAssemblyAsync([FromBody] ERPPartAssemblyDto partAssembly)
	{
		using (erpPartAssemblyModel = new ERPPartAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpPartAssemblyModel, () => erpPartAssemblyModel.ValidateRequest_PutPartAssembly(partAssembly).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAssemblyModel.Process_PutPartAssembly(partAssembly), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartAssemblyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartAssemblyModel = new ERPPartAssemblyModel())
		{
			return await RunApiMethod(base.Request, erpPartAssemblyModel, () => erpPartAssemblyModel.ValidateRequest_DeletePartAssembly(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAssemblyModel.Process_DeletePartAssembly(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
