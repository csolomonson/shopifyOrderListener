...
[RoutePrefix("api/ERP/WorkCenters")]
public class ERPWorkCentersController : ERPBaseController
{
	public IERPWorkCenterModel erpWorkCenterModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPWorkCenterDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllWorkCenterAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpWorkCenterModel = new ERPWorkCenterModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterModel, () => erpWorkCenterModel.ValidateRequest_GetAllWorkCenters(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterModel.Process_GetAllWorkCenters(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a WorkCenter based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWorkCenterDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetWorkCenterAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWorkCenterModel = new ERPWorkCenterModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterModel, () => erpWorkCenterModel.ValidateRequest_GetWorkCenter(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterModel.Process_GetWorkCenter(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="workCenter">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPWorkCenterDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPWorkCenterDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPWorkCenterDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutWorkCenterAsync([FromBody] ERPWorkCenterDto workCenter)
	{
		using (erpWorkCenterModel = new ERPWorkCenterModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterModel, () => erpWorkCenterModel.ValidateRequest_PutWorkCenter(workCenter).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterModel.Process_PutWorkCenter(workCenter), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteWorkCenterAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpWorkCenterModel = new ERPWorkCenterModel())
		{
			return await RunApiMethod(base.Request, erpWorkCenterModel, () => erpWorkCenterModel.ValidateRequest_DeleteWorkCenter(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpWorkCenterModel.Process_DeleteWorkCenter(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
