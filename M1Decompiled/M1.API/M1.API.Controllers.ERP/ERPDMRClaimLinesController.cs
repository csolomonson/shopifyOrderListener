...
[RoutePrefix("api/ERP/DMRClaimLines")]
public class ERPDMRClaimLinesController : ERPBaseController
{
	public IERPDMRClaimLineModel erpDMRClaimLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPDMRClaimLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllDMRClaimLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpDMRClaimLineModel = new ERPDMRClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimLineModel, () => erpDMRClaimLineModel.ValidateRequest_GetAllDMRClaimLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimLineModel.Process_GetAllDMRClaimLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a DMRClaimLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetDMRClaimLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRClaimLineModel = new ERPDMRClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimLineModel, () => erpDMRClaimLineModel.ValidateRequest_GetDMRClaimLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimLineModel.Process_GetDMRClaimLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="dMRClaimLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPDMRClaimLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPDMRClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDMRClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutDMRClaimLineAsync([FromBody] ERPDMRClaimLineDto dMRClaimLine)
	{
		using (erpDMRClaimLineModel = new ERPDMRClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimLineModel, () => erpDMRClaimLineModel.ValidateRequest_PutDMRClaimLine(dMRClaimLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimLineModel.Process_PutDMRClaimLine(dMRClaimLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteDMRClaimLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDMRClaimLineModel = new ERPDMRClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpDMRClaimLineModel, () => erpDMRClaimLineModel.ValidateRequest_DeleteDMRClaimLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDMRClaimLineModel.Process_DeleteDMRClaimLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
