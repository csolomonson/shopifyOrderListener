...
[RoutePrefix("api/ERP/PurchaseOrders")]
public class ERPPurchaseOrdersController : ERPBaseController
{
	public IERPPurchaseOrderModel erpPurchaseOrderModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPurchaseOrderDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPurchaseOrderDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPurchaseOrderAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPurchaseOrderModel = new ERPPurchaseOrderModel())
		{
			return await RunApiMethod(base.Request, erpPurchaseOrderModel, () => erpPurchaseOrderModel.ValidateRequest_GetAllPurchaseOrders(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPurchaseOrderModel.Process_GetAllPurchaseOrders(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PurchaseOrder based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPurchaseOrderDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPurchaseOrderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPurchaseOrderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPurchaseOrderModel = new ERPPurchaseOrderModel())
		{
			return await RunApiMethod(base.Request, erpPurchaseOrderModel, () => erpPurchaseOrderModel.ValidateRequest_GetPurchaseOrder(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPurchaseOrderModel.Process_GetPurchaseOrder(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="purchaseOrder">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPurchaseOrderDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPurchaseOrderDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPurchaseOrderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPurchaseOrderAsync([FromBody] ERPPurchaseOrderDto purchaseOrder)
	{
		using (erpPurchaseOrderModel = new ERPPurchaseOrderModel())
		{
			return await RunApiMethod(base.Request, erpPurchaseOrderModel, () => erpPurchaseOrderModel.ValidateRequest_PutPurchaseOrder(purchaseOrder).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPurchaseOrderModel.Process_PutPurchaseOrder(purchaseOrder), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePurchaseOrderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPurchaseOrderModel = new ERPPurchaseOrderModel())
		{
			return await RunApiMethod(base.Request, erpPurchaseOrderModel, () => erpPurchaseOrderModel.ValidateRequest_DeletePurchaseOrder(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPurchaseOrderModel.Process_DeletePurchaseOrder(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
