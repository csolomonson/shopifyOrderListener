...
[RoutePrefix("api/ERP/LotNumbers")]
public class ERPLotNumbersController : ERPBaseController
{
	public IERPLotNumberModel erpLotNumberModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLotNumberDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLotNumberDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLotNumberAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLotNumberModel = new ERPLotNumberModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberModel, () => erpLotNumberModel.ValidateRequest_GetAllLotNumbers(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberModel.Process_GetAllLotNumbers(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LotNumber based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLotNumberDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLotNumberDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLotNumberAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLotNumberModel = new ERPLotNumberModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberModel, () => erpLotNumberModel.ValidateRequest_GetLotNumber(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberModel.Process_GetLotNumber(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="lotNumber">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLotNumberDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLotNumberDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLotNumberDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLotNumberAsync([FromBody] ERPLotNumberDto lotNumber)
	{
		using (erpLotNumberModel = new ERPLotNumberModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberModel, () => erpLotNumberModel.ValidateRequest_PutLotNumber(lotNumber).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberModel.Process_PutLotNumber(lotNumber), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLotNumberAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLotNumberModel = new ERPLotNumberModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberModel, () => erpLotNumberModel.ValidateRequest_DeleteLotNumber(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberModel.Process_DeleteLotNumber(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
