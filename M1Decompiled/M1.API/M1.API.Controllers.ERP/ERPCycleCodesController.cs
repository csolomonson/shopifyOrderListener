...
[RoutePrefix("api/ERP/CycleCodes")]
public class ERPCycleCodesController : ERPBaseController
{
	public IERPCycleCodeModel erpCycleCodeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPCycleCodeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPCycleCodeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllCycleCodeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpCycleCodeModel = new ERPCycleCodeModel())
		{
			return await RunApiMethod(base.Request, erpCycleCodeModel, () => erpCycleCodeModel.ValidateRequest_GetAllCycleCodes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCycleCodeModel.Process_GetAllCycleCodes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a CycleCode based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPCycleCodeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCycleCodeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetCycleCodeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCycleCodeModel = new ERPCycleCodeModel())
		{
			return await RunApiMethod(base.Request, erpCycleCodeModel, () => erpCycleCodeModel.ValidateRequest_GetCycleCode(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCycleCodeModel.Process_GetCycleCode(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="cycleCode">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPCycleCodeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPCycleCodeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPCycleCodeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutCycleCodeAsync([FromBody] ERPCycleCodeDto cycleCode)
	{
		using (erpCycleCodeModel = new ERPCycleCodeModel())
		{
			return await RunApiMethod(base.Request, erpCycleCodeModel, () => erpCycleCodeModel.ValidateRequest_PutCycleCode(cycleCode).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCycleCodeModel.Process_PutCycleCode(cycleCode), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteCycleCodeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpCycleCodeModel = new ERPCycleCodeModel())
		{
			return await RunApiMethod(base.Request, erpCycleCodeModel, () => erpCycleCodeModel.ValidateRequest_DeleteCycleCode(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpCycleCodeModel.Process_DeleteCycleCode(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
