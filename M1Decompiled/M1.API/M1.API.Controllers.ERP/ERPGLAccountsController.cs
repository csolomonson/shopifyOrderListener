...
[RoutePrefix("api/ERP/GLAccounts")]
public class ERPGLAccountsController : ERPBaseController
{
	public IERPGLAccountModel erpGLAccountModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLAccountDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLAccountDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLAccountAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLAccountModel = new ERPGLAccountModel())
		{
			return await RunApiMethod(base.Request, erpGLAccountModel, () => erpGLAccountModel.ValidateRequest_GetAllGLAccounts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLAccountModel.Process_GetAllGLAccounts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLAccount based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLAccountDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLAccountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLAccountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLAccountModel = new ERPGLAccountModel())
		{
			return await RunApiMethod(base.Request, erpGLAccountModel, () => erpGLAccountModel.ValidateRequest_GetGLAccount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLAccountModel.Process_GetGLAccount(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLAccount">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLAccountDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLAccountDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLAccountDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLAccountAsync([FromBody] ERPGLAccountDto gLAccount)
	{
		using (erpGLAccountModel = new ERPGLAccountModel())
		{
			return await RunApiMethod(base.Request, erpGLAccountModel, () => erpGLAccountModel.ValidateRequest_PutGLAccount(gLAccount).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLAccountModel.Process_PutGLAccount(gLAccount), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLAccountAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLAccountModel = new ERPGLAccountModel())
		{
			return await RunApiMethod(base.Request, erpGLAccountModel, () => erpGLAccountModel.ValidateRequest_DeleteGLAccount(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLAccountModel.Process_DeleteGLAccount(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
