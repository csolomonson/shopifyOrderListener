...
[RoutePrefix("api/ERP/ServiceContracts")]
public class ERPServiceContractsController : ERPBaseController
{
	public IERPServiceContractModel erpServiceContractModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPServiceContractDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPServiceContractDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllServiceContractAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpServiceContractModel = new ERPServiceContractModel())
		{
			return await RunApiMethod(base.Request, erpServiceContractModel, () => erpServiceContractModel.ValidateRequest_GetAllServiceContracts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpServiceContractModel.Process_GetAllServiceContracts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ServiceContract based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPServiceContractDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPServiceContractDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetServiceContractAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpServiceContractModel = new ERPServiceContractModel())
		{
			return await RunApiMethod(base.Request, erpServiceContractModel, () => erpServiceContractModel.ValidateRequest_GetServiceContract(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpServiceContractModel.Process_GetServiceContract(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="serviceContract">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPServiceContractDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPServiceContractDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPServiceContractDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutServiceContractAsync([FromBody] ERPServiceContractDto serviceContract)
	{
		using (erpServiceContractModel = new ERPServiceContractModel())
		{
			return await RunApiMethod(base.Request, erpServiceContractModel, () => erpServiceContractModel.ValidateRequest_PutServiceContract(serviceContract).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpServiceContractModel.Process_PutServiceContract(serviceContract), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteServiceContractAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpServiceContractModel = new ERPServiceContractModel())
		{
			return await RunApiMethod(base.Request, erpServiceContractModel, () => erpServiceContractModel.ValidateRequest_DeleteServiceContract(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpServiceContractModel.Process_DeleteServiceContract(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
