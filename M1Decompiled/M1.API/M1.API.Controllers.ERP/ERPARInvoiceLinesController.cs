...
[RoutePrefix("api/ERP/ARInvoiceLines")]
public class ERPARInvoiceLinesController : ERPBaseController
{
	public IERPARInvoiceLineModel erpARInvoiceLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARInvoiceLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARInvoiceLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARInvoiceLineModel = new ERPARInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceLineModel, () => erpARInvoiceLineModel.ValidateRequest_GetAllARInvoiceLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceLineModel.Process_GetAllARInvoiceLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARInvoiceLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARInvoiceLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceLineModel = new ERPARInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceLineModel, () => erpARInvoiceLineModel.ValidateRequest_GetARInvoiceLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceLineModel.Process_GetARInvoiceLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRInvoiceLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARInvoiceLineAsync([FromBody] ERPARInvoiceLineDto aRInvoiceLine)
	{
		using (erpARInvoiceLineModel = new ERPARInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceLineModel, () => erpARInvoiceLineModel.ValidateRequest_PutARInvoiceLine(aRInvoiceLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceLineModel.Process_PutARInvoiceLine(aRInvoiceLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARInvoiceLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceLineModel = new ERPARInvoiceLineModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceLineModel, () => erpARInvoiceLineModel.ValidateRequest_DeleteARInvoiceLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceLineModel.Process_DeleteARInvoiceLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
