...
[RoutePrefix("api/ERP/RFQQuantities")]
public class ERPRFQQuantitiesController : ERPBaseController
{
	public IERPRFQQuantityModel erpRFQQuantityModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRFQQuantityDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRFQQuantityDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRFQQuantityAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRFQQuantityModel = new ERPRFQQuantityModel())
		{
			return await RunApiMethod(base.Request, erpRFQQuantityModel, () => erpRFQQuantityModel.ValidateRequest_GetAllRFQQuantities(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQQuantityModel.Process_GetAllRFQQuantities(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RFQQuantity based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRFQQuantityDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRFQQuantityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQQuantityModel = new ERPRFQQuantityModel())
		{
			return await RunApiMethod(base.Request, erpRFQQuantityModel, () => erpRFQQuantityModel.ValidateRequest_GetRFQQuantity(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQQuantityModel.Process_GetRFQQuantity(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rFQQuantity">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRFQQuantityDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRFQQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQQuantityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRFQQuantityAsync([FromBody] ERPRFQQuantityDto rFQQuantity)
	{
		using (erpRFQQuantityModel = new ERPRFQQuantityModel())
		{
			return await RunApiMethod(base.Request, erpRFQQuantityModel, () => erpRFQQuantityModel.ValidateRequest_PutRFQQuantity(rFQQuantity).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQQuantityModel.Process_PutRFQQuantity(rFQQuantity), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRFQQuantityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQQuantityModel = new ERPRFQQuantityModel())
		{
			return await RunApiMethod(base.Request, erpRFQQuantityModel, () => erpRFQQuantityModel.ValidateRequest_DeleteRFQQuantity(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQQuantityModel.Process_DeleteRFQQuantity(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
