...
[RoutePrefix("api/ERP/Attachments")]
public class ERPAttachmentsController : ERPBaseController
{
	public IERPAttachmentModel erpAttachmentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAttachmentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAttachmentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAttachmentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAttachmentModel = new ERPAttachmentModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentModel, () => erpAttachmentModel.ValidateRequest_GetAllAttachments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentModel.Process_GetAllAttachments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Attachment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAttachmentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DOCUMENTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAttachmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentModel = new ERPAttachmentModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentModel, () => erpAttachmentModel.ValidateRequest_GetAttachment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentModel.Process_GetAttachment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="attachment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAttachmentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAttachmentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAttachmentAsync([FromBody] ERPAttachmentDto attachment)
	{
		using (erpAttachmentModel = new ERPAttachmentModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentModel, () => erpAttachmentModel.ValidateRequest_PutAttachment(attachment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentModel.Process_PutAttachment(attachment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAttachmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentModel = new ERPAttachmentModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentModel, () => erpAttachmentModel.ValidateRequest_DeleteAttachment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentModel.Process_DeleteAttachment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
