...
[RoutePrefix("api/ERP/LandedCosts")]
public class ERPLandedCostsController : ERPBaseController
{
	public IERPLandedCostModel erpLandedCostModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLandedCostDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLandedCostDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLandedCostAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLandedCostModel = new ERPLandedCostModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostModel, () => erpLandedCostModel.ValidateRequest_GetAllLandedCosts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostModel.Process_GetAllLandedCosts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LandedCost based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLandedCostDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLandedCostDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLandedCostAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLandedCostModel = new ERPLandedCostModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostModel, () => erpLandedCostModel.ValidateRequest_GetLandedCost(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostModel.Process_GetLandedCost(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="landedCost">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLandedCostDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLandedCostDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLandedCostDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLandedCostAsync([FromBody] ERPLandedCostDto landedCost)
	{
		using (erpLandedCostModel = new ERPLandedCostModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostModel, () => erpLandedCostModel.ValidateRequest_PutLandedCost(landedCost).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostModel.Process_PutLandedCost(landedCost), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLandedCostAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLandedCostModel = new ERPLandedCostModel())
		{
			return await RunApiMethod(base.Request, erpLandedCostModel, () => erpLandedCostModel.ValidateRequest_DeleteLandedCost(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLandedCostModel.Process_DeleteLandedCost(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
