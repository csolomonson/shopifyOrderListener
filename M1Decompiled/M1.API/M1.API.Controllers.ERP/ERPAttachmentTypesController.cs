...
[RoutePrefix("api/ERP/AttachmentTypes")]
public class ERPAttachmentTypesController : ERPBaseController
{
	public IERPAttachmentTypeModel erpAttachmentTypeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAttachmentTypeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAttachmentTypeDto>>))]
	...
	[SwaggerOperation(null, Tags = new string[] { "ERP/DOCUMENTS" })]
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAttachmentTypeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAttachmentTypeModel = new ERPAttachmentTypeModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentTypeModel, () => erpAttachmentTypeModel.ValidateRequest_GetAllAttachmentTypes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentTypeModel.Process_GetAllAttachmentTypes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AttachmentType based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAttachmentTypeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DOCUMENTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAttachmentTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentTypeModel = new ERPAttachmentTypeModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentTypeModel, () => erpAttachmentTypeModel.ValidateRequest_GetAttachmentType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentTypeModel.Process_GetAttachmentType(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="attachmentType">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAttachmentTypeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAttachmentTypeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAttachmentTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAttachmentTypeAsync([FromBody] ERPAttachmentTypeDto attachmentType)
	{
		using (erpAttachmentTypeModel = new ERPAttachmentTypeModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentTypeModel, () => erpAttachmentTypeModel.ValidateRequest_PutAttachmentType(attachmentType).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentTypeModel.Process_PutAttachmentType(attachmentType), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAttachmentTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAttachmentTypeModel = new ERPAttachmentTypeModel())
		{
			return await RunApiMethod(base.Request, erpAttachmentTypeModel, () => erpAttachmentTypeModel.ValidateRequest_DeleteAttachmentType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAttachmentTypeModel.Process_DeleteAttachmentType(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
