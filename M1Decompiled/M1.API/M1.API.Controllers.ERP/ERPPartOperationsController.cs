...
[RoutePrefix("api/ERP/PartOperations")]
public class ERPPartOperationsController : ERPBaseController
{
	public IERPPartOperationModel erpPartOperationModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartOperationDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartOperationDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartOperationAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartOperationModel = new ERPPartOperationModel())
		{
			return await RunApiMethod(base.Request, erpPartOperationModel, () => erpPartOperationModel.ValidateRequest_GetAllPartOperations(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOperationModel.Process_GetAllPartOperations(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartOperation based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartOperationDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartOperationModel = new ERPPartOperationModel())
		{
			return await RunApiMethod(base.Request, erpPartOperationModel, () => erpPartOperationModel.ValidateRequest_GetPartOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOperationModel.Process_GetPartOperation(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partOperation">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartOperationDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartOperationDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartOperationAsync([FromBody] ERPPartOperationDto partOperation)
	{
		using (erpPartOperationModel = new ERPPartOperationModel())
		{
			return await RunApiMethod(base.Request, erpPartOperationModel, () => erpPartOperationModel.ValidateRequest_PutPartOperation(partOperation).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOperationModel.Process_PutPartOperation(partOperation), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartOperationModel = new ERPPartOperationModel())
		{
			return await RunApiMethod(base.Request, erpPartOperationModel, () => erpPartOperationModel.ValidateRequest_DeletePartOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartOperationModel.Process_DeletePartOperation(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
