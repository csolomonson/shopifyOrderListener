...
[RoutePrefix("api/ERP/PartAlternates")]
public class ERPPartAlternatesController : ERPBaseController
{
	public IERPPartAlternateModel erpPartAlternateModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartAlternateDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartAlternateDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartAlternateAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartAlternateModel = new ERPPartAlternateModel())
		{
			return await RunApiMethod(base.Request, erpPartAlternateModel, () => erpPartAlternateModel.ValidateRequest_GetAllPartAlternates(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAlternateModel.Process_GetAllPartAlternates(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartAlternate based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartAlternateDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartAlternateDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartAlternateAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartAlternateModel = new ERPPartAlternateModel())
		{
			return await RunApiMethod(base.Request, erpPartAlternateModel, () => erpPartAlternateModel.ValidateRequest_GetPartAlternate(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAlternateModel.Process_GetPartAlternate(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partAlternate">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartAlternateDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartAlternateDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartAlternateDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartAlternateAsync([FromBody] ERPPartAlternateDto partAlternate)
	{
		using (erpPartAlternateModel = new ERPPartAlternateModel())
		{
			return await RunApiMethod(base.Request, erpPartAlternateModel, () => erpPartAlternateModel.ValidateRequest_PutPartAlternate(partAlternate).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAlternateModel.Process_PutPartAlternate(partAlternate), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartAlternateAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartAlternateModel = new ERPPartAlternateModel())
		{
			return await RunApiMethod(base.Request, erpPartAlternateModel, () => erpPartAlternateModel.ValidateRequest_DeletePartAlternate(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartAlternateModel.Process_DeletePartAlternate(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
