...
[RoutePrefix("api/ERP/MarketingPrograms")]
public class ERPMarketingProgramsController : ERPBaseController
{
	public IERPMarketingProgramModel erpMarketingProgramModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMarketingProgramDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMarketingProgramDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMarketingProgramAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMarketingProgramModel = new ERPMarketingProgramModel())
		{
			return await RunApiMethod(base.Request, erpMarketingProgramModel, () => erpMarketingProgramModel.ValidateRequest_GetAllMarketingPrograms(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMarketingProgramModel.Process_GetAllMarketingPrograms(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MarketingProgram based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMarketingProgramDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMarketingProgramDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMarketingProgramAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMarketingProgramModel = new ERPMarketingProgramModel())
		{
			return await RunApiMethod(base.Request, erpMarketingProgramModel, () => erpMarketingProgramModel.ValidateRequest_GetMarketingProgram(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMarketingProgramModel.Process_GetMarketingProgram(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="marketingProgram">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMarketingProgramDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMarketingProgramDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMarketingProgramDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMarketingProgramAsync([FromBody] ERPMarketingProgramDto marketingProgram)
	{
		using (erpMarketingProgramModel = new ERPMarketingProgramModel())
		{
			return await RunApiMethod(base.Request, erpMarketingProgramModel, () => erpMarketingProgramModel.ValidateRequest_PutMarketingProgram(marketingProgram).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMarketingProgramModel.Process_PutMarketingProgram(marketingProgram), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMarketingProgramAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMarketingProgramModel = new ERPMarketingProgramModel())
		{
			return await RunApiMethod(base.Request, erpMarketingProgramModel, () => erpMarketingProgramModel.ValidateRequest_DeleteMarketingProgram(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMarketingProgramModel.Process_DeleteMarketingProgram(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
