...
[RoutePrefix("api/ERP/GLCharts")]
public class ERPGLChartsController : ERPBaseController
{
	public IERPGLChartModel erpGLChartModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLChartDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLChartDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLChartAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLChartModel = new ERPGLChartModel())
		{
			return await RunApiMethod(base.Request, erpGLChartModel, () => erpGLChartModel.ValidateRequest_GetAllGLCharts(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLChartModel.Process_GetAllGLCharts(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLChart based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLChartDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLChartDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLChartAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLChartModel = new ERPGLChartModel())
		{
			return await RunApiMethod(base.Request, erpGLChartModel, () => erpGLChartModel.ValidateRequest_GetGLChart(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLChartModel.Process_GetGLChart(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLChart">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLChartDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLChartDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLChartDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLChartAsync([FromBody] ERPGLChartDto gLChart)
	{
		using (erpGLChartModel = new ERPGLChartModel())
		{
			return await RunApiMethod(base.Request, erpGLChartModel, () => erpGLChartModel.ValidateRequest_PutGLChart(gLChart).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLChartModel.Process_PutGLChart(gLChart), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLChartAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLChartModel = new ERPGLChartModel())
		{
			return await RunApiMethod(base.Request, erpGLChartModel, () => erpGLChartModel.ValidateRequest_DeleteGLChart(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLChartModel.Process_DeleteGLChart(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
