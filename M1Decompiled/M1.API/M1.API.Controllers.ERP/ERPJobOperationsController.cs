...
[RoutePrefix("api/ERP/JobOperations")]
public class ERPJobOperationsController : ERPBaseController
{
	public IERPJobOperationModel erpJobOperationModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobOperationDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobOperationDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobOperationAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobOperationModel = new ERPJobOperationModel())
		{
			return await RunApiMethod(base.Request, erpJobOperationModel, () => erpJobOperationModel.ValidateRequest_GetAllJobOperations(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobOperationModel.Process_GetAllJobOperations(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobOperation based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobOperationDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobOperationModel = new ERPJobOperationModel())
		{
			return await RunApiMethod(base.Request, erpJobOperationModel, () => erpJobOperationModel.ValidateRequest_GetJobOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobOperationModel.Process_GetJobOperation(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobOperation">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobOperationDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobOperationDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobOperationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobOperationAsync([FromBody] ERPJobOperationDto jobOperation)
	{
		using (erpJobOperationModel = new ERPJobOperationModel())
		{
			return await RunApiMethod(base.Request, erpJobOperationModel, () => erpJobOperationModel.ValidateRequest_PutJobOperation(jobOperation).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobOperationModel.Process_PutJobOperation(jobOperation), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobOperationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobOperationModel = new ERPJobOperationModel())
		{
			return await RunApiMethod(base.Request, erpJobOperationModel, () => erpJobOperationModel.ValidateRequest_DeleteJobOperation(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobOperationModel.Process_DeleteJobOperation(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
