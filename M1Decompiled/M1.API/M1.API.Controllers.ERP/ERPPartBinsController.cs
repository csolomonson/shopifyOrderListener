...
[RoutePrefix("api/ERP/PartBins")]
public class ERPPartBinsController : ERPBaseController
{
	public IERPPartBinModel erpPartBinModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartBinDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartBinDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartBinAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartBinModel = new ERPPartBinModel())
		{
			return await RunApiMethod(base.Request, erpPartBinModel, () => erpPartBinModel.ValidateRequest_GetAllPartBins(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinModel.Process_GetAllPartBins(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartBin based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartBinDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartBinDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartBinAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartBinModel = new ERPPartBinModel())
		{
			return await RunApiMethod(base.Request, erpPartBinModel, () => erpPartBinModel.ValidateRequest_GetPartBin(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinModel.Process_GetPartBin(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partBin">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartBinDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartBinDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartBinDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartBinAsync([FromBody] ERPPartBinDto partBin)
	{
		using (erpPartBinModel = new ERPPartBinModel())
		{
			return await RunApiMethod(base.Request, erpPartBinModel, () => erpPartBinModel.ValidateRequest_PutPartBin(partBin).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinModel.Process_PutPartBin(partBin), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartBinAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartBinModel = new ERPPartBinModel())
		{
			return await RunApiMethod(base.Request, erpPartBinModel, () => erpPartBinModel.ValidateRequest_DeletePartBin(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinModel.Process_DeletePartBin(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
