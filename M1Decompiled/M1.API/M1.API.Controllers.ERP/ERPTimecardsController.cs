...
[RoutePrefix("api/ERP/Timecards")]
public class ERPTimecardsController : ERPBaseController
{
	public IERPTimecardModel erpTimecardModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPTimecardDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPTimecardDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllTimecardAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpTimecardModel = new ERPTimecardModel())
		{
			return await RunApiMethod(base.Request, erpTimecardModel, () => erpTimecardModel.ValidateRequest_GetAllTimecards(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardModel.Process_GetAllTimecards(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Timecard based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPTimecardDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTimecardDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DATACOLLECTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetTimecardAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTimecardModel = new ERPTimecardModel())
		{
			return await RunApiMethod(base.Request, erpTimecardModel, () => erpTimecardModel.ValidateRequest_GetTimecard(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardModel.Process_GetTimecard(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="timecard">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPTimecardDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPTimecardDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPTimecardDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutTimecardAsync([FromBody] ERPTimecardDto timecard)
	{
		using (erpTimecardModel = new ERPTimecardModel())
		{
			return await RunApiMethod(base.Request, erpTimecardModel, () => erpTimecardModel.ValidateRequest_PutTimecard(timecard).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardModel.Process_PutTimecard(timecard), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteTimecardAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpTimecardModel = new ERPTimecardModel())
		{
			return await RunApiMethod(base.Request, erpTimecardModel, () => erpTimecardModel.ValidateRequest_DeleteTimecard(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpTimecardModel.Process_DeleteTimecard(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
