...
[RoutePrefix("api/ERP/Employees")]
public class ERPEmployeesController : ERPBaseController
{
	public IERPEmployeeModel erpEmployeeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPEmployeeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPEmployeeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllEmployeeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpEmployeeModel = new ERPEmployeeModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeModel, () => erpEmployeeModel.ValidateRequest_GetAllEmployees(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeModel.Process_GetAllEmployees(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Employee based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPEmployeeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPEmployeeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/EMPLOYEE" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetEmployeeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpEmployeeModel = new ERPEmployeeModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeModel, () => erpEmployeeModel.ValidateRequest_GetEmployee(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeModel.Process_GetEmployee(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="employee">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPEmployeeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPEmployeeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPEmployeeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutEmployeeAsync([FromBody] ERPEmployeeDto employee)
	{
		using (erpEmployeeModel = new ERPEmployeeModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeModel, () => erpEmployeeModel.ValidateRequest_PutEmployee(employee).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeModel.Process_PutEmployee(employee), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteEmployeeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpEmployeeModel = new ERPEmployeeModel())
		{
			return await RunApiMethod(base.Request, erpEmployeeModel, () => erpEmployeeModel.ValidateRequest_DeleteEmployee(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpEmployeeModel.Process_DeleteEmployee(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
