...
[RoutePrefix("api/ERP/ProjectTypes")]
public class ERPProjectTypesController : ERPBaseController
{
	public IERPProjectTypeModel erpProjectTypeModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPProjectTypeDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPProjectTypeDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllProjectTypeAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpProjectTypeModel = new ERPProjectTypeModel())
		{
			return await RunApiMethod(base.Request, erpProjectTypeModel, () => erpProjectTypeModel.ValidateRequest_GetAllProjectTypes(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectTypeModel.Process_GetAllProjectTypes(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ProjectType based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPProjectTypeDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PROJECTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetProjectTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectTypeModel = new ERPProjectTypeModel())
		{
			return await RunApiMethod(base.Request, erpProjectTypeModel, () => erpProjectTypeModel.ValidateRequest_GetProjectType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectTypeModel.Process_GetProjectType(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="projectType">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPProjectTypeDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPProjectTypeDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectTypeDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutProjectTypeAsync([FromBody] ERPProjectTypeDto projectType)
	{
		using (erpProjectTypeModel = new ERPProjectTypeModel())
		{
			return await RunApiMethod(base.Request, erpProjectTypeModel, () => erpProjectTypeModel.ValidateRequest_PutProjectType(projectType).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectTypeModel.Process_PutProjectType(projectType), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteProjectTypeAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectTypeModel = new ERPProjectTypeModel())
		{
			return await RunApiMethod(base.Request, erpProjectTypeModel, () => erpProjectTypeModel.ValidateRequest_DeleteProjectType(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectTypeModel.Process_DeleteProjectType(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
