...
[RoutePrefix("api/ERP/LotNumberStatuses")]
public class ERPLotNumberStatusesController : ERPBaseController
{
	public IERPLotNumberStatusModel erpLotNumberStatusModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLotNumberStatusDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLotNumberStatusDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLotNumberStatusAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLotNumberStatusModel = new ERPLotNumberStatusModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberStatusModel, () => erpLotNumberStatusModel.ValidateRequest_GetAllLotNumberStatuses(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberStatusModel.Process_GetAllLotNumberStatuses(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LotNumberStatus based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLotNumberStatusDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLotNumberStatusDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLotNumberStatusAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLotNumberStatusModel = new ERPLotNumberStatusModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberStatusModel, () => erpLotNumberStatusModel.ValidateRequest_GetLotNumberStatus(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberStatusModel.Process_GetLotNumberStatus(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="lotNumberStatus">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLotNumberStatusDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLotNumberStatusDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLotNumberStatusDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLotNumberStatusAsync([FromBody] ERPLotNumberStatusDto lotNumberStatus)
	{
		using (erpLotNumberStatusModel = new ERPLotNumberStatusModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberStatusModel, () => erpLotNumberStatusModel.ValidateRequest_PutLotNumberStatus(lotNumberStatus).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberStatusModel.Process_PutLotNumberStatus(lotNumberStatus), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLotNumberStatusAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLotNumberStatusModel = new ERPLotNumberStatusModel())
		{
			return await RunApiMethod(base.Request, erpLotNumberStatusModel, () => erpLotNumberStatusModel.ValidateRequest_DeleteLotNumberStatus(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLotNumberStatusModel.Process_DeleteLotNumberStatus(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
