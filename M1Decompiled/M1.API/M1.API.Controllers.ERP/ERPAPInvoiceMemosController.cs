...
[RoutePrefix("api/ERP/APInvoiceMemos")]
public class ERPAPInvoiceMemosController : ERPBaseController
{
	public IERPAPInvoiceMemoModel erpAPInvoiceMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPInvoiceMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPInvoiceMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPInvoiceMemoModel = new ERPAPInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceMemoModel, () => erpAPInvoiceMemoModel.ValidateRequest_GetAllAPInvoiceMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceMemoModel.Process_GetAllAPInvoiceMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APInvoiceMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPInvoiceMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceMemoModel = new ERPAPInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceMemoModel, () => erpAPInvoiceMemoModel.ValidateRequest_GetAPInvoiceMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceMemoModel.Process_GetAPInvoiceMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPInvoiceMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPInvoiceMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPInvoiceMemoAsync([FromBody] ERPAPInvoiceMemoDto aPInvoiceMemo)
	{
		using (erpAPInvoiceMemoModel = new ERPAPInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceMemoModel, () => erpAPInvoiceMemoModel.ValidateRequest_PutAPInvoiceMemo(aPInvoiceMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceMemoModel.Process_PutAPInvoiceMemo(aPInvoiceMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPInvoiceMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPInvoiceMemoModel = new ERPAPInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpAPInvoiceMemoModel, () => erpAPInvoiceMemoModel.ValidateRequest_DeleteAPInvoiceMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPInvoiceMemoModel.Process_DeleteAPInvoiceMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
