...
[RoutePrefix("api/ERP/Shipments")]
public class ERPShipmentsController : ERPBaseController
{
	public IERPShipmentModel erpShipmentModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPShipmentDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPShipmentDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllShipmentAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpShipmentModel = new ERPShipmentModel())
		{
			return await RunApiMethod(base.Request, erpShipmentModel, () => erpShipmentModel.ValidateRequest_GetAllShipments(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentModel.Process_GetAllShipments(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Shipment based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPShipmentDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SHIPPING" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetShipmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShipmentModel = new ERPShipmentModel())
		{
			return await RunApiMethod(base.Request, erpShipmentModel, () => erpShipmentModel.ValidateRequest_GetShipment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentModel.Process_GetShipment(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="shipment">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPShipmentDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPShipmentDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutShipmentAsync([FromBody] ERPShipmentDto shipment)
	{
		using (erpShipmentModel = new ERPShipmentModel())
		{
			return await RunApiMethod(base.Request, erpShipmentModel, () => erpShipmentModel.ValidateRequest_PutShipment(shipment).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentModel.Process_PutShipment(shipment), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteShipmentAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpShipmentModel = new ERPShipmentModel())
		{
			return await RunApiMethod(base.Request, erpShipmentModel, () => erpShipmentModel.ValidateRequest_DeleteShipment(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpShipmentModel.Process_DeleteShipment(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
