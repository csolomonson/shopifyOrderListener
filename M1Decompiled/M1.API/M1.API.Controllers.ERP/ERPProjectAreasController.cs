...
[RoutePrefix("api/ERP/ProjectAreas")]
public class ERPProjectAreasController : ERPBaseController
{
	public IERPProjectAreaModel erpProjectAreaModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPProjectAreaDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPProjectAreaDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllProjectAreaAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpProjectAreaModel = new ERPProjectAreaModel())
		{
			return await RunApiMethod(base.Request, erpProjectAreaModel, () => erpProjectAreaModel.ValidateRequest_GetAllProjectAreas(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectAreaModel.Process_GetAllProjectAreas(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ProjectArea based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPProjectAreaDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectAreaDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PROJECTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetProjectAreaAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectAreaModel = new ERPProjectAreaModel())
		{
			return await RunApiMethod(base.Request, erpProjectAreaModel, () => erpProjectAreaModel.ValidateRequest_GetProjectArea(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectAreaModel.Process_GetProjectArea(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="projectArea">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPProjectAreaDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPProjectAreaDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPProjectAreaDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutProjectAreaAsync([FromBody] ERPProjectAreaDto projectArea)
	{
		using (erpProjectAreaModel = new ERPProjectAreaModel())
		{
			return await RunApiMethod(base.Request, erpProjectAreaModel, () => erpProjectAreaModel.ValidateRequest_PutProjectArea(projectArea).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectAreaModel.Process_PutProjectArea(projectArea), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteProjectAreaAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpProjectAreaModel = new ERPProjectAreaModel())
		{
			return await RunApiMethod(base.Request, erpProjectAreaModel, () => erpProjectAreaModel.ValidateRequest_DeleteProjectArea(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpProjectAreaModel.Process_DeleteProjectArea(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
