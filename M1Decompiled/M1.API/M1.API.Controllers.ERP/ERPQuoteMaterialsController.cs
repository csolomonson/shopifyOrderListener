...
[RoutePrefix("api/ERP/QuoteMaterials")]
public class ERPQuoteMaterialsController : ERPBaseController
{
	public IERPQuoteMaterialModel erpQuoteMaterialModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPQuoteMaterialDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPQuoteMaterialDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllQuoteMaterialAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpQuoteMaterialModel = new ERPQuoteMaterialModel())
		{
			return await RunApiMethod(base.Request, erpQuoteMaterialModel, () => erpQuoteMaterialModel.ValidateRequest_GetAllQuoteMaterials(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteMaterialModel.Process_GetAllQuoteMaterials(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a QuoteMaterial based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPQuoteMaterialDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUOTATIONS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetQuoteMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteMaterialModel = new ERPQuoteMaterialModel())
		{
			return await RunApiMethod(base.Request, erpQuoteMaterialModel, () => erpQuoteMaterialModel.ValidateRequest_GetQuoteMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteMaterialModel.Process_GetQuoteMaterial(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="quoteMaterial">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPQuoteMaterialDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPQuoteMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPQuoteMaterialDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutQuoteMaterialAsync([FromBody] ERPQuoteMaterialDto quoteMaterial)
	{
		using (erpQuoteMaterialModel = new ERPQuoteMaterialModel())
		{
			return await RunApiMethod(base.Request, erpQuoteMaterialModel, () => erpQuoteMaterialModel.ValidateRequest_PutQuoteMaterial(quoteMaterial).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteMaterialModel.Process_PutQuoteMaterial(quoteMaterial), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteQuoteMaterialAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpQuoteMaterialModel = new ERPQuoteMaterialModel())
		{
			return await RunApiMethod(base.Request, erpQuoteMaterialModel, () => erpQuoteMaterialModel.ValidateRequest_DeleteQuoteMaterial(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpQuoteMaterialModel.Process_DeleteQuoteMaterial(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
