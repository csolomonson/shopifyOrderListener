...
[RoutePrefix("api/ERP/InspectionLines")]
public class ERPInspectionLinesController : ERPBaseController
{
	public IERPInspectionLineModel erpInspectionLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPInspectionLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPInspectionLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllInspectionLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpInspectionLineModel = new ERPInspectionLineModel())
		{
			return await RunApiMethod(base.Request, erpInspectionLineModel, () => erpInspectionLineModel.ValidateRequest_GetAllInspectionLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionLineModel.Process_GetAllInspectionLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a InspectionLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPInspectionLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInspectionLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetInspectionLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInspectionLineModel = new ERPInspectionLineModel())
		{
			return await RunApiMethod(base.Request, erpInspectionLineModel, () => erpInspectionLineModel.ValidateRequest_GetInspectionLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionLineModel.Process_GetInspectionLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="inspectionLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPInspectionLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPInspectionLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPInspectionLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutInspectionLineAsync([FromBody] ERPInspectionLineDto inspectionLine)
	{
		using (erpInspectionLineModel = new ERPInspectionLineModel())
		{
			return await RunApiMethod(base.Request, erpInspectionLineModel, () => erpInspectionLineModel.ValidateRequest_PutInspectionLine(inspectionLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionLineModel.Process_PutInspectionLine(inspectionLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteInspectionLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpInspectionLineModel = new ERPInspectionLineModel())
		{
			return await RunApiMethod(base.Request, erpInspectionLineModel, () => erpInspectionLineModel.ValidateRequest_DeleteInspectionLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpInspectionLineModel.Process_DeleteInspectionLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
