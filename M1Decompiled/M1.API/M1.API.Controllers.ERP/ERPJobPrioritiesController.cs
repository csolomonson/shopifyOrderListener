...
[RoutePrefix("api/ERP/JobPriorities")]
public class ERPJobPrioritiesController : ERPBaseController
{
	public IERPJobPriorityModel erpJobPriorityModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobPriorityDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobPriorityDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobPriorityAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobPriorityModel = new ERPJobPriorityModel())
		{
			return await RunApiMethod(base.Request, erpJobPriorityModel, () => erpJobPriorityModel.ValidateRequest_GetAllJobPriorities(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobPriorityModel.Process_GetAllJobPriorities(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobPriority based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobPriorityDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobPriorityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobPriorityModel = new ERPJobPriorityModel())
		{
			return await RunApiMethod(base.Request, erpJobPriorityModel, () => erpJobPriorityModel.ValidateRequest_GetJobPriority(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobPriorityModel.Process_GetJobPriority(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobPriority">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobPriorityDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobPriorityAsync([FromBody] ERPJobPriorityDto jobPriority)
	{
		using (erpJobPriorityModel = new ERPJobPriorityModel())
		{
			return await RunApiMethod(base.Request, erpJobPriorityModel, () => erpJobPriorityModel.ValidateRequest_PutJobPriority(jobPriority).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobPriorityModel.Process_PutJobPriority(jobPriority), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobPriorityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobPriorityModel = new ERPJobPriorityModel())
		{
			return await RunApiMethod(base.Request, erpJobPriorityModel, () => erpJobPriorityModel.ValidateRequest_DeleteJobPriority(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobPriorityModel.Process_DeleteJobPriority(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
