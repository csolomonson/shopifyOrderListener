...
[RoutePrefix("api/ERP/PartRevisions")]
public class ERPPartRevisionsController : ERPBaseController
{
	public IERPPartRevisionModel erpPartRevisionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartRevisionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartRevisionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartRevisionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartRevisionModel = new ERPPartRevisionModel())
		{
			return await RunApiMethod(base.Request, erpPartRevisionModel, () => erpPartRevisionModel.ValidateRequest_GetAllPartRevisions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRevisionModel.Process_GetAllPartRevisions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartRevision based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartRevisionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartRevisionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartRevisionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartRevisionModel = new ERPPartRevisionModel())
		{
			return await RunApiMethod(base.Request, erpPartRevisionModel, () => erpPartRevisionModel.ValidateRequest_GetPartRevision(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRevisionModel.Process_GetPartRevision(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partRevision">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartRevisionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartRevisionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartRevisionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartRevisionAsync([FromBody] ERPPartRevisionDto partRevision)
	{
		using (erpPartRevisionModel = new ERPPartRevisionModel())
		{
			return await RunApiMethod(base.Request, erpPartRevisionModel, () => erpPartRevisionModel.ValidateRequest_PutPartRevision(partRevision).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRevisionModel.Process_PutPartRevision(partRevision), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartRevisionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartRevisionModel = new ERPPartRevisionModel())
		{
			return await RunApiMethod(base.Request, erpPartRevisionModel, () => erpPartRevisionModel.ValidateRequest_DeletePartRevision(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartRevisionModel.Process_DeletePartRevision(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
