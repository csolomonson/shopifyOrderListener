...
[RoutePrefix("api/ERP/RMAClaimLines")]
public class ERPRMAClaimLinesController : ERPBaseController
{
	public IERPRMAClaimLineModel erpRMAClaimLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRMAClaimLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRMAClaimLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRMAClaimLineModel = new ERPRMAClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimLineModel, () => erpRMAClaimLineModel.ValidateRequest_GetAllRMAClaimLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimLineModel.Process_GetAllRMAClaimLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RMAClaimLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/QUALITY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRMAClaimLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAClaimLineModel = new ERPRMAClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimLineModel, () => erpRMAClaimLineModel.ValidateRequest_GetRMAClaimLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimLineModel.Process_GetRMAClaimLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rMAClaimLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRMAClaimLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRMAClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRMAClaimLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRMAClaimLineAsync([FromBody] ERPRMAClaimLineDto rMAClaimLine)
	{
		using (erpRMAClaimLineModel = new ERPRMAClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimLineModel, () => erpRMAClaimLineModel.ValidateRequest_PutRMAClaimLine(rMAClaimLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimLineModel.Process_PutRMAClaimLine(rMAClaimLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRMAClaimLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRMAClaimLineModel = new ERPRMAClaimLineModel())
		{
			return await RunApiMethod(base.Request, erpRMAClaimLineModel, () => erpRMAClaimLineModel.ValidateRequest_DeleteRMAClaimLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRMAClaimLineModel.Process_DeleteRMAClaimLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
