...
[RoutePrefix("api/ERP/PartBinDetails")]
public class ERPPartBinDetailsController : ERPBaseController
{
	public IERPPartBinDetailModel erpPartBinDetailModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPartBinDetailDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPartBinDetailDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPartBinDetailAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPartBinDetailModel = new ERPPartBinDetailModel())
		{
			return await RunApiMethod(base.Request, erpPartBinDetailModel, () => erpPartBinDetailModel.ValidateRequest_GetAllPartBinDetails(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinDetailModel.Process_GetAllPartBinDetails(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a PartBinDetail based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPartBinDetailDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartBinDetailDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPartBinDetailAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartBinDetailModel = new ERPPartBinDetailModel())
		{
			return await RunApiMethod(base.Request, erpPartBinDetailModel, () => erpPartBinDetailModel.ValidateRequest_GetPartBinDetail(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinDetailModel.Process_GetPartBinDetail(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="partBinDetail">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPartBinDetailDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPartBinDetailDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPartBinDetailDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPartBinDetailAsync([FromBody] ERPPartBinDetailDto partBinDetail)
	{
		using (erpPartBinDetailModel = new ERPPartBinDetailModel())
		{
			return await RunApiMethod(base.Request, erpPartBinDetailModel, () => erpPartBinDetailModel.ValidateRequest_PutPartBinDetail(partBinDetail).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinDetailModel.Process_PutPartBinDetail(partBinDetail), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePartBinDetailAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPartBinDetailModel = new ERPPartBinDetailModel())
		{
			return await RunApiMethod(base.Request, erpPartBinDetailModel, () => erpPartBinDetailModel.ValidateRequest_DeletePartBinDetail(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPartBinDetailModel.Process_DeletePartBinDetail(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
