...
[RoutePrefix("api/ERP/LeadCompetitors")]
public class ERPLeadCompetitorsController : ERPBaseController
{
	public IERPLeadCompetitorModel erpLeadCompetitorModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPLeadCompetitorDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPLeadCompetitorDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllLeadCompetitorAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpLeadCompetitorModel = new ERPLeadCompetitorModel())
		{
			return await RunApiMethod(base.Request, erpLeadCompetitorModel, () => erpLeadCompetitorModel.ValidateRequest_GetAllLeadCompetitors(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadCompetitorModel.Process_GetAllLeadCompetitors(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a LeadCompetitor based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPLeadCompetitorDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadCompetitorDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetLeadCompetitorAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadCompetitorModel = new ERPLeadCompetitorModel())
		{
			return await RunApiMethod(base.Request, erpLeadCompetitorModel, () => erpLeadCompetitorModel.ValidateRequest_GetLeadCompetitor(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadCompetitorModel.Process_GetLeadCompetitor(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="leadCompetitor">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPLeadCompetitorDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPLeadCompetitorDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPLeadCompetitorDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutLeadCompetitorAsync([FromBody] ERPLeadCompetitorDto leadCompetitor)
	{
		using (erpLeadCompetitorModel = new ERPLeadCompetitorModel())
		{
			return await RunApiMethod(base.Request, erpLeadCompetitorModel, () => erpLeadCompetitorModel.ValidateRequest_PutLeadCompetitor(leadCompetitor).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadCompetitorModel.Process_PutLeadCompetitor(leadCompetitor), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteLeadCompetitorAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpLeadCompetitorModel = new ERPLeadCompetitorModel())
		{
			return await RunApiMethod(base.Request, erpLeadCompetitorModel, () => erpLeadCompetitorModel.ValidateRequest_DeleteLeadCompetitor(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpLeadCompetitorModel.Process_DeleteLeadCompetitor(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
