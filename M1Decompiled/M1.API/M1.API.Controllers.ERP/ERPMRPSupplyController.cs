...
[RoutePrefix("api/ERP/MRPSupply")]
public class ERPMRPSupplyController : ERPBaseController
{
	public IERPMRPSupplyModel erpMRPSupplyModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMRPSupplyDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMRPSupplyDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMRPSupplyAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMRPSupplyModel = new ERPMRPSupplyModel())
		{
			return await RunApiMethod(base.Request, erpMRPSupplyModel, () => erpMRPSupplyModel.ValidateRequest_GetAllMRPSupply(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSupplyModel.Process_GetAllMRPSupply(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MRPSupply based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMRPSupplyDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPSupplyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMRPSupplyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPSupplyModel = new ERPMRPSupplyModel())
		{
			return await RunApiMethod(base.Request, erpMRPSupplyModel, () => erpMRPSupplyModel.ValidateRequest_GetMRPSupply(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSupplyModel.Process_GetMRPSupply(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="mRPSupply">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMRPSupplyDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMRPSupplyDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPSupplyDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMRPSupplyAsync([FromBody] ERPMRPSupplyDto mRPSupply)
	{
		using (erpMRPSupplyModel = new ERPMRPSupplyModel())
		{
			return await RunApiMethod(base.Request, erpMRPSupplyModel, () => erpMRPSupplyModel.ValidateRequest_PutMRPSupply(mRPSupply).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSupplyModel.Process_PutMRPSupply(mRPSupply), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMRPSupplyAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPSupplyModel = new ERPMRPSupplyModel())
		{
			return await RunApiMethod(base.Request, erpMRPSupplyModel, () => erpMRPSupplyModel.ValidateRequest_DeleteMRPSupply(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPSupplyModel.Process_DeleteMRPSupply(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
