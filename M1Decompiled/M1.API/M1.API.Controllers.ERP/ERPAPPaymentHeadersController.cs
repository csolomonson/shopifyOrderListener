...
[RoutePrefix("api/ERP/APPaymentHeaders")]
public class ERPAPPaymentHeadersController : ERPBaseController
{
	public IERPAPPaymentHeaderModel erpAPPaymentHeaderModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentHeaderDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAPPaymentHeaderDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAPPaymentHeaderAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAPPaymentHeaderModel = new ERPAPPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentHeaderModel, () => erpAPPaymentHeaderModel.ValidateRequest_GetAllAPPaymentHeaders(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentHeaderModel.Process_GetAllAPPaymentHeaders(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a APPaymentHeader based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentHeaderDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAPPaymentHeaderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentHeaderModel = new ERPAPPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentHeaderModel, () => erpAPPaymentHeaderModel.ValidateRequest_GetAPPaymentHeader(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentHeaderModel.Process_GetAPPaymentHeader(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aPPaymentHeader">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAPPaymentHeaderDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAPPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAPPaymentHeaderDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAPPaymentHeaderAsync([FromBody] ERPAPPaymentHeaderDto aPPaymentHeader)
	{
		using (erpAPPaymentHeaderModel = new ERPAPPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentHeaderModel, () => erpAPPaymentHeaderModel.ValidateRequest_PutAPPaymentHeader(aPPaymentHeader).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentHeaderModel.Process_PutAPPaymentHeader(aPPaymentHeader), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAPPaymentHeaderAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAPPaymentHeaderModel = new ERPAPPaymentHeaderModel())
		{
			return await RunApiMethod(base.Request, erpAPPaymentHeaderModel, () => erpAPPaymentHeaderModel.ValidateRequest_DeleteAPPaymentHeader(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAPPaymentHeaderModel.Process_DeleteAPPaymentHeader(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
