...
[RoutePrefix("api/ERP/JobScenarios")]
public class ERPJobScenariosController : ERPBaseController
{
	public IERPJobScenarioModel erpJobScenarioModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPJobScenarioDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPJobScenarioDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllJobScenarioAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpJobScenarioModel = new ERPJobScenarioModel())
		{
			return await RunApiMethod(base.Request, erpJobScenarioModel, () => erpJobScenarioModel.ValidateRequest_GetAllJobScenarios(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobScenarioModel.Process_GetAllJobScenarios(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a JobScenario based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPJobScenarioDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobScenarioDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetJobScenarioAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobScenarioModel = new ERPJobScenarioModel())
		{
			return await RunApiMethod(base.Request, erpJobScenarioModel, () => erpJobScenarioModel.ValidateRequest_GetJobScenario(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobScenarioModel.Process_GetJobScenario(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="jobScenario">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPJobScenarioDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPJobScenarioDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPJobScenarioDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutJobScenarioAsync([FromBody] ERPJobScenarioDto jobScenario)
	{
		using (erpJobScenarioModel = new ERPJobScenarioModel())
		{
			return await RunApiMethod(base.Request, erpJobScenarioModel, () => erpJobScenarioModel.ValidateRequest_PutJobScenario(jobScenario).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobScenarioModel.Process_PutJobScenario(jobScenario), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteJobScenarioAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpJobScenarioModel = new ERPJobScenarioModel())
		{
			return await RunApiMethod(base.Request, erpJobScenarioModel, () => erpJobScenarioModel.ValidateRequest_DeleteJobScenario(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpJobScenarioModel.Process_DeleteJobScenario(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
