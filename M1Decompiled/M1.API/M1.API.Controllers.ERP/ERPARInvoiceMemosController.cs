...
[RoutePrefix("api/ERP/ARInvoiceMemos")]
public class ERPARInvoiceMemosController : ERPBaseController
{
	public IERPARInvoiceMemoModel erpARInvoiceMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPARInvoiceMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllARInvoiceMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpARInvoiceMemoModel = new ERPARInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceMemoModel, () => erpARInvoiceMemoModel.ValidateRequest_GetAllARInvoiceMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceMemoModel.Process_GetAllARInvoiceMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a ARInvoiceMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetARInvoiceMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceMemoModel = new ERPARInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceMemoModel, () => erpARInvoiceMemoModel.ValidateRequest_GetARInvoiceMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceMemoModel.Process_GetARInvoiceMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="aRInvoiceMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPARInvoiceMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPARInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPARInvoiceMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutARInvoiceMemoAsync([FromBody] ERPARInvoiceMemoDto aRInvoiceMemo)
	{
		using (erpARInvoiceMemoModel = new ERPARInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceMemoModel, () => erpARInvoiceMemoModel.ValidateRequest_PutARInvoiceMemo(aRInvoiceMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceMemoModel.Process_PutARInvoiceMemo(aRInvoiceMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteARInvoiceMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpARInvoiceMemoModel = new ERPARInvoiceMemoModel())
		{
			return await RunApiMethod(base.Request, erpARInvoiceMemoModel, () => erpARInvoiceMemoModel.ValidateRequest_DeleteARInvoiceMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpARInvoiceMemoModel.Process_DeleteARInvoiceMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
