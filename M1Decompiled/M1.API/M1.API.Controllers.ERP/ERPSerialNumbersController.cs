...
[RoutePrefix("api/ERP/SerialNumbers")]
public class ERPSerialNumbersController : ERPBaseController
{
	public IERPSerialNumberModel erpSerialNumberModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPSerialNumberDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPSerialNumberDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllSerialNumberAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpSerialNumberModel = new ERPSerialNumberModel())
		{
			return await RunApiMethod(base.Request, erpSerialNumberModel, () => erpSerialNumberModel.ValidateRequest_GetAllSerialNumbers(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSerialNumberModel.Process_GetAllSerialNumbers(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a SerialNumber based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPSerialNumberDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSerialNumberDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/INVENTORY" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetSerialNumberAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSerialNumberModel = new ERPSerialNumberModel())
		{
			return await RunApiMethod(base.Request, erpSerialNumberModel, () => erpSerialNumberModel.ValidateRequest_GetSerialNumber(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSerialNumberModel.Process_GetSerialNumber(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="serialNumber">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPSerialNumberDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPSerialNumberDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPSerialNumberDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutSerialNumberAsync([FromBody] ERPSerialNumberDto serialNumber)
	{
		using (erpSerialNumberModel = new ERPSerialNumberModel())
		{
			return await RunApiMethod(base.Request, erpSerialNumberModel, () => erpSerialNumberModel.ValidateRequest_PutSerialNumber(serialNumber).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSerialNumberModel.Process_PutSerialNumber(serialNumber), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteSerialNumberAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpSerialNumberModel = new ERPSerialNumberModel())
		{
			return await RunApiMethod(base.Request, erpSerialNumberModel, () => erpSerialNumberModel.ValidateRequest_DeleteSerialNumber(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpSerialNumberModel.Process_DeleteSerialNumber(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
