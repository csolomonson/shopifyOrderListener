...
[RoutePrefix("api/ERP/AssetMemos")]
public class ERPAssetMemosController : ERPBaseController
{
	public IERPAssetMemoModel erpAssetMemoModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPAssetMemoDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPAssetMemoDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllAssetMemoAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpAssetMemoModel = new ERPAssetMemoModel())
		{
			return await RunApiMethod(base.Request, erpAssetMemoModel, () => erpAssetMemoModel.ValidateRequest_GetAllAssetMemos(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetMemoModel.Process_GetAllAssetMemos(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a AssetMemo based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPAssetMemoDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetAssetMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetMemoModel = new ERPAssetMemoModel())
		{
			return await RunApiMethod(base.Request, erpAssetMemoModel, () => erpAssetMemoModel.ValidateRequest_GetAssetMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetMemoModel.Process_GetAssetMemo(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="assetMemo">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPAssetMemoDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPAssetMemoDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPAssetMemoDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutAssetMemoAsync([FromBody] ERPAssetMemoDto assetMemo)
	{
		using (erpAssetMemoModel = new ERPAssetMemoModel())
		{
			return await RunApiMethod(base.Request, erpAssetMemoModel, () => erpAssetMemoModel.ValidateRequest_PutAssetMemo(assetMemo).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetMemoModel.Process_PutAssetMemo(assetMemo), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteAssetMemoAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpAssetMemoModel = new ERPAssetMemoModel())
		{
			return await RunApiMethod(base.Request, erpAssetMemoModel, () => erpAssetMemoModel.ValidateRequest_DeleteAssetMemo(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpAssetMemoModel.Process_DeleteAssetMemo(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
