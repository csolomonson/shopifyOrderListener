...
[RoutePrefix("api/ERP/GLDivisions")]
public class ERPGLDivisionsController : ERPBaseController
{
	public IERPGLDivisionModel erpGLDivisionModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPGLDivisionDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPGLDivisionDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllGLDivisionAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpGLDivisionModel = new ERPGLDivisionModel())
		{
			return await RunApiMethod(base.Request, erpGLDivisionModel, () => erpGLDivisionModel.ValidateRequest_GetAllGLDivisions(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDivisionModel.Process_GetAllGLDivisions(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a GLDivision based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPGLDivisionDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLDivisionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/FINANCIAL" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetGLDivisionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLDivisionModel = new ERPGLDivisionModel())
		{
			return await RunApiMethod(base.Request, erpGLDivisionModel, () => erpGLDivisionModel.ValidateRequest_GetGLDivision(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDivisionModel.Process_GetGLDivision(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="gLDivision">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPGLDivisionDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPGLDivisionDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPGLDivisionDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutGLDivisionAsync([FromBody] ERPGLDivisionDto gLDivision)
	{
		using (erpGLDivisionModel = new ERPGLDivisionModel())
		{
			return await RunApiMethod(base.Request, erpGLDivisionModel, () => erpGLDivisionModel.ValidateRequest_PutGLDivision(gLDivision).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDivisionModel.Process_PutGLDivision(gLDivision), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteGLDivisionAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpGLDivisionModel = new ERPGLDivisionModel())
		{
			return await RunApiMethod(base.Request, erpGLDivisionModel, () => erpGLDivisionModel.ValidateRequest_DeleteGLDivision(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpGLDivisionModel.Process_DeleteGLDivision(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
