...
[RoutePrefix("api/ERP/Priorities")]
public class ERPPrioritiesController : ERPBaseController
{
	public IERPPriorityModel erpPriorityModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPPriorityDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPPriorityDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllPriorityAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpPriorityModel = new ERPPriorityModel())
		{
			return await RunApiMethod(base.Request, erpPriorityModel, () => erpPriorityModel.ValidateRequest_GetAllPriorities(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPriorityModel.Process_GetAllPriorities(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Priority based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPPriorityDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetPriorityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPriorityModel = new ERPPriorityModel())
		{
			return await RunApiMethod(base.Request, erpPriorityModel, () => erpPriorityModel.ValidateRequest_GetPriority(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPriorityModel.Process_GetPriority(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="priority">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPPriorityDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPPriorityDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutPriorityAsync([FromBody] ERPPriorityDto priority)
	{
		using (erpPriorityModel = new ERPPriorityModel())
		{
			return await RunApiMethod(base.Request, erpPriorityModel, () => erpPriorityModel.ValidateRequest_PutPriority(priority).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPriorityModel.Process_PutPriority(priority), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeletePriorityAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpPriorityModel = new ERPPriorityModel())
		{
			return await RunApiMethod(base.Request, erpPriorityModel, () => erpPriorityModel.ValidateRequest_DeletePriority(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpPriorityModel.Process_DeletePriority(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
