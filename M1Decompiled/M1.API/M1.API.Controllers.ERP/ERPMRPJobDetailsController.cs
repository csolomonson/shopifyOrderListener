...
[RoutePrefix("api/ERP/MRPJobDetails")]
public class ERPMRPJobDetailsController : ERPBaseController
{
	public IERPMRPJobDetailModel erpMRPJobDetailModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPMRPJobDetailDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPMRPJobDetailDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllMRPJobDetailAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpMRPJobDetailModel = new ERPMRPJobDetailModel())
		{
			return await RunApiMethod(base.Request, erpMRPJobDetailModel, () => erpMRPJobDetailModel.ValidateRequest_GetAllMRPJobDetails(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPJobDetailModel.Process_GetAllMRPJobDetails(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a MRPJobDetail based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPMRPJobDetailDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPJobDetailDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PRODUCTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetMRPJobDetailAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPJobDetailModel = new ERPMRPJobDetailModel())
		{
			return await RunApiMethod(base.Request, erpMRPJobDetailModel, () => erpMRPJobDetailModel.ValidateRequest_GetMRPJobDetail(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPJobDetailModel.Process_GetMRPJobDetail(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="mRPJobDetail">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPMRPJobDetailDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPMRPJobDetailDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPMRPJobDetailDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutMRPJobDetailAsync([FromBody] ERPMRPJobDetailDto mRPJobDetail)
	{
		using (erpMRPJobDetailModel = new ERPMRPJobDetailModel())
		{
			return await RunApiMethod(base.Request, erpMRPJobDetailModel, () => erpMRPJobDetailModel.ValidateRequest_PutMRPJobDetail(mRPJobDetail).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPJobDetailModel.Process_PutMRPJobDetail(mRPJobDetail), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteMRPJobDetailAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpMRPJobDetailModel = new ERPMRPJobDetailModel())
		{
			return await RunApiMethod(base.Request, erpMRPJobDetailModel, () => erpMRPJobDetailModel.ValidateRequest_DeleteMRPJobDetail(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpMRPJobDetailModel.Process_DeleteMRPJobDetail(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
