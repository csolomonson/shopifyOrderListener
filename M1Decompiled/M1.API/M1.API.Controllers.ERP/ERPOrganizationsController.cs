...
[RoutePrefix("api/ERP/Organizations")]
public class ERPOrganizationsController : ERPBaseController
{
	public IERPOrganizationModel erpOrganizationModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPOrganizationDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPOrganizationDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllOrganizationAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpOrganizationModel = new ERPOrganizationModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationModel, () => erpOrganizationModel.ValidateRequest_GetAllOrganizations(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationModel.Process_GetAllOrganizations(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Organization based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPOrganizationDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPOrganizationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/CRM" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetOrganizationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpOrganizationModel = new ERPOrganizationModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationModel, () => erpOrganizationModel.ValidateRequest_GetOrganization(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationModel.Process_GetOrganization(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="organization">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPOrganizationDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPOrganizationDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPOrganizationDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutOrganizationAsync([FromBody] ERPOrganizationDto organization)
	{
		using (erpOrganizationModel = new ERPOrganizationModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationModel, () => erpOrganizationModel.ValidateRequest_PutOrganization(organization).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationModel.Process_PutOrganization(organization), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteOrganizationAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpOrganizationModel = new ERPOrganizationModel())
		{
			return await RunApiMethod(base.Request, erpOrganizationModel, () => erpOrganizationModel.ValidateRequest_DeleteOrganization(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpOrganizationModel.Process_DeleteOrganization(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
