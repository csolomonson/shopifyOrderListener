...
[RoutePrefix("api/ERP/FreightPackages")]
public class ERPFreightPackagesController : ERPBaseController
{
	public IERPFreightPackageModel erpFreightPackageModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPFreightPackageDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPFreightPackageDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllFreightPackageAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpFreightPackageModel = new ERPFreightPackageModel())
		{
			return await RunApiMethod(base.Request, erpFreightPackageModel, () => erpFreightPackageModel.ValidateRequest_GetAllFreightPackages(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFreightPackageModel.Process_GetAllFreightPackages(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a FreightPackage based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPFreightPackageDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPFreightPackageDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/SHIPPING" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetFreightPackageAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpFreightPackageModel = new ERPFreightPackageModel())
		{
			return await RunApiMethod(base.Request, erpFreightPackageModel, () => erpFreightPackageModel.ValidateRequest_GetFreightPackage(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFreightPackageModel.Process_GetFreightPackage(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="freightPackage">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPFreightPackageDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPFreightPackageDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPFreightPackageDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutFreightPackageAsync([FromBody] ERPFreightPackageDto freightPackage)
	{
		using (erpFreightPackageModel = new ERPFreightPackageModel())
		{
			return await RunApiMethod(base.Request, erpFreightPackageModel, () => erpFreightPackageModel.ValidateRequest_PutFreightPackage(freightPackage).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFreightPackageModel.Process_PutFreightPackage(freightPackage), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteFreightPackageAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpFreightPackageModel = new ERPFreightPackageModel())
		{
			return await RunApiMethod(base.Request, erpFreightPackageModel, () => erpFreightPackageModel.ValidateRequest_DeleteFreightPackage(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpFreightPackageModel.Process_DeleteFreightPackage(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
