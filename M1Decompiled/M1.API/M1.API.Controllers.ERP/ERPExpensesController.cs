...
[RoutePrefix("api/ERP/Expenses")]
public class ERPExpensesController : ERPBaseController
{
	public IERPExpenseModel erpExpenseModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPExpenseDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPExpenseDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllExpenseAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpExpenseModel = new ERPExpenseModel())
		{
			return await RunApiMethod(base.Request, erpExpenseModel, () => erpExpenseModel.ValidateRequest_GetAllExpenses(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpExpenseModel.Process_GetAllExpenses(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a Expense based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPExpenseDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPExpenseDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DATACOLLECTION" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetExpenseAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpExpenseModel = new ERPExpenseModel())
		{
			return await RunApiMethod(base.Request, erpExpenseModel, () => erpExpenseModel.ValidateRequest_GetExpense(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpExpenseModel.Process_GetExpense(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="expense">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPExpenseDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPExpenseDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPExpenseDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutExpenseAsync([FromBody] ERPExpenseDto expense)
	{
		using (erpExpenseModel = new ERPExpenseModel())
		{
			return await RunApiMethod(base.Request, erpExpenseModel, () => erpExpenseModel.ValidateRequest_PutExpense(expense).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpExpenseModel.Process_PutExpense(expense), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteExpenseAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpExpenseModel = new ERPExpenseModel())
		{
			return await RunApiMethod(base.Request, erpExpenseModel, () => erpExpenseModel.ValidateRequest_DeleteExpense(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpExpenseModel.Process_DeleteExpense(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
