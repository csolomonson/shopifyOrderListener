...
[RoutePrefix("api/ERP/DocumentLinks")]
public class ERPDocumentLinksController : ERPBaseController
{
	public IERPDocumentLinkModel erpDocumentLinkModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPDocumentLinkDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPDocumentLinkDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllDocumentLinkAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpDocumentLinkModel = new ERPDocumentLinkModel())
		{
			return await RunApiMethod(base.Request, erpDocumentLinkModel, () => erpDocumentLinkModel.ValidateRequest_GetAllDocumentLinks(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDocumentLinkModel.Process_GetAllDocumentLinks(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a DocumentLink based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPDocumentLinkDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDocumentLinkDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/DOCUMENTS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetDocumentLinkAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDocumentLinkModel = new ERPDocumentLinkModel())
		{
			return await RunApiMethod(base.Request, erpDocumentLinkModel, () => erpDocumentLinkModel.ValidateRequest_GetDocumentLink(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDocumentLinkModel.Process_GetDocumentLink(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="documentLink">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPDocumentLinkDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPDocumentLinkDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPDocumentLinkDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutDocumentLinkAsync([FromBody] ERPDocumentLinkDto documentLink)
	{
		using (erpDocumentLinkModel = new ERPDocumentLinkModel())
		{
			return await RunApiMethod(base.Request, erpDocumentLinkModel, () => erpDocumentLinkModel.ValidateRequest_PutDocumentLink(documentLink).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDocumentLinkModel.Process_PutDocumentLink(documentLink), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteDocumentLinkAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpDocumentLinkModel = new ERPDocumentLinkModel())
		{
			return await RunApiMethod(base.Request, erpDocumentLinkModel, () => erpDocumentLinkModel.ValidateRequest_DeleteDocumentLink(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpDocumentLinkModel.Process_DeleteDocumentLink(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
