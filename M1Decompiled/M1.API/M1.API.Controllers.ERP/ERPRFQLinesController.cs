...
[RoutePrefix("api/ERP/RFQLines")]
public class ERPRFQLinesController : ERPBaseController
{
	public IERPRFQLineModel erpRFQLineModel;
	...
	/// <returns>A list of <see cref="T:M1.API.DTOs.ERP.ERPRFQLineDto" /> objects</returns>
	/// <remarks>
	...
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<IList<ERPRFQLineDto>>))]
	...
	[AcceptVerbs("GET")]
	[Route("")]
	public async Task<IHttpActionResult> GetAllRFQLineAsync([FromUri] int pageSize = 1000, [FromUri] int pageNumber = 0, [FromUri] string[] filter = null, [FromUri] string orderBy = null)
	{
		using (erpRFQLineModel = new ERPRFQLineModel())
		{
			return await RunApiMethod(base.Request, erpRFQLineModel, () => erpRFQLineModel.ValidateRequest_GetAllRFQLines(pageSize, pageNumber, filter, orderBy).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQLineModel.Process_GetAllRFQLines(pageSize, pageNumber, filter, orderBy), showReturnObject: true, showResponseMessage: false, showRecordCount: true);
		}
	}
	...
	/// </summary>
	/// <remarks>
	/// This endpoint retrieves a RFQLine based on its identifier. If the record does not exist, a 404 Not Found response will be returned.
	/// </remarks>
	/// <param name="key">The Unique Id of the record to be retrieved</param>
	/// <returns>A single <see cref="T:M1.API.DTOs.ERP.ERPRFQLineDto" /> object).</returns>
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	[SwaggerOperation(null, Tags = new string[] { "ERP/PURCHASEORDERS" })]
	[AcceptVerbs("GET")]
	[Route("{key}")]
	public async Task<IHttpActionResult> GetRFQLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQLineModel = new ERPRFQLineModel())
		{
			return await RunApiMethod(base.Request, erpRFQLineModel, () => erpRFQLineModel.ValidateRequest_GetRFQLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQLineModel.Process_GetRFQLine(key), showReturnObject: true, showResponseMessage: false, showRecordCount: false);
		}
	}
	...
	/// </summary>
	/// <param name="rFQLine">The fully populated <see cref="T:M1.API.DTOs.ERP.ERPRFQLineDto" /> model.</param>
	/// <returns>
	...
	[SwaggerResponse(HttpStatusCode.UnsupportedMediaType, Type = typeof(string))]
	[SwaggerResponse(HttpStatusCode.Unauthorized)]
	[SwaggerResponse(HttpStatusCode.Created, Type = typeof(ERPResponseMessageDto<ERPRFQLineDto>))]
	[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ERPResponseMessageDto<ERPRFQLineDto>))]
	[SwaggerResponse(HttpStatusCode.NotFound, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(APIResponseMessageDto))]
	[SwaggerResponse(HttpStatusCode.InternalServerError, Type = typeof(APIResponseMessageDto))]
	...
	[AcceptVerbs("PUT")]
	[Route("")]
	public async Task<IHttpActionResult> PutRFQLineAsync([FromBody] ERPRFQLineDto rFQLine)
	{
		using (erpRFQLineModel = new ERPRFQLineModel())
		{
			return await RunApiMethod(base.Request, erpRFQLineModel, () => erpRFQLineModel.ValidateRequest_PutRFQLine(rFQLine).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQLineModel.Process_PutRFQLine(rFQLine), showReturnObject: true, showResponseMessage: true, showRecordCount: false);
		}
	}
	...
	[AcceptVerbs("DELETE")]
	[Route("{key}")]
	public async Task<IHttpActionResult> DeleteRFQLineAsync([FromUri(Name = "key")] Guid key)
	{
		using (erpRFQLineModel = new ERPRFQLineModel())
		{
			return await RunApiMethod(base.Request, erpRFQLineModel, () => erpRFQLineModel.ValidateRequest_DeleteRFQLine(key).ConfigureAwait(continueOnCapturedContext: false).GetAwaiter()
				.GetResult(), () => erpRFQLineModel.Process_DeleteRFQLine(key), showReturnObject: false, showResponseMessage: true, showRecordCount: false);
		}
	}
}
