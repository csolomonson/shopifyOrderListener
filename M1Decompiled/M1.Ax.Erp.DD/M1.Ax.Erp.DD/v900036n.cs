...
[DBConversion("9.00.036", "Add fields to StateUITaxYearQuarterTotals table", "2015-05-19")]
public class v900036n
{
	public v900036n(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "StateUITaxYearQuarterTotals"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "StateUITaxYearQuarterTotals", new DmoField[18]
			{
