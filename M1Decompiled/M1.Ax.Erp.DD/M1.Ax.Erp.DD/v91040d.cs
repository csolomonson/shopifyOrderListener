...
[DBConversion("9.1.040", "Add fields to Form1094YearTotalLines table", "2016-03-06")]
public class v91040d
{
	public v91040d(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "Form1094YearTotalLines"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "Form1094YearTotalLines", new DmoField[26]
			{
