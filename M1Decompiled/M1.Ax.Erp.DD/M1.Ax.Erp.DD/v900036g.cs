...
[DBConversion("9.00.036", "Add fields to Form940Years table", "2015-05-19")]
public class v900036g
{
	public v900036g(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "Form940Years"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "Form940Years", new DmoField[17]
			{
