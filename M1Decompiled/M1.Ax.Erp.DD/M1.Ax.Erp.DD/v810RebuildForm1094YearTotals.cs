...
[DBConversion("8.10.050", "Convert Form1094YearTotals to support unicode", "2013-10-17")]
public class v810RebuildForm1094YearTotals
{
	public v810RebuildForm1094YearTotals(DBConversionParms parms)
	{
		if (parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "Form1094YearTotals"))
		{
			parms.Dmo.RebuildTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "Form1094YearTotals", new DmoField[58]
			{
