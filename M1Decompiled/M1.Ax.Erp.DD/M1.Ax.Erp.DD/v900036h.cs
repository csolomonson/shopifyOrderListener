...
[DBConversion("9.00.036", "Add fields to Form940YearTotals table", "2015-05-19")]
public class v900036h
{
	public v900036h(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "Form940YearTotals"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "Form940YearTotals", new DmoField[42]
			{
				...
				new DmoField("pftSignDate", "date", 14, 0, nullable: false),
