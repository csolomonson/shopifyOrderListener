...
[DBConversion("9.2.050", "Create PartBinDetails table", "2016-12-07")]
public class v92050a
{
	public v92050a(DBConversionParms parms)
	{
		if (parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "PartBinDetails"))
		{
			parms.Dmo.DropTable(null, parms.User, parms.DatabaseName, "PartBinDetails");
		}
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "PartBinDetails"))
		{
