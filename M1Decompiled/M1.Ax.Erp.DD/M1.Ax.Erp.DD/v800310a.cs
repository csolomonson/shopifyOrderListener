...
[DBConversion("8.00.310", "Add fields to PayrollNZYears table", "2015-05-19")]
public class v800310a
{
	public v800310a(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "PayrollNZYears"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "PayrollNZYears", new DmoField[17]
			{
