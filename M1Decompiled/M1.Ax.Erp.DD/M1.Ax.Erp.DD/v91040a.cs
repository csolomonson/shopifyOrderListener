...
[DBConversion("9.1.040", "Add fields to Form1094Years table", "2016-03-06")]
public class v91040a
{
	public v91040a(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "Form1094Years"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "Form1094Years", new DmoField[36]
			{
