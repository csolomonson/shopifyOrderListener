...
[DBConversion("8.00.310", "Add fields to PayrollNZYearScheduleLines table", "2015-05-19")]
public class v800310d
{
	public v800310d(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "PayrollNZYearScheduleLines"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "PayrollNZYearScheduleLines", new DmoField[26]
			{
