...
[DBConversion("9.00.036", "Add fields to StateUITaxYears table", "2015-05-19")]
public class v900036l
{
	public v900036l(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "StateUITaxYears"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "StateUITaxYears", new DmoField[18]
			{
