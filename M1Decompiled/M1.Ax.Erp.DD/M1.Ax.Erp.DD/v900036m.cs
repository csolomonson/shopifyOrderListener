...
[DBConversion("9.00.036", "Add fields to StateUITaxYearQuarters table", "2015-05-19")]
public class v900036m
{
	public v900036m(DBConversionParms parms)
	{
		if (!parms.Dmo.DoesTableExist(null, parms.User, parms.DatabaseName, "StateUITaxYearQuarters"))
		{
			parms.Dmo.CreateTable(null, parms.User, parms.DataDictionary, parms.DatabaseName, "StateUITaxYearQuarters", new DmoField[22]
			{
